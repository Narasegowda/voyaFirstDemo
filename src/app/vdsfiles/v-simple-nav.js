...
/******/ 	return __webpack_require__(__webpack_require__.s = "rvx0");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VSimpleNav", function() { return /* binding */ v_simple_nav_VSimpleNav; });
...
// CONCATENATED MODULE: ./src/components/v-simple-nav/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    height: auto;\n    background-color: #f2f2f2;\n    align-items: center;\n    font-size: 18px;\n    font-family: var(--v-fonts__primary);\n    width: 100%;\n    color: var(--v-colors__black);\n  }\n\n  #sticky {\n    background-color: var(--v-colors__gray-light);\n  }\n  .stickyTop {\n    z-index: 10;\n    top: 0;\n  }\n\n  .stickyTopFixed {\n    position: fixed;\n    width: 100%; // IE fallback\n    width: -webkit-fill-available;\n  }\n\n  .hide {\n    display: none;\n  }\n  .v-mobile-global-nav__notification-mobile__show {\n    display: block;\n    margin-top: 3px;\n  }\n\n  .v-tertiary-menu-wrapper {\n    display: flex;\n    height: auto;\n    padding: 9px 0px;\n    background-color: var(--v-colors__gray-medium-3);\n    align-items: center;\n    justify-content: flex-start;\n    font-size: 14px;\n    font-family: var(--v-fonts__primary);\n    width: 100%;\n    flow-direction: row;\n  }\n\n  .v-left {\n    width: 50%;\n    display: flex;\n  }\n\n  .v-right {\n    width: 50%;\n    display: flex;\n    justify-content: flex-end;\n  }\n\n  .v-left > .v-tertiary-item {\n    margin-left: 35px;\n  }\n\n  .v-left > .v-tertiary-item:first-child {\n    margin-left: 0;\n  }\n\n  .v-right > .v-tertiary-item {\n    margin-left: 27px;\n  }\n\n  .v-right > .v-tertiary-item:first-child {\n    margin-left: 0;\n  }\n\n  .v-tertiary-item > a {\n    text-decoration: none;\n    color: var(--v-colors__black);\n    font-size: 14px;\n    font-family: var(--v-fonts__primary);\n  }\n  .v-tertiary-item > a:hover {\n    text-decoration: none;\n    color: var(--v-colors__primary-darker-1);\n  }\n\n  .v-primary-menu-wrapper {\n    width: 100%;\n    height: 90px;\n    background-color: var(--v-colors__white);\n    box-shadow: 0px 10px 10px -10px var(--v-colors__box-shadow-25);\n  }\n\n  .v-secondary-menu-wrapper {\n    width: 100%;\n  }\n\n  .hide {\n    display: none;\n  }\n\n  .v-desktop-global-nav {\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-start;\n  }\n\n  .v-mobile-global-nav {\n    display: none;\n  }\n\n  .searchField {\n    width: 100%;\n  }\n\n  .overlayHeading {\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n    margin-bottom: 30px;\n    text-align: center;\n    font-size: var(--v-fonts__m);\n  }\n  .overlayLinks {\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n    text-align: center;\n  }\n  .popularLinks {\n    text-decoration: underline;\n    color: var(--v-colors__primary);\n    margin-left: 9px;\n  }\n\n  v-heading {\n    padding: 40px 20px 0 0;\n    display: inline-block;\n  }\n\n  .magnifierIcon {\n    display: table;\n    margin-left: auto;\n    margin-right: auto;\n    padding-top: 30px;\n  }\n\n  #searchCard {\n    height: 600px;\n    width: 100%;\n    z-index: 2;\n    padding: 40px 70px 50px;\n  }\n\n  @media screen and (max-width: 1100px) {\n    .stickyTopFixed {\n      width: 100%;\n    }\n\n    .v-desktop-global-nav {\n      display: none;\n    }\n\n    #searchCard {\n      display: none;\n    }\n\n    .v-mobile-global-nav {\n      display: block;\n      overflow: hidden;\n      background-color: var(--v-colors__white);\n    }\n  }\n\n  .searchResCard {\n    margin-top: 30px;\n    padding: 20px;\n  }\n\n  a.search-text {\n    color: var(--v-colors__primary);\n    font-family: var(--v-fonts__primary);\n    font-size: 22px;\n    text-decoration: underline;\n  }\n  a.search-text:hover {\n    text-decoration: underline;\n    background-color: var(--v-colors__box-shadow);\n    cursor: pointer;\n  }\n\n  .tertiary_Padding_Top {\n    padding-top: 30px;\n  }\n\n  .mobileNavOpen {\n    height: 100%;\n    background-color: var(--v-colors__white);\n    position: fixed;\n    top: 0px;\n    width: 100%;\n    overflow-y: auto;\n    z-index: 1;\n  }\n\n  .tertiary-container {\n    display: flex;\n    max-width: 1440px;\n    margin: auto;\n    width: 100%;\n    padding: 0 40px;\n  }\n\n  .searchForm {\n    display: none;\n  }\n  .anchorText {\n    color: #145a7b;\n    font-size: 18px;\n    line-height: 24px;\n    color: var(--v-states__link-color);\n    text-decoration: underline;\n  }\n\n  .anchorText:active {\n    color: #551b57;\n    color: var(--v-states__link-active-color);\n  }\n\n  .anchorText:hover {\n    color: #06395a;\n    color: var(--v-link-hover-color);\n  }\n"]);
...
/* harmony default export */ var v_simple_nav_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/index.js + 8 modules
var utils = __webpack_require__("7Qib");

// CONCATENATED MODULE: ./src/components/v-simple-nav/slottedStyles.js
/* harmony default export */ var slottedStyles = ("\n  .v-tertiary-menu-wrapper {\n    display: flex;\n    height: auto;\n    padding: 0.5% 5%;\n    background-color: #f2f2f2;\n    align-items: center;\n    justify-content: flex-start;\n    font-size: 13px;\n    font-family: var(--v-fonts__primary);\n    width: 100%;\n    flow-direction: row;\n  }\n\n  .v-left {\n    width: 50%;\n    display: flex;\n  }\n  \n  .tertiary-container {\n    display: flex;\n    max-width: 1440px;\n    margin: auto;\n    width: 100%;\n    padding: 0 40px;\n  }\n\n  .v-right {\n    width: 50%;\n    display: flex;\n    justify-content: flex-end;\n  }\n\n  .v-tertiary-item {\n    margin: 0 2%;\n  }\n\n  .v-left > .v-tertiary-item:first-child {\n    margin-left: 0;\n  }\n\n  .v-right > .v-tertiary-item:last-child {\n    margin-right: 0;\n  }\n\n  .v-tertiary-item > a {\n    text-decoration: none;\n    color: inherit;\n  }\n\n  .v-primary-menu-wrapper {\n    width: 100%;\n    min-height: 90px;\n    background-color: var(--v-colors__white);\n    box-shadow: 0px 10px 10px -10px var(--v-colors__box-shadow-25);\n  }\n\n  .v-secondary-menu-wrapper {\n    width: 100%;\n    padding: 0 5%;\n\tmargin-top: 50px;\n  }\n\n  .hide {\n    display: none;\n  }\n\n  .searchField {\n    width: 100%;\n  }\n\n  .overlayHeading {\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n    margin-bottom: 30px;\n    text-align: center;\n    font-size: var(--v-fonts__m);\n  }\n  .overlayLinks {\n    display: block;\n    margin-left: auto;\n    margin-right: auto;\n    text-align: center;\n  }\n  .popularLinks{\n\t  text-decoration:underline;\n\t  color: var(--v-colors__primary);\n\t  margin-left: 9px;\n  }\n\n  v-heading {\n    padding: 40px 20px 0 0;\n    display: inline-block;\n  }\n\n  #searchCard {\n    height: 600px;\n    width: 100%;\n    z-index: 2;\n    padding: 40px 70px 50px;\n  }\n  \n  .magnifierIcon {\n    display: table;\n    margin-left: auto;\n    margin-right: auto;\n    padding-top: 30px;\n  }\n");
// EXTERNAL MODULE: ./node_modules/lit-html/lit-html.js + 1 modules
var lit_html = __webpack_require__("AaG5");

// CONCATENATED MODULE: ./src/components/v-simple-nav/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject84() {
  var data = v_simple_nav_taggedTemplateLiteral(["<slot name=\"popularLinks\"></slot>"]);
...
function _templateObject83() {
  var data = v_simple_nav_taggedTemplateLiteral(["", " ", ""]);
...
function _templateObject82() {
  var data = v_simple_nav_taggedTemplateLiteral(["\n      <v-heading\n        rank=\"2\"\n        sizeModifier=\"m\"\n        fontWeight=\"light\"\n        class=\"overlayHeading\"\n      >\n        Enter a keyword in the search field above and your results will be\n        displayed as you type.</v-heading\n      >\n      <v-heading\n        rank=\"2\"\n        sizeModifier=\"m\"\n        fontWeight=\"light\"\n        class=\"overlayLinks\"\n        style=\"\"\n      >\n        ", "\n      </v-heading>\n      <v-icon name=\"magnifier\" size=\"140\" class=\"magnifierIcon\"></v-icon>\n    "]);
...
function _templateObject75() {
  var data = v_simple_nav_taggedTemplateLiteral(["\n      <v-heading class=\"overlayLinks\"\n        >", "\n      </v-heading>\n      <v-icon name=\"magnifier\" size=\"120\" class=\"magnifierIcon\"></v-icon>\n    "]);
...
function _templateObject70() {
  var data = v_simple_nav_taggedTemplateLiteral(["<div class=\"v-tertiary-menu-wrapper\" slot=\"v-tertiary-menu\">\n            <div class=\"tertiary-container\">\n              <div class=\"v-left\">\n                ", "\n              </div>\n              <div class=\"v-right\">\n                ", "\n              </div>\n            </div>\n          </div>"]);
...
function _templateObject62() {
  var data = v_simple_nav_taggedTemplateLiteral(["\n          <v-secondary-navigation secondaryMenuIndex=\"", "\">\n            ", "\n          </v-secondary-navigation>\n        "]);
...
function _templateObject60() {
  var data = v_simple_nav_taggedTemplateLiteral(["\n      <div class=\"v-secondary-menu-wrapper\" slot=\"v-secondary-menu\">\n        ", "\n      </div>\n    "]);
...
function _templateObject53() {
  var data = v_simple_nav_taggedTemplateLiteral(["\n      <div class=\"v-primary-menu-wrapper\" slot=\"v-primary-menu\">\n        <v-primary-navigation\n          disablenativesearch\n          profiletext=\"", "\"\n          profilelink=\"", "\"\n          ?profileoption=", "\n          primaryprofileicon\n          class=\"v-primary-manu-nav\"\n          search=\"", "\"\n          ?noprofileicon=", "\n        >\n          ", "\n          ", "\n        </v-primary-navigation>\n      </div>\n    "]);
...
function _templateObject27() {
  var data = v_simple_nav_taggedTemplateLiteral(["<a href=\"", "\" class=\"anchorText\" name=\"", "\">\n        ", "\n      </a>"]);
...
function _templateObject26() {
  var data = v_simple_nav_taggedTemplateLiteral(["<v-icon\n        linkButton\n        href=\"", "\"\n        size=\"22px\"\n        darkOrange\n        name=\"", "\"\n      >\n        ", "\n      </v-icon>"]);
...
function _templateObject23() {
  var data = v_simple_nav_taggedTemplateLiteral(["<v-mobile-navigation-footer>\n                ", "</v-mobile-navigation-footer\n              >"]);
...
function _templateObject20() {
  var data = v_simple_nav_taggedTemplateLiteral([" <v-drilldown-menu-page\n                  id=\"", "\"\n                  level=\"", "\"\n                  breadcrumbtext=\"", "\"\n                  title=\"", "\"\n                  from=\"", "\"\n                >\n                  ", "</v-drilldown-menu-page\n                >"]);
...
function _templateObject13() {
  var data = v_simple_nav_taggedTemplateLiteral(["\n      <div class=\"v-mobile-navigation-container__wrapper\" slot=\"v-mobile-menu\">\n        <v-mobile-navigation-container issimplenav>\n          <v-drilldown-menu class=\"mainMenuMobile\">\n            <v-drilldown-menu-page\n              id=\"main\"\n              level=\"0\"\n              ?staticSearch=", "\n              searchLink=", "\n            >\n              ", "\n              ", "\n              ", "\n              <div slot=\"popularLinks\">\n                ", " ", "\n              </div>\n            </v-drilldown-menu-page>\n            ", "\n            ", "\n          </v-drilldown-menu>\n          ", "\n        </v-mobile-navigation-container>\n      </div>\n    "]);
...
function _templateObject7() {
  var data = v_simple_nav_taggedTemplateLiteral([" <v-search-field\n                class=\"searchField\"\n                form=\"search\"\n                large\n                name=\"query\"\n                placeholder=\"Search\"\n                iconColor=\"--v-colors__voya-dark-orange\"\n                iconrightside\n              ></v-search-field>"]);
...
function _templateObject5() {
  var data = v_simple_nav_taggedTemplateLiteral(["\n      <form\n        id=\"test1\"\n        method=\"GET\"\n        name=\"test1\"\n        class=\"searchForm\"\n        action=\"", "\"\n      >\n        <v-card id=\"searchCard\" class=\"hide\" slot=\"v-search-card\">\n          ", "\n          <div id=\"navDisplayResults\" class=\"navDisplayResults\">\n            ", "\n          </div>\n        </v-card>\n      </form>\n    "]);
...
function _templateObject4() {
  var data = v_simple_nav_taggedTemplateLiteral(["\n      <div class=\"v-desktop-global-nav\">\n        <div id=\"sticky\">\n          <slot name=\"v-brand-stripe\"></slot>\n          <slot name=\"v-notification\"></slot>\n          ", "\n          ", "\n        </div>\n        <div id=\"stickyPage\"></div>\n        ", " ", "\n      </div>\n      <div id=\"stickyMobile\" class=\"v-mobile-global-nav\">\n        <div\n          id=\"notificationMobile\"\n          class=\"v-mobile-global-nav__notification-mobile__show\"\n        >\n          <v-brand-stripe id=\"mobileBrandStirpe\" class=\"hide\"> </v-brand-stripe>\n          <slot name=\"v-notification-mobile\"></slot>\n        </div>\n        ", "\n      </div>\n      <div id=\"stickyPageMobile\"></div>\n    "]);
...
function v_simple_nav_templateObject() {
  var data = v_simple_nav_taggedTemplateLiteral(["\n      <div class=\"v-desktop-global-nav\">\n        <div id=\"sticky\">\n          <slot name=\"v-brand-stripe\"></slot>\n          <slot name=\"v-notification\"></slot>\n          <slot name=\"v-tertiary-menu\"></slot>\n          <slot name=\"v-primary-menu\"></slot>\n        </div>\n        <form\n          id=\"test1\"\n          method=\"GET\"\n          name=\"test1\"\n          class=\"searchForm\"\n          action=\"", "\"\n        >\n          <v-card id=\"searchCard\" class=\"hide\" slot=\"v-search-card\">\n            ", "\n            <div class=\"navDisplayResults\">\n              ", "\n            </div>\n          </v-card>\n        </form>\n        <slot name=\"v-secondary-menu\"></slot>\n      </div>\n      <div id=\"stickyMobile\" class=\"v-mobile-global-nav\">\n        <div\n          id=\"notificationMobile\"\n          class=\"v-mobile-global-nav__notification-mobile__show\"\n        >\n          <v-brand-stripe id=\"mobileBrandStirpe\" class=\"hide\"> </v-brand-stripe>\n          <slot name=\"v-notification-mobile\"></slot>\n        </div>\n        <slot name=\"v-mobile-menu\"></slot>\n      </div>\n    "]);

  v_simple_nav_templateObject = function _templateObject() {
    return data;
  };
...
function v_simple_nav_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_simple_nav_VSimpleNav = _decorate([Object(lit_element["c" /* customElement */])('v-simple-nav')], function (_initialize, _LitElement) {
  var VSimpleNav = /*#__PURE__*/function (_LitElement2) {
    _inherits(VSimpleNav, _LitElement2);

    var _super = _createSuper(VSimpleNav);

    function VSimpleNav() {
      var _this;

      _classCallCheck(this, VSimpleNav);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_simple_nav_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        var thisElement = this.config ? this.shadowRoot : this;
        this.$secondaryMenus = thisElement.querySelectorAll('v-secondary-navigation');
        this.$primaryMenus = thisElement.querySelectorAll('v-primary-navigation-link');
        thisElement.addEventListener('activatesecondarymenu', function (e) {
          _this2._activateSecondaryMenu(e.detail);
        }, true);
        thisElement.addEventListener('activatesearch', function () {}, true);
        thisElement.addEventListener('activatelink', function (e) {
          _this2.activateSecondaryTabLink(e.detail);
        }, true);
        this.$secondaryMenus.forEach(function (secondaryMenu) {
          secondaryMenu.classList.add('hide');
        });
        var assignedElementsBySlot = Object(utils["k" /* getSlottedElementsBySlotName */])(this);

        if (assignedElementsBySlot['v-brand-stripe'].length > 0) {
          assignedElementsBySlot['v-brand-stripe'][0].style.height = '25px';

          if (this.shadowRoot.querySelector('#mobileBrandStirpe')) {
            this.shadowRoot.querySelector('#mobileBrandStirpe').classList.remove('hide');
          }
        }

        this._setInitialActiveTab();

        if (!this.activate || this.activate === '' || this.activate === 'null') {
          this.$secondaryMenus.forEach(function (secondaryMenu) {
            if (!secondaryMenu.classList.contains('hide')) secondaryMenu.setAttribute('activateFirstLink', true);
          });
        }
      }
    }, {
      ...
      value: function connectedCallback() {
        ...
        _get(_getPrototypeOf(VSimpleNav.prototype), "connectedCallback", this).call(this);

        window.addEventListener('scroll', function () {
          _this3._applyScroll();
        });
        this.addEventListener('vmobilenavigationtopbar-click', this.toggleNotification);
      }
    }, {
      kind: "method",
      key: "_applyScroll",
      value: function _applyScroll() {
        var details = this.getBoundingClientRect();
        var assignedElementsBySlot = Object(utils["k" /* getSlottedElementsBySlotName */])(this);

        if (details.width > 1100 && details.top < 0 && this.shadowRoot.querySelector('#sticky') && this.shadowRoot.querySelector('#sticky').classList) {
          this.shadowRoot.querySelector('#sticky').classList.add('stickyTop');
          this.shadowRoot.querySelector('#sticky').classList.add('stickyTopFixed');
          this.shadowRoot.querySelector('#stickyPage').style.height = '124px';

          if (assignedElementsBySlot['v-brand-stripe'].length > 0) {
            assignedElementsBySlot['v-brand-stripe'][0].style.background = '#FFF';
          }
        } else if (this.shadowRoot.querySelector('#sticky') && this.shadowRoot.querySelector('#sticky').classList) {
          this.shadowRoot.querySelector('#sticky').classList.remove('stickyTopFixed');
          this.shadowRoot.querySelector('#sticky').classList.remove('stickyTop');
          this.shadowRoot.querySelector('#stickyPage').style.height = '0px';

          if (assignedElementsBySlot['v-brand-stripe'].length > 0) {
            assignedElementsBySlot['v-brand-stripe'][0].style.background = '';
          }
        }

        if (details.width <= 1100 && details.top <= 0 && this.shadowRoot.querySelector('#stickyMobile') && this.shadowRoot.querySelector('#stickyMobile').classList) {
          this.shadowRoot.querySelector('#stickyMobile').classList.add('stickyTop');
          this.shadowRoot.querySelector('#stickyMobile').classList.add('stickyTopFixed');
          this.shadowRoot.querySelector('#stickyPageMobile').style.height = '90px';
        } else if (this.shadowRoot.querySelector('#stickyMobile') && this.shadowRoot.querySelector('#stickyMobile').classList) {
          this.shadowRoot.querySelector('#stickyMobile').classList.remove('stickyTopFixed');
          this.shadowRoot.querySelector('#stickyPageMobile').style.height = '0px';
        }
      }
    }, {
      kind: "method",
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        window.removeEventListener('scroll', this._applyScroll);
        this.removeEventListener('vmobilenavigationtopbar-click', this.toggleNotification);

        _get(_getPrototypeOf(VSimpleNav.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "toggleNotification",
      value: function toggleNotification() {
        var notificationDiv = this.shadowRoot.querySelector('#notificationMobile');
        var mobileDiv = this.shadowRoot.querySelector('.v-mobile-global-nav');

        if (notificationDiv && notificationDiv.classList.contains('v-mobile-global-nav__notification-mobile__show')) {
          notificationDiv.classList.remove('v-mobile-global-nav__notification-mobile__show');
          notificationDiv.classList.add('hide'); // mobile nav background
        } else if (notificationDiv && notificationDiv.classList.contains('hide')) {
          notificationDiv.classList.add('v-mobile-global-nav__notification-mobile__show');
          notificationDiv.classList.remove('hide');
        }

        if (mobileDiv && mobileDiv.classList.contains('mobileNavOpen')) {
          mobileDiv.classList.remove('mobileNavOpen');
        } else if (mobileDiv) {
          mobileDiv.classList.add('mobileNavOpen');
        }
      }
    }, {
      kind: "method",
      ...
      value: function updated(changedProperties) {
        ...
        if (changedProperties.has('activate')) {
          if (this.config && this.activate && this.activate.keys && this.activate.keys.length > 0) {
            this.config.primaryNav.menuItems.map(function () {
              var primaryLink = _this4.shadowRoot.querySelector('v-primary-navigation').querySelectorAll('v-primary-navigation-link');

              primaryLink.forEach(function (item) {
                if (item.getAttribute('id') === _this4.activate.keys[0]) {
                  item.setAttribute('active', '');
                  index = item.primaryMenuIndex;
                } else {
          ...
          if (this.config && this.activate && this.activate.keys && this.activate.keys.length > 1) {
            this.config.secondaryNav.map(function () {
              _this4.shadowRoot.querySelectorAll('v-secondary-navigation').forEach(function (item) {
                item.removeAttribute('active');
                item.querySelectorAll('v-secondary-navigation-link').forEach(function (item) {
                  item.removeAttribute('active');
                });
              });

              var secondaryNav = _this4.shadowRoot.querySelector('v-secondary-navigation[secondarymenuindex="' + index + '"]') && _this4.shadowRoot.querySelector('v-secondary-navigation[secondarymenuindex="' + index + '"]').querySelectorAll('v-secondary-navigation-tab');

              secondaryNav && secondaryNav.length > 0 && secondaryNav.forEach(function (item) {
                if (item.getAttribute('id') === _this4.activate.keys[1] + '-' + index) {
                  item.setAttribute('active', '');

                  if (_this4.activate.keys.length > 2) {
                    var secondaryLink = item.querySelectorAll('v-secondary-navigation-link');
                    secondaryLink.forEach(function (item) {
                      if (item.getAttribute('id') === _this4.activate.keys[2] + '-' + _this4.activate.keys[1] + '-' + index) {
                        item.setAttribute('active', '');
                      } else {
                        item.removeAttribute('active');
                      }
        ...
        if (changedProperties.has('searchResult')) {
          this._displaySearchResult(this.searchResult);
        }
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return this.config ? this._configTemplate() : this._standardTemplate();
      }
    }, {
      kind: "method",
      key: "_standardTemplate",
      value: function _standardTemplate() {
        return Object(lit_element["d" /* html */])(v_simple_nav_templateObject(), this.searchLink, this.staticSearch ? Object(lit_element["d" /* html */])(_templateObject2()) : Object(lit_element["d" /* html */])(_templateObject3()), this.staticSearch ? this._staticSearchMessage() : this._defaultSearchMessage());
      }
    }, {
      kind: "method",
      key: "_configTemplate",
      value: function _configTemplate() {
        return Object(lit_element["d" /* html */])(_templateObject4(), this.getTertiaryMenu(), this.homePage ? this.getHomePagePrimaryNav() : this.getPrimaryNav(), this.getSecondaryNav(), this.getSearchCard(), this.getMobileNav());
      }
    }, {
      kind: "method",
      key: "getSearchCard",
      value: function getSearchCard() {
        return Object(lit_element["d" /* html */])(_templateObject5(), this.searchLink, this.staticSearch ? Object(lit_element["d" /* html */])(_templateObject6()) : Object(lit_element["d" /* html */])(_templateObject7()), this.staticSearch ? this._staticSearchMessage() : this._defaultSearchMessage());
      }
    }, {
      kind: "method",
      key: "getPopularLinks",
      value: function getPopularLinks() {
        var _this5 = this;

        return Object(lit_element["d" /* html */])(_templateObject8(), this.config.popularLinks ? Object(lit_element["d" /* html */])(_templateObject9(), this.config.popularLinks.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject10(), _this5.getPopularLink(item));
        })) : Object(lit_element["d" /* html */])(_templateObject11()));
      }
    }, {
      kind: "method",
      key: "getPopularLink",
      value: function getPopularLink(item) {
        return Object(lit_element["d" /* html */])(_templateObject12(), item.link, item.title);
      }
    }, {
      kind: "method",
      key: "getMobileNav",
      value: function getMobileNav() {
        var _this6 = this;

        return Object(lit_element["d" /* html */])(_templateObject13(), this.staticSearch, this.searchLink, this.config.primaryNav.menuItems.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject14(), _this6.getDrillDownLinkForSecondary(item, item.primaryMenuIndex));
        }), this.config.primaryNav.myProfileItems ? Object(lit_element["d" /* html */])(_templateObject15(), this.getDrillDownLink(this.config.primaryNav.myProfileItems)) : Object(lit_element["d" /* html */])(_templateObject16()), this.config.primaryNav.myMessages ? Object(lit_element["d" /* html */])(_templateObject17(), this.getDrillDownLink(this.config.primaryNav.myMessages)) : Object(lit_element["d" /* html */])(_templateObject18()), this.searchTitle, this.getPopularLinks(), this.config.secondaryNav.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject19(), _this6.getSecondaryTabForMobile(item));
        }), this.config.primaryNav.myProfileItems.secondaryMenu && this.config.primaryNav.myProfileItems.secondaryMenu[0] && this.config.primaryNav.myProfileItems.secondaryMenu[0].mobile ? Object(lit_element["d" /* html */])(_templateObject20(), this.config.primaryNav.myProfileItems.secondaryMenu[0].mobile.key, this.config.primaryNav.myProfileItems.secondaryMenu[0].mobile.level, this.config.primaryNav.myProfileItems.secondaryMenu[0].mobile.breadcrumbText, this.config.primaryNav.myProfileItems.secondaryMenu[0].mobile.title, this.config.primaryNav.myProfileItems.secondaryMenu[0].mobile.from, this.config.primaryNav.myProfileItems.secondaryMenu.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject21(), _this6.getDrillDownLink(item));
        })) : Object(lit_element["d" /* html */])(_templateObject22()), this.config.mobilefooter && this.config.mobilefooter[0] ? Object(lit_element["d" /* html */])(_templateObject23(), this.config.mobilefooter.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject24(), _this6.getFooterForMobile(item));
        })) : Object(lit_element["d" /* html */])(_templateObject25()));
      }
    }, {
      kind: "method",
      key: "getFooterForMobile",
      value: function getFooterForMobile(item) {
        if (item.icon) {
          return Object(lit_element["d" /* html */])(_templateObject26(), item.href, item.icon, item.text);
        } else if (!item.icon) {
          return Object(lit_element["d" /* html */])(_templateObject27(), item.href, item.icon, item.text);
        }
      }
    }, {
      kind: "method",
      key: "getProfileMenuForMobile",
      value: function getProfileMenuForMobile(item) {
        var _this7 = this;

        return Object(lit_element["d" /* html */])(_templateObject28(), item.secondaryMenu[0].mobile.key, item.secondaryMenu[0].mobile.level, item.secondaryMenu[0].mobile.breadcrumbText, item.secondaryMenu[0].mobile.title, item.secondaryMenu[0].mobile.from, item.secondaryMenu.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject29(), _this7.getDrillDownLink(item));
        }));
      }
    }, {
      kind: "method",
      key: "_getMobilePrimaryNavIDForIndex",
      value: function _getMobilePrimaryNavIDForIndex(index) {
        var _this$config$primaryN, _this$config$primaryN2;

        if (((_this$config$primaryN = this.config.primaryNav) === null || _this$config$primaryN === void 0 ? void 0 : (_this$config$primaryN2 = _this$config$primaryN.menuItems) === null || _this$config$primaryN2 === void 0 ? void 0 : _this$config$primaryN2.length) >= index && index >= 0) {
          var _this$config, _this$config$primaryN3, _linkId;

          var item = (_this$config = this.config) === null || _this$config === void 0 ? void 0 : (_this$config$primaryN3 = _this$config.primaryNav) === null || _this$config$primaryN3 === void 0 ? void 0 : _this$config$primaryN3.menuItems[index];
          var linkId = item === null || item === void 0 ? void 0 : item.key;

          if (item === null || item === void 0 ? void 0 : item.mobile) {
            linkId = linkId + '-' + item.mobile.id;
          }

          linkId = (_linkId = linkId) === null || _linkId === void 0 ? void 0 : _linkId.replace(/\s/g, '');
          return linkId;
        }
      }
    }, {
      kind: "method",
      key: "getSecondaryTabForMobile",
      value: function getSecondaryTabForMobile(item) {
        var _this8 = this;

        var secondaryIdex = item.secondaryMenuIndex;

        var linkId = this._getMobilePrimaryNavIDForIndex(secondaryIdex);

        var itemMobileKey = '';
        var itemMobileFrom = '';

        if (item.secondaryMenuTab && item.secondaryMenuTab.length > 0 && item.secondaryMenuTab[0].mobile.key) {
          itemMobileKey = item.secondaryMenuTab[0].mobile.key.replace(/\s/g, '');
        }

        if (item.secondaryMenuTab && item.secondaryMenuTab.length > 0 && item.secondaryMenuTab[0].mobile.from) {
          itemMobileFrom = item.secondaryMenuTab[0].mobile.from.replace(/\s/g, '');
        }

        return item.secondaryMenuTab && item.secondaryMenuTab.length > 0 ? Object(lit_element["d" /* html */])(_templateObject30(), itemMobileKey, secondaryIdex, item.secondaryMenuTab[0].mobile.level, item.secondaryMenuTab[0].mobile.breadcrumbText, item.secondaryMenuTab[0].mobile.title, itemMobileFrom, item.secondaryMenuTab.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject31(), _this8.getDrillDownLinkForSecondaryTab(item, secondaryIdex, linkId));
        }), item.secondaryMenuTab.map(function (item) {
          return item.secondaryMenuLinks !== undefined ? Object(lit_element["d" /* html */])(_templateObject32(), _this8.getSecondaryNavForMobile(item, secondaryIdex, linkId)) : Object(lit_element["d" /* html */])(_templateObject33());
        })) : undefined;
      }
    }, {
      kind: "method",
      key: "getSecondaryNavForMobile",
      value: function getSecondaryNavForMobile(item, secondaryIdex, linkId) {
        var _this9 = this;

        if (item.mobile) {
          linkId = linkId + ' ' + (item.mobile.text + '-' + item.mobile.key).replace(/\s/g, '');
        }

        var itemMobileKey = '';
        var itemMobileFrom = '';

        if (item.secondaryMenuLinks && item.secondaryMenuLinks[0].mobile.key) {
          itemMobileKey = item.secondaryMenuLinks[0].mobile.key.replace(/\s/g, '');
        }

        if (item.secondaryMenuLinks && item.secondaryMenuLinks.length > 0 && item.secondaryMenuLinks[0].mobile.from) {
          itemMobileFrom = item.secondaryMenuLinks[0].mobile.from.replace(/\s/g, '');
        }

        return Object(lit_element["d" /* html */])(_templateObject34(), itemMobileKey, secondaryIdex, item.secondaryMenuLinks[0].mobile.level, item.secondaryMenuLinks[0].mobile.breadcrumbText, item.secondaryMenuLinks[0].mobile.title, itemMobileFrom, secondaryIdex, item.secondaryMenuLinks.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject35(), _this9.getDrillDownLinkForSecondaryTab(item, secondaryIdex, linkId));
        }));
      }
    }, {
      kind: "method",
      key: "getDrillDownLinkForSecondary",
      value: function getDrillDownLinkForSecondary(item, secondaryIdex) {
        if (item.mobile) {
          var linkId = (item.key + '-' + item.mobile.id).replace(/\s/g, '');
          var itemMobileTo = '';

          if (item.mobile.type !== 'link' && item.mobile.to) {
            itemMobileTo = item.mobile.to.replace(/\s/g, '');
          }

          return Object(lit_element["d" /* html */])(_templateObject36(), item.mobile.type === 'link' ? Object(lit_element["d" /* html */])(_templateObject37(), item.mobile.href, item.mobile.selected, linkId, item.mobile.text) : Object(lit_element["d" /* html */])(_templateObject38(), itemMobileTo, secondaryIdex, item.mobile.selected, linkId, item.mobile.text));
        } else {
          return Object(lit_element["d" /* html */])(_templateObject39());
        }
      }
    }, {
      kind: "method",
      key: "getDrillDownLinkForSecondaryTab",
      value: function getDrillDownLinkForSecondaryTab(item, secondaryIdex, parentLinkId) {
        if (item.mobile) {
          var linkId = (item.key + '-' + item.mobile.id + '-' + secondaryIdex).replace(/\s/g, '');
          var itemMobileTo = '';
          ...
          return Object(lit_element["d" /* html */])(_templateObject40(), item.mobile.type === 'link' ? Object(lit_element["d" /* html */])(_templateObject41(), item.mobile.href, item.mobile.selected, linkId, parentLinkId, item.mobile.text) : Object(lit_element["d" /* html */])(_templateObject42(), itemMobileTo, secondaryIdex, item.mobile.selected, linkId, parentLinkId, item.mobile.text));
        } else {
          return Object(lit_element["d" /* html */])(_templateObject43());
        }
      }
    }, {
      kind: "method",
      key: "getDrillDownLink",
      value: function getDrillDownLink(item) {
        if (item.mobile) {
          return Object(lit_element["d" /* html */])(_templateObject44(), item.mobile.type === 'link' ? Object(lit_element["d" /* html */])(_templateObject45(), item.mobile.href, item.mobile.selected, item.mobile.text) : Object(lit_element["d" /* html */])(_templateObject46(), item.mobile.to, item.mobile.selected, item.mobile.text));
        } else {
          return Object(lit_element["d" /* html */])(_templateObject47());
        }
      }
    }, {
      kind: "method",
      key: "getHomePagePrimaryNav",
      value: function getHomePagePrimaryNav() {
        var _this10 = this;

        return Object(lit_element["d" /* html */])(_templateObject48(), this.config.primaryNav.myProfileItems.profileText, this.config.primaryNav.myProfileItems.profileLink, this.config.primaryNav.myProfileItems.secondaryMenu, this.searchLink, this.config.primaryNav.myProfileItems.noProfileIcon, this.config.primaryNav.menuItems.map(function (item, index) {
          return Object(lit_element["d" /* html */])(_templateObject49(), _this10.getPrimaryMenuLink(item, index + 1));
        }), this.config.primaryNav.myProfileItems.secondaryMenu ? Object(lit_element["d" /* html */])(_templateObject50(), this.config.primaryNav.myProfileItems.secondaryMenu.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject51(), _this10.getProfileItems(item));
        })) : Object(lit_element["d" /* html */])(_templateObject52()));
      }
    }, {
      kind: "method",
      key: "getPrimaryNav",
      value: function getPrimaryNav() {
        var _this11 = this;

        return Object(lit_element["d" /* html */])(_templateObject53(), this.config.primaryNav.myProfileItems.profileText, this.config.primaryNav.myProfileItems.profileLink, this.config.primaryNav.myProfileItems.secondaryMenu, this.searchLink, this.config.primaryNav.myProfileItems.noProfileIcon, this.config.primaryNav.menuItems.map(function (item, index) {
          return Object(lit_element["d" /* html */])(_templateObject54(), _this11.getPrimaryMenuLink(item, index + 1));
        }), this.config.primaryNav.myProfileItems.secondaryMenu ? Object(lit_element["d" /* html */])(_templateObject55(), this.config.primaryNav.myProfileItems.secondaryMenu.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject56(), _this11.getProfileItems(item));
        })) : Object(lit_element["d" /* html */])(_templateObject57()));
      }
    }, {
      kind: "method",
      key: "getPrimaryMenuLink",
      value: function getPrimaryMenuLink(item, index) {
        var linkId = item.key;
        if (item.key !== '') linkId = item.key.replace(/\s/g, '');
        return Object(lit_element["d" /* html */])(_templateObject58(), item.link, index, item.active, linkId, item.title);
      }
    }, {
      kind: "method",
      key: "getProfileItems",
      value: function getProfileItems(item) {
        return Object(lit_element["d" /* html */])(_templateObject59(), item.text, item.link);
      }
    }, {
      kind: "method",
      key: "getSecondaryNav",
      value: function getSecondaryNav() {
        var _this12 = this;

        return Object(lit_element["d" /* html */])(_templateObject60(), this.config.secondaryNav.map(function (item, index) {
          return Object(lit_element["d" /* html */])(_templateObject61(), _this12.getSecondaryMenu(item, index + 1));
        }));
      }
    }, {
      kind: "method",
      key: "_getPrimaryNavIdForIndex",
      value: function _getPrimaryNavIdForIndex(index) {
        if (this.config.primaryNav && this.config.primaryNav.menuItems && this.config.primaryNav.menuItems.length >= index && index >= 0) {
          var key = this.config.primaryNav.menuItems[index - 1].key;
          return key.replace(/\s/g, '');
        }
      }
    }, {
      kind: "method",
      key: "getSecondaryMenu",
      value: function getSecondaryMenu(item, index) {
        var _this13 = this;

        var primaryNavKey = this._getPrimaryNavIdForIndex(index);

        return item.secondaryMenuTab && item.secondaryMenuTab.length > 0 ? Object(lit_element["d" /* html */])(_templateObject62(), index, item.secondaryMenuTab.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject63(), _this13.getSecondaryTab(item, index, primaryNavKey));
        })) : undefined;
      }
    }, {
      kind: "method",
      key: "getSecondaryTab",
      value: function getSecondaryTab(item, index, primaryNavKey) {
        var _this14 = this;

        var tabId = item.key + '-' + index;
        tabId = tabId.replace(/\s/g, '');
        return Object(lit_element["d" /* html */])(_templateObject64(), item.illustration, item.active, item.tabtext, tabId, item.link, primaryNavKey, item.secondaryMenuLinks ? Object(lit_element["d" /* html */])(_templateObject65(), item.secondaryMenuLinks.map(function (childItem) {
          return Object(lit_element["d" /* html */])(_templateObject66(), _this14.getSecondaryLink(childItem, tabId, primaryNavKey));
        })) : Object(lit_element["d" /* html */])(_templateObject67()));
      }
    }, {
      kind: "method",
      key: "getSecondaryLink",
      value: function getSecondaryLink(item, index, primaryNavKey) {
        var linkId = item.key + '-' + index;
        linkId = linkId.replace(/\s/g, '');
        var primarySecondayKey = primaryNavKey + ' ' + index;
        return Object(lit_element["d" /* html */])(_templateObject68(), item.active, item.link, linkId, primarySecondayKey, item.text);
      }
    }, {
      kind: "method",
      key: "getTertiaryMenu",
      value: function getTertiaryMenu() {
        var _this15 = this;

        return Object(lit_element["d" /* html */])(_templateObject69(), this.config.leftTertiaryMenu && this.config.rightTertiaryMenu && this.config.rightTertiaryMenu.length > 0 ? Object(lit_element["d" /* html */])(_templateObject70(), this.config.leftTertiaryMenu.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject71(), _this15.getTertiaryItem(item));
        }), this.config.rightTertiaryMenu.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject72(), _this15.getTertiaryItem(item));
        })) : Object(lit_element["d" /* html */])(_templateObject73()));
      }
    }, {
      kind: "method",
      key: "getTertiaryItem",
      value: function getTertiaryItem(item) {
        return Object(lit_element["d" /* html */])(_templateObject74(), item.link, item.title);
      }
    }, {
      kind: "field",
      key: "_setInitialActiveTab",
      value: function value() {
        var _this16 = this;

        return function () {
          _this16.$primaryMenus.forEach(function (primaryMenu) {
            if (primaryMenu.active) {
              _this16._activateSecondaryMenu({
                index: primaryMenu.getAttribute('primaryMenuIndex')
              });
            }
          });
        };
      ...
      kind: "field",
      key: "_activateSecondaryMenu",
      value: function value() {
        var _this17 = this;

        return function (tabIndex) {
          _this17.$secondaryMenus.forEach(function (secondaryMenu) {
            if (tabIndex.index === secondaryMenu.getAttribute('secondarymenuindex')) {
              if (tabIndex.path && tabIndex.path !== '' && tabIndex.path !== '#') {
                secondaryMenu.classList.add('hide');
              } else {
                secondaryMenu.classList.remove('hide');
              }
            } else {
              secondaryMenu.classList.add('hide');
            }
      ...
      kind: "field",
      key: "activateSecondaryTabLink",
      value: function value() {
        var _this18 = this;

        return function (detail) {
          var keys = new Array(_this18.activate.keys[0], detail[0], detail[1]);
          _this18.activate = {
            keys: keys
          };
        };
      ...
      kind: "method",
      key: "toggleSearchCard",
      value: function toggleSearchCard() {
        var thisElement = this.config ? this.shadowRoot : this;
        var search = this.shadowRoot.querySelector('#searchCard');
        var secondaryMenu = thisElement.querySelector('.v-secondary-menu-wrapper');
      ...
      kind: "method",
      key: "_staticSearchMessage",
      value: function _staticSearchMessage() {
        return Object(lit_element["d" /* html */])(_templateObject75(), this.config ? Object(lit_element["d" /* html */])(_templateObject76(), this.searchTitle, this.getPopularLinks()) : Object(lit_element["d" /* html */])(_templateObject77()));
      }
    }, {
      kind: "method",
      key: "_displaySearchResult",
      value: function _displaySearchResult(searchValue) {
        return Object(lit_element["d" /* html */])(_templateObject78(), searchValue.request && searchValue.request.length > 0 ? Object(lit_html["f" /* render */])(Object(lit_element["d" /* html */])(_templateObject79(), searchValue.request, searchValue.response.length, searchValue.response.length, searchValue.response.map(function (link) {
          return Object(lit_element["d" /* html */])(_templateObject80(), link.URL, link.Text);
        })), this.shadowRoot.querySelector('.navDisplayResults')) : Object(lit_html["f" /* render */])(Object(lit_element["d" /* html */])(_templateObject81(), this._defaultSearchMessage()), this.shadowRoot.querySelector('.navDisplayResults')));
      }
    }, {
      kind: "method",
      key: "_defaultSearchMessage",
      value: function _defaultSearchMessage() {
        return Object(lit_element["d" /* html */])(_templateObject82(), this.config ? Object(lit_element["d" /* html */])(_templateObject83(), this.searchTitle, this.getPopularLinks()) : Object(lit_element["d" /* html */])(_templateObject84()));
      }
    }]
  };
