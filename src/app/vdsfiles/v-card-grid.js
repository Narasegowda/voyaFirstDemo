...
/******/ 	return __webpack_require__(__webpack_require__.s = "TSMT");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ var v_card_grid_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/styles/commonStyles.js
var commonStyles = __webpack_require__("ONJ/");

// CONCATENATED MODULE: ./src/components/v-card-grid/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject3() {
  var data = v_card_grid_taggedTemplateLiteral(["\n      <div\n        id=\"", "\"\n        tagText=\"", "\"\n        class=\"ecard\"\n      >\n        <div class=\"ecard-title\">", "</div>\n          <div class=\"ecard-button\">\n            <v-button class=\"buttonPosition\" target='", "' secondary href=", " arialabel=\"", "\">\n              ", "\n            </v-button>\n          </div>\n        </div>\n      </div>\n    "]);
...
function v_card_grid_templateObject() {
  var data = v_card_grid_taggedTemplateLiteral(["\n      <div class=\"v-card-grid-container grid-container-", "\">\n        ", "\n      </div>\n    "]);

  v_card_grid_templateObject = function _templateObject() {
    return data;
  };
...
function v_card_grid_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_card_grid_VCardGrid = _decorate([Object(lit_element["c" /* customElement */])('v-card-grid')], function (_initialize, _LitElement) {
  var VCardGrid = /*#__PURE__*/function (_LitElement2) {
    _inherits(VCardGrid, _LitElement2);

    var _super = _createSuper(VCardGrid);

    function VCardGrid() {
      var _this;

      _classCallCheck(this, VCardGrid);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_card_grid_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        ...
        return Object(lit_element["d" /* html */])(v_card_grid_templateObject(), this.number, this.config.cards ? this.config.cards.map(function (element) {
          if (element.ecardTitle && element.ecardButtonText) {
            return _this2.renderCard(element);
          }
        }) : Object(lit_element["d" /* html */])(_templateObject2()));
      }
    }, {
      kind: "method",
      key: "renderCard",
      value: function renderCard(card) {
        return Object(lit_element["d" /* html */])(_templateObject3(), (card === null || card === void 0 ? void 0 : card.idRef) || '', (card === null || card === void 0 ? void 0 : card.tagText) || '', card.ecardTitle, card.target || '', card.ecardLink, card.arialabel || '', card.ecardButtonText);
      }
    }]
  };
