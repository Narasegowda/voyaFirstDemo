...
/******/ 	return __webpack_require__(__webpack_require__.s = "oyy8");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VSearchField", function() { return /* binding */ v_search_field_VSearchField; });
...
/* harmony default export */ var v_search_field_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/styles/commonStyles.js
var commonStyles = __webpack_require__("ONJ/");

// CONCATENATED MODULE: ./src/components/v-search-field/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_search_field_templateObject() {
  var data = v_search_field_taggedTemplateLiteral(["\n      <input\n        @input=", "\n        ?disabled=", "\n        ?error=", "\n        class=", "\n        placeholder=\"Search\"\n        tabindex=", "\n        type=\"input\"\n        .value=", "\n        @keyup=", "\n        name=", "\n        id=", "\n        aria-label=\"Search\"\n      />\n      <v-icon\n        color=", "\n        name=\"search\"\n        size=", "\n        class=\"", "\"\n        @click=", "\n      ></v-icon>\n    "]);

  v_search_field_templateObject = function _templateObject() {
    return data;
  };
...
function v_search_field_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_search_field_VSearchField = _decorate([Object(lit_element["c" /* customElement */])('v-search-field')], function (_initialize, _LitElement) {
  var VSearchField = /*#__PURE__*/function (_LitElement2) {
    _inherits(VSearchField, _LitElement2);

    var _super = _createSuper(VSearchField);

    function VSearchField() {
      var _this;

      _classCallCheck(this, VSearchField);
  ...
  return {
    ...
    d: [{
      ...
      value: function firstUpdated() {
        ...
        this.$vIcon = this.shadowRoot.querySelector('v-icon');
        ...
        if (this.iconrightside && this.small) {
          this.$input.classList.add('input-small-right-padding');
        } else if (!this.iconrightside && this.small) {
          this.$input.classList.add('input-small-left-padding');
        } else if (this.iconrightside && !this.small) {
          this.$input.classList.add('input-large-right-padding');
        } else if (!this.iconrightside && !this.small) {
          this.$input.classList.add('input-large-left-padding');
        }
      }
    }, {
      kind: "method",
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(VSearchField.prototype), "connectedCallback", this).call(this);
        ...
        if (formName) {
          ...
          formName.addEventListener('keypress', this.impliciteSubmit);
        }
      }
    }, {
      kind: "method",
      key: "impliciteSubmit",
      value: function impliciteSubmit(event) {
        if (event.keyCode === 13) {
          var form = this.closest(this, function (el) {
            return el.localName === 'form';
          });

          if (form) {
            if (Object(utils["u" /* isSafari */])()) {
      ...
      kind: "method",
      key: "searchClickSubmit",
      value: function searchClickSubmit() {
        if (this.iconrightside) {
          var form = this.closest(this, function (el) {
            return el.localName === 'form';
          });
      ...
      kind: "method",
      key: "addHiddenInput",
      value: function addHiddenInput(form) {
      ...
      value: function disconnectedCallback() {
        ...
        if (formName) {
          ...
          formName.removeEventListener('keypress', this.formDataAppend);
        }

        _get(_getPrototypeOf(VSearchField.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "get",
      "static": true,
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_search_field_styles];
      }
    }, {
      kind: "method",
      key: "updated",
      value: function updated(changedProperties) {
        if (changedProperties.has('disabled') || changedProperties.has('error')) this._updateIconColor();
        if (changedProperties.has('large') || changedProperties.has('small')) this._updateIconSize();
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_search_field_templateObject(), this._handleInput, this.disabled, this.error, Object(class_map["a" /* classMap */])({
          large: this.large,
          small: this.small
        }), this.inputTabIndex, this.value, this._handleKeyUp, this.name, this.id, this.iconColor, this.iconSize, this.iconrightside ? 'right-v-icon' : 'left-v-icon', this.searchClickSubmit);
      }
    }, {
      kind: "method",
      key: "_handleInput",
      ...
      value: function _transposeAttributes() {
        var inputAttributes = ['autocomplete', 'autofocus', 'disabled', 'form', 'maxlength', 'minlength', 'name', 'placeholder', 'required', 'value'];
        Object(utils["x" /* transposeAttributes */])({
      ...
      value: function _updateIconColor() {
        var nextColor = '--v-colors__primary';

        if (this.disabled) {
          nextColor = '--v-states__disabled-color';
        } else if (this.error) {
          nextColor = '--v-states__error-color';
        }

        this.iconColor = nextColor;
      }
    }, {
      kind: "method",
      key: "_updateIconSize",
      value: function _updateIconSize() {
        var size = this.large ? '34px' : '26px';
        this.iconSize = size;
      }
    }, {
      kind: "method",
      ...
      value: function _handleKeyUp() {
        this.dispatchEvent(new CustomEvent('vsearchfield-keyup', {
          bubbles: true,
          composed: true,
          detail: {
            value: this.value
