...
/******/ 	return __webpack_require__(__webpack_require__.s = "iwzV");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vDrilldownMenuPage", function() { return /* binding */ v_drilldown_menu_page_vDrilldownMenuPage; });
...
// CONCATENATED MODULE: ./src/components/v-drilldown-menu-page/styles.js
function _templateObject() {
...
/* harmony default export */ var v_drilldown_menu_page_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
var ifDefined = Object(lit_html["d" /* directive */])(function (value) {
  return function (part) {
...
// CONCATENATED MODULE: ./src/components/v-drilldown-menu-page/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject15() {
  var data = v_drilldown_menu_page_taggedTemplateLiteral([" ", " "]);
...
function _templateObject7() {
  var data = v_drilldown_menu_page_taggedTemplateLiteral(["<slot id=\"drillDownMenu\"></slot> "]);
...
function _templateObject6() {
  var data = v_drilldown_menu_page_taggedTemplateLiteral(["<form\n                id=\"search\"\n                method=\"GET\"\n                name=\"search\"\n                action=\"", "\"\n              >\n                <v-search-field\n                  form=\"search\"\n                  name=\"query\"\n                  placeholder=\"Search\"\n                  @focusin=\"", "\"\n                  @focusout=\"", "\"\n                  large\n                  inputTabIndex=", "\n                  iconrightside\n                ></v-search-field>\n              </form>"]);
...
function _templateObject3() {
  var data = v_drilldown_menu_page_taggedTemplateLiteral([" <div class=\"hd-3 headingIE ", "\">", "</div> "]);
...
function v_drilldown_menu_page_templateObject() {
  var data = v_drilldown_menu_page_taggedTemplateLiteral(["\n      <div class=", ">\n        ", "\n        ", "\n        ", "", "\n        <div id=\"displayResults\" class=\"hide\">\n          ", "\n        </div>\n      </div>\n    "]);

  v_drilldown_menu_page_templateObject = function _templateObject() {
    return data;
  };
...
function v_drilldown_menu_page_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_drilldown_menu_page_vDrilldownMenuPage = _decorate([Object(lit_element["c" /* customElement */])('v-drilldown-menu-page')], function (_initialize, _LitElement) {
  var vDrilldownMenuPage = /*#__PURE__*/function (_LitElement2) {
    _inherits(vDrilldownMenuPage, _LitElement2);

    var _super = _createSuper(vDrilldownMenuPage);

    // internally used
    function vDrilldownMenuPage() {
      var _this;

      _classCallCheck(this, vDrilldownMenuPage);

      _this = _super.call(this);

      _initialize(_assertThisInitialized(_this));

      _this.isIEOrEdge = Object(utils["q" /* isIEOrEdge */])();

      _this._handleClickBreadcrumb();

      return _this;
    }

    return vDrilldownMenuPage;
  }(_LitElement);

  return {
    F: vDrilldownMenuPage,
    d: [{
      kind: "field",
      ...
      key: "blockBreadcrumbTranslation",
      value: function value() {
        return false;
      }
    }, {
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_drilldown_menu_page_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        this.$items = Object(utils["j" /* getSlottedElements */])(this);
        this.$breadcrumb = this.shadowRoot.querySelector('v-mobile-breadcrumb');
      ...
      value: function updated(changedProperties) {
        if (changedProperties.has('level')) this.isMain = this.level === 0;
        if (changedProperties.has('isMain')) this._dispatchActivatePageEvent();

        if (changedProperties.has('activate')) {
          this.activate ? this._dispatchActivatePageEvent() : this._dispatchDeactivatePageEvent();
        }

        if (changedProperties.has('shown')) {
          this._updateBreadcrumbTabIndex();

          this._updateItemsShown();
        }
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_drilldown_menu_page_templateObject(), Object(class_map["a" /* classMap */])({
          activated: this.activated
        }), !this.disableSearch ? this._searchFieldTemplate() : "", this._breadcrumbTemplate(), this._headingTemplate(), this._slotTemplate(), this.staticSearch ? this._staticSearchMessage() : this._defaultSearchMessage());
      }
    }, {
      kind: "method",
      key: "_breadcrumbTemplate",
      value: function _breadcrumbTemplate() {
        var _this2 = this;

        return this._shouldShowBreadcrumb() ? Object(lit_element["d" /* html */])(_templateObject2(), function () {
          return _this2._handleClickBreadcrumb();
        }, this.breadcrumbTabIndex, ifDefined(this.blockBreadcrumbTranslation ? 'OneLinkNoTx' : ''), this.breadcrumbText) : undefined;
      }
    }, {
      kind: "method",
      key: "_dispatchActivatePageEvent",
      value: function _dispatchActivatePageEvent() {
        this.dispatchEvent(new CustomEvent('vdrilldownmenu-activatepage', {
          bubbles: true,
          composed: true,
          detail: {
            pageId: this.id
      ...
      kind: "method",
      key: "_dispatchDeactivatePageEvent",
      value: function _dispatchDeactivatePageEvent() {
        this.dispatchEvent(new CustomEvent('vdrilldownmenu-deactivatepage', {
          bubbles: true,
          composed: true,
          detail: {
            pageId: this.id
      ...
      kind: "method",
      key: "_handleClickBreadcrumb",
      value: function _handleClickBreadcrumb() {
        this._dispatchDeactivatePageEvent();
      }
    }, {
      kind: "method",
      key: "_headingTemplate",
      value: function _headingTemplate() {
        return this.title ? Object(lit_element["d" /* html */])(_templateObject3(), this.blockTitleTranslation ? 'OneLinkNoTx' : '', this.title) : undefined;
      }
    }, {
      kind: "method",
      key: "_searchFieldTemplate",
      value: function _searchFieldTemplate() {
        var _this3 = this;

        return this._shouldShowSearchField() ? Object(lit_element["d" /* html */])(_templateObject4(), this.staticSearch ? Object(lit_element["d" /* html */])(_templateObject5(), this.searchLink, function (e) {
          return _this3._handleFocus(e.target.value, 'focusin');
        }, function (e) {
          return _this3._handleFocus(e.target.value, 'focusout');
        }, this.breadcrumbTabIndex) : Object(lit_element["d" /* html */])(_templateObject6(), this.searchLink, function (e) {
          return _this3._handleFocus(e.target.value, 'focusin');
        }, function (e) {
          return _this3._handleFocus(e.target.value, 'focusout');
        }, this.breadcrumbTabIndex)) : undefined;
      }
    }, {
      kind: "method",
      key: "_shouldShowBreadcrumb",
      value: function _shouldShowBreadcrumb() {
        if (this.isIEOrEdge) return Boolean(this.breadcrumbText);
        return Boolean(this.breadcrumbText);
      }
    }, {
      kind: "method",
      key: "_shouldShowSearchField",
      value: function _shouldShowSearchField() {
        if (this.isIEOrEdge) return this.isMain;
        return this.isMain;
      }
    }, {
      kind: "method",
      key: "_slotTemplate",
      value: function _slotTemplate() {
        return Object(lit_element["d" /* html */])(_templateObject7());
      }
    }, {
      kind: "method",
      key: "_updateBreadcrumbTabIndex",
      value: function _updateBreadcrumbTabIndex() {
        this.shown ? this.breadcrumbTabIndex = 0 : this.breadcrumbTabIndex = -1;
      }
    }, {
      kind: "method",
      key: "_updateItemsShown",
      value: function _updateItemsShown() {
        var _this4 = this;

        this.$items.forEach(function (item) {
          item.shown = _this4.shown;
        });
      }
    }, {
      kind: "method",
      ...
      value: function _defaultSearchMessage() {
        return Object(lit_element["d" /* html */])(_templateObject8(), this.staticSearch ? Object(lit_element["d" /* html */])(_templateObject9()) : Object(lit_element["d" /* html */])(_templateObject10()));
      }
    }, {
      kind: "method",
      key: "_staticSearchMessage",
      value: function _staticSearchMessage() {
        return Object(lit_element["d" /* html */])(_templateObject11());
      }
    }, {
      kind: "method",
      key: "_displaySearchResult",
      value: function _displaySearchResult(searchValue) {
        return Object(lit_element["d" /* html */])(_templateObject12(), searchValue.request.length > 0 ? Object(lit_html["f" /* render */])(Object(lit_element["d" /* html */])(_templateObject13(), searchValue.request, searchValue.response.length, searchValue.response.length, searchValue.response.map(function (link) {
          return Object(lit_element["d" /* html */])(_templateObject14(), link.URL, link.Text);
        })), this.shadowRoot.querySelector('#displayResults')) : Object(lit_html["f" /* render */])(Object(lit_element["d" /* html */])(_templateObject15(), this._defaultSearchMessage()), this.shadowRoot.querySelector('#displayResults')));
      }
    }, {
      kind: "method",
      key: "_handleFocus",
      value: function _handleFocus(value, focus) {
        var vDDM = this.shadowRoot.querySelector('#drillDownMenu');
        var vMSR = this.shadowRoot.querySelector('#displayResults');

        if (focus === 'focusin') {
          vDDM.classList.remove('show');
          vMSR.classList.remove('hide');
          vDDM.classList.add('hide');
          vMSR.classList.add('show');
        }
        ...
        if (focus === 'focusout') {
          if (value) {
            ...
            vDDM.classList.remove('hide');
            vMSR.classList.remove('show');
            vDDM.classList.add('show');
            vMSR.classList.add('hide');
          }
        }
      }
    }]
