...
/******/ 	return __webpack_require__(__webpack_require__.s = "enny");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vVideo", function() { return /* binding */ v_video_vVideo; });

// EXTERNAL MODULE: ./node_modules/lit-element/lit-element.js + 5 modules
var lit_element = __webpack_require__("CQbg");

// CONCATENATED MODULE: ./src/components/v-video/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n"]);
...
/* harmony default export */ var v_video_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/styles/commonStyles.js
var commonStyles = __webpack_require__("ONJ/");

// CONCATENATED MODULE: ./src/components/v-video/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject3() {
  var data = v_video_taggedTemplateLiteral([" <slot></slot> "]);
...
function _templateObject2() {
  var data = v_video_taggedTemplateLiteral(["\n            <v-button primary @click=", "\n              >", "</v-button\n            >\n            <v-modal withXButton>\n              <slot></slot>\n            </v-modal>\n          "]);
...
function v_video_templateObject() {
  var data = v_video_taggedTemplateLiteral(["\n      ", "\n    "]);

  v_video_templateObject = function _templateObject() {
    return data;
  };
...
function v_video_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_video_vVideo = _decorate([Object(lit_element["c" /* customElement */])('v-video')], function (_initialize, _LitElement) {
  var vVideo = /*#__PURE__*/function (_LitElement2) {
    _inherits(vVideo, _LitElement2);

    var _super = _createSuper(vVideo);

    function vVideo() {
      var _this;

      _classCallCheck(this, vVideo);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_video_styles];
      }
    }, {
      kind: "field",
      key: "firstUpdated",
      value: function value() {
        ...
        return function () {
          _this2.vModal = _this2.shadowRoot.querySelector('v-modal');
        };
      }
    }, {
      kind: "field",
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_video_templateObject(), this.modal ? Object(lit_element["d" /* html */])(_templateObject2(), this.openDemoModal, this.buttonText) : Object(lit_element["d" /* html */])(_templateObject3()));
      }
    }]
  };
