...
/******/ 	return __webpack_require__(__webpack_require__.s = "WR9q");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VPrimaryNavigation", function() { return /* binding */ v_primary_navigation_VPrimaryNavigation; });
...
/* harmony default export */ var v_primary_navigation_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-primary-navigation/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject28() {
  var data = v_primary_navigation_taggedTemplateLiteral(["<slot name=\"popularLinks\"></slot>"]);
...
function _templateObject27() {
  var data = v_primary_navigation_taggedTemplateLiteral(["", " ", ""]);
...
function _templateObject18() {
  var data = v_primary_navigation_taggedTemplateLiteral([" <v-search-field\n                class=\"searchField\"\n                form=\"search\"\n                large\n                name=\"query\"\n                placeholder=\"Search\"\n                iconColor=\"--v-colors__voya-dark-orange\"\n              ></v-search-field>"]);
...
function _templateObject17() {
  var data = v_primary_navigation_taggedTemplateLiteral([" <v-input-field\n                name=\"query\"\n                placeholder=\"Search\"\n              ></v-input-field>"]);
...
function _templateObject16() {
  var data = v_primary_navigation_taggedTemplateLiteral(["\n      <form id=\"primNav\" method=\"GET\" name=\"test1\" action=\"", "\">\n        <v-card id=\"searchCard\" class=\"hide\">\n          ", "\n          <div id=\"navDisplayResults\">\n            ", "\n          </div>\n        </v-card>\n      </form>\n    "]);
...
function _templateObject15() {
  var data = v_primary_navigation_taggedTemplateLiteral([" <span class=\"verticalLine\"></span>\n              <v-icon\n                href=", "\n                class=\"search-icon\"\n                primary\n                name=\"search\"\n                size=\"40px\"\n              ></v-icon>\n              ", ""]);
...
function _templateObject13() {
  var data = v_primary_navigation_taggedTemplateLiteral([" <v-desktop-navbar-item link=\"", "\">\n              <v-navigation-icon\n                iconname=\"envelopecircle\"\n                slot=\"icon\"\n                withbadge\n              ></v-navigation-icon>\n            </v-desktop-navbar-item>"]);
...
function _templateObject12() {
  var data = v_primary_navigation_taggedTemplateLiteral(["<a href=", " class=\"proileAnchor\">\n              ", "\n            </a>"]);
...
function _templateObject10() {
  var data = v_primary_navigation_taggedTemplateLiteral(["<slot name=\"profile-options\"></slot>"]);
...
function _templateObject9() {
  var data = v_primary_navigation_taggedTemplateLiteral(["<v-icon\n                        circletext=", "\n                      ></v-icon>"]);
...
function _templateObject8() {
  var data = v_primary_navigation_taggedTemplateLiteral(["<v-desktop-navbar-item\n                text=\"", "\"\n                link=", "\n                class=\"profileIcon\"\n              >\n                <v-navigation-icon\n                  iconname=\"profilecircle\"\n                  ?primary=", "\n                  slot=\"icon\"\n                  class=\"with-text\"\n                  ?withbadge=\"", "\"\n                  >", "\n                </v-navigation-icon>\n                ", "\n              </v-desktop-navbar-item>"]);
...
function _templateObject2() {
  var data = v_primary_navigation_taggedTemplateLiteral(["<div class=\"indicator-tab-logo\"></div>"]);
...
function v_primary_navigation_templateObject() {
  var data = v_primary_navigation_taggedTemplateLiteral(["<div class=\"v-primary-menu-wrapper\">\n      <div class=\"v-primary-menu-holder\">\n        <v-logo\n          alt=", "\n          src=", "\n          width=", "\n          height=", "\n          logohref=", "\n        ></v-logo>\n        ", "\n        <slot></slot>\n\n        <span class=\"profile-icon\"></span>\n        ", "\n        ", "\n\n        <slot name=\"icons\"></slot>\n        ", "\n      </div>\n    </div>"]);

  v_primary_navigation_templateObject = function _templateObject() {
    return data;
  };
...
function v_primary_navigation_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_primary_navigation_VPrimaryNavigation = _decorate([Object(lit_element["c" /* customElement */])('v-primary-navigation')], function (_initialize, _LitElement) {
  var VPrimaryNavigation = /*#__PURE__*/function (_LitElement2) {
    _inherits(VPrimaryNavigation, _LitElement2);

    var _super = _createSuper(VPrimaryNavigation);

    function VPrimaryNavigation() {
      var _this;

      _classCallCheck(this, VPrimaryNavigation);
    ...
    return VPrimaryNavigation;
  }(_LitElement);

  return {
    F: VPrimaryNavigation,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_primary_navigation_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        this.$primaryMenus = this.querySelectorAll('v-primary-navigation-link');
        var assignedElementsBySlot = Object(utils["k" /* getSlottedElementsBySlotName */])(this);
        this.$menuItems = assignedElementsBySlot[utils["a" /* DEFAULT_SLOT_NAME */]];
        this.addEventListener('activatesecondarymenu', function (e) {
          _this2.$primaryMenus.forEach(function (primaryMenu) {
            primaryMenu.active = false;
          });

          if (e.target.path && e.target.path !== '' && e.target.path !== '#') {
        ...
        this.$menuItems.forEach(function (item) {
          item.setAttribute('inprimarynav', 'true');
        });
        if (assignedElementsBySlot['default'].length > 0) assignedElementsBySlot['default'][assignedElementsBySlot['default'].length - 1].style.paddingRight = '15px';

        if (!this.disableSearch) {
          this.toggleSearchCard();
        }
      }
    }, {
      kind: "method",
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_primary_navigation_templateObject(), this.alt, this.logoSrc, this.logowidth, this.logoheight, this.logoHref, this.homePage ? Object(lit_element["d" /* html */])(_templateObject2()) : Object(lit_element["d" /* html */])(_templateObject3()), !this.noprofileicon ? this.profileLink === '#' ? Object(lit_element["d" /* html */])(_templateObject4(), this.profileText, this.primaryProfileIcon, this.profileCircleText, this.profileCircleText ? Object(lit_element["d" /* html */])(_templateObject5(), this.profileCircleText) : '', this.profileOption ? Object(lit_element["d" /* html */])(_templateObject6()) : Object(lit_element["d" /* html */])(_templateObject7())) : Object(lit_element["d" /* html */])(_templateObject8(), this.profileText, this.profileLink, this.primaryProfileIcon, this.profileCircleText, this.profileCircleText ? Object(lit_element["d" /* html */])(_templateObject9(), this.profileCircleText) : '', this.profileOption && this.profileLink === '#' ? Object(lit_element["d" /* html */])(_templateObject10()) : Object(lit_element["d" /* html */])(_templateObject11())) : Object(lit_element["d" /* html */])(_templateObject12(), this.profileLink, this.profileText), this.envelopLink !== '' ? Object(lit_element["d" /* html */])(_templateObject13(), this.envelopLink) : Object(lit_element["d" /* html */])(_templateObject14()), !this.disableSearch ? Object(lit_element["d" /* html */])(_templateObject15(), this.disablenativesearch ? this.search : '', this._getSearchCard()) : "");
      }
    }, {
      kind: "method",
      ...
      value: function toggleSearchCard() {
        ...
        this.shadowRoot.querySelector('.search-icon').addEventListener('click', function () {
          _this3._toggleSearchCard();

          _this3.dispatchEvent(new CustomEvent('activatesearch', {
            detail: {
              index: ''
            },
            bubbles: true
      ...
      kind: "method",
      key: "_toggleSearchCard",
      value: function _toggleSearchCard() {
        if (!this.disablenativesearch) {
      ...
      kind: "method",
      key: "_getSearchCard",
      value: function _getSearchCard() {
        return Object(lit_element["d" /* html */])(_templateObject16(), this.search, this.staticSearch ? Object(lit_element["d" /* html */])(_templateObject17()) : Object(lit_element["d" /* html */])(_templateObject18()), this.staticSearch ? this._staticSearchMessage() : this._defaultSearchMessage());
      }
    }, {
      kind: "method",
      key: "_staticSearchMessage",
      value: function _staticSearchMessage() {
        return Object(lit_element["d" /* html */])(_templateObject19(), this.config ? Object(lit_element["d" /* html */])(_templateObject20(), this.searchTitle, this.getPopularLinks()) : Object(lit_element["d" /* html */])(_templateObject21()));
      }
    }, {
      kind: "method",
      key: "_displaySearchResult",
      value: function _displaySearchResult(searchValue) {
        return Object(lit_element["d" /* html */])(_templateObject22(), searchValue.request && searchValue.request.length > 0 ? Object(lit_html["f" /* render */])(Object(lit_element["d" /* html */])(_templateObject23(), searchValue.request, searchValue.response.length, searchValue.response.length, searchValue.response.map(function (link) {
          return Object(lit_element["d" /* html */])(_templateObject24(), link.URL, link.Text);
        })), this.shadowRoot.querySelector('#navDisplayResults')) : Object(lit_html["f" /* render */])(Object(lit_element["d" /* html */])(_templateObject25(), this._defaultSearchMessage()), this.shadowRoot.querySelector('#navDisplayResults')));
      }
    }, {
      kind: "method",
      key: "_defaultSearchMessage",
      value: function _defaultSearchMessage() {
        return Object(lit_element["d" /* html */])(_templateObject26(), this.config ? Object(lit_element["d" /* html */])(_templateObject27(), this.searchTitle, this.getPopularLinks()) : Object(lit_element["d" /* html */])(_templateObject28()));
      }
    }]
  };
