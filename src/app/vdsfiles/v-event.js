...
/******/ 	return __webpack_require__(__webpack_require__.s = "3BFV");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vEvent", function() { return /* binding */ v_event_vEvent; });
...
// CONCATENATED MODULE: ./src/components/v-event/styles.js
...
/* harmony default export */ var v_event_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-event/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_event_taggedTemplateLiteral(["\n          <div id=\"meeting-container\">\n            <div class=\"event-image\">\n              <img id=\"meeting-img\" src=", " alt=", " />\n            </div>\n            <div id=\"meeting-info\">\n              <div class=\"hd-2\" id=\"meeting-title\">", "</div>\n              <p id=\"meeting-description\">\n                <div>\n                  ", "\n                </div>\n              </p>\n            </div>\n            <div id=\"meeting-details\">\n              <div  class=\"hd-3\" id=\"meeting-time\">", "</div>\n              <p id=\"meeting-location\">", "</p>\n            </div>\n          </div>\n        "]);
...
function v_event_templateObject() {
  var data = v_event_taggedTemplateLiteral(["\n          <div id=\"webcast-container\">\n            <img id=\"webcast-img\" src=", " alt=", " />\n            <div id=\"webcast-info\">\n              <div class=\"hd-2\" id=\"webcast-title\">", "</div>\n              <p id=\"webcast-host\">Host: ", "</p>\n              <p>Location: ", "</p>\n              <p>Start Date: ", "</p>\n              <p>End Date: ", "</p>\n\t\t\t        <p id=\"webcast-description\">\n                <div>\n                  ", "\n                </div>\n              </p>  \n            </div>\n            <v-button class=\"webcast-button\"secondary href=", "\n              >", "</v-button\n            >\n          </div>\n        "]);

  v_event_templateObject = function _templateObject() {
    return data;
  };
...
function v_event_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_event_vEvent = _decorate([Object(lit_element["c" /* customElement */])('v-event')], function (_initialize, _LitElement) {
  var vEvent = /*#__PURE__*/function (_LitElement2) {
    _inherits(vEvent, _LitElement2);

    var _super = _createSuper(vEvent);
  ...
  return {
    ...
    d: [{
      ...
      "static": true,
      key: "styles",
      value: //default is webcast
      function styles() {
        return [global_styles["a" /* default */], commonStyles["a" /* default */], v_event_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return this.eventType === 'Webcast' ? Object(lit_element["d" /* html */])(v_event_templateObject(), this.eventImg, this.alt, this.eventTitle, this.eventHost, this.eventType, this.startTime, this.endTime, Object(unsafe_html["a" /* unsafeHTML */])(this.eventDescription), this.buttonHref, this.buttonText) : Object(lit_element["d" /* html */])(_templateObject2(), this.eventImg, this.alt, this.eventTitle, Object(unsafe_html["a" /* unsafeHTML */])(this.eventDescription), this.startTime, this.eventLocation);
      }
    }]
  };
