...
/******/ 	return __webpack_require__(__webpack_require__.s = "AJVb");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VHamburger", function() { return /* binding */ v_hamburger_VHamburger; });
...
// CONCATENATED MODULE: ./src/components/v-hamburger/styles.js
...
/* harmony default export */ var v_hamburger_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-hamburger/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_hamburger_templateObject() {
  var data = v_hamburger_taggedTemplateLiteral(["\n      <button\n        @click=", "\n        class=", "\n        type=\"button\"\n      >\n        <span class=\"box\">\n          <span class=\"inner\"></span>\n        </span>\n        <span class=\"label\">Hamburger Menu</span>\n      </button>\n    "]);

  v_hamburger_templateObject = function _templateObject() {
    return data;
  };
...
function v_hamburger_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_hamburger_VHamburger = _decorate([Object(lit_element["c" /* customElement */])('v-hamburger')], function (_initialize, _LitElement) {
  var VHamburger = /*#__PURE__*/function (_LitElement2) {
    _inherits(VHamburger, _LitElement2);

    var _super = _createSuper(VHamburger);

    function VHamburger() {
      var _this;

      _classCallCheck(this, VHamburger);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_hamburger_styles];
      }
    }, {
      kind: "method",
      key: "updated",
      value: function updated(changedProperties) {
        if (changedProperties.has('active')) this._dispatchChangeEvent();
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_hamburger_templateObject(), this._handleClick, Object(class_map["a" /* classMap */])({
          active: this.active
        }));
      }
    }, {
      ...
      value: function _dispatchChangeEvent() {
        return this.dispatchEvent(new CustomEvent('vhamburger-change', {
          bubbles: true,
          composed: true,
          detail: {
            active: this.active
