...
/******/ 	return __webpack_require__(__webpack_require__.s = "0V79");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VSecondaryNavigationLink", function() { return /* binding */ v_secondary_navigation_link_VSecondaryNavigationLink; });

// EXTERNAL MODULE: ./node_modules/lit-element/lit-element.js + 5 modules
var lit_element = __webpack_require__("CQbg");

// CONCATENATED MODULE: ./src/components/v-secondary-navigation-link/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  a {\n    align-items: center;\n    display: flex;\n    font-size: 18px;\n    font-weight: 100;\n    height: 32px;\n    min-height: 32px;\n    padding: 0 20px;\n    position: relative;\n    text-decoration: underline;\n    text-align: center;\n    color: var(--v-colors__primary);\n    border-left: 1px solid var(--v-colors__gray-medium-2);\n  }\n  a:hover {\n    color: var(--v-colors__primary-darker-1);\n  }\n\n  a:active {\n    text-decoration: none;\n  }\n\n  .active {\n    text-decoration: none;\n    color: var(--v-colors__black);\n    font-weight: bold;\n    margin-right: 5px;\n    position: relative;\n  }\n\n  .active:hover {\n  }\n\n  a:hover::before:not(:focus),\n  a.active::before {\n    text-decoration: underline;\n\n    content: '';\n    height: 70px;\n    position: absolute;\n    right: -1px;\n    z-index: 2;\n    color: var(--v-colors__primary-darker);\n  }\n\n  a.active::before {\n    right: -6px;\n  }\n\n  :host(.first-of-type) > a {\n    border: none;\n  }\n\n  :host(.first-of-type) > a:hover {\n    color: var(--v-colors__primary-darker-1);\n  }\n\n  a:hover:focus,\n  a.active:focus {\n    outline: none;\n    box-shadow: var(--v-states__focus-box-shadow);\n  }\n\n  a:focus:not(.active):not(:hover) {\n    outline: none;\n    z-index: 3;\n    box-shadow: var(--v-states__focus-box-shadow);\n  }\n  .external {\n    margin-left: 10px;\n  }\n"]);
...
/* harmony default export */ var v_secondary_navigation_link_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-secondary-navigation-link/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_secondary_navigation_link_taggedTemplateLiteral(["<v-icon\n              class=\"external\"\n              name=\"externalLink\"\n              color=\"--v-colors__primary\"\n              size=\"15px\"\n            ></v-icon> "]);
...
function v_secondary_navigation_link_templateObject() {
  var data = v_secondary_navigation_link_taggedTemplateLiteral(["\n      <a\n        href=", "\n        class=\"", "\"\n        aria-label=\"", "\"\n        target=", "\n      >\n        <slot></slot>\n        ", "\n      </a>\n    "]);

  v_secondary_navigation_link_templateObject = function _templateObject() {
    return data;
  };
...
function v_secondary_navigation_link_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_secondary_navigation_link_VSecondaryNavigationLink = _decorate([Object(lit_element["c" /* customElement */])('v-secondary-navigation-link')], function (_initialize, _LitElement) {
  var VSecondaryNavigationLink = /*#__PURE__*/function (_LitElement2) {
    _inherits(VSecondaryNavigationLink, _LitElement2);

    var _super = _createSuper(VSecondaryNavigationLink);

    function VSecondaryNavigationLink() {
      var _this;

      _classCallCheck(this, VSecondaryNavigationLink);
    ...
    return VSecondaryNavigationLink;
  }(_LitElement);

  return {
    F: VSecondaryNavigationLink,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_secondary_navigation_link_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_secondary_navigation_link_templateObject(), this.path, this._classList(), this.target === '_blank' ? 'open in ' + this.getAttribute('path') + ' new tab' : 'redirects to ' + this.getAttribute('path'), this.target, this.target === '_blank' ? Object(lit_element["d" /* html */])(_templateObject2()) : '');
      }
    }, {
      kind: "field",
      key: "_classList",
