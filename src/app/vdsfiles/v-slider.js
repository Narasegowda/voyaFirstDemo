...
/******/ 	return __webpack_require__(__webpack_require__.s = "oo/6");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VSlider", function() { return /* binding */ v_slider_VSlider; });
...
// CONCATENATED MODULE: ./src/components/v-slider/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    box-sizing: border-box;\n    display: block;\n  }\n\n  /* Below styles adapted from https://css-tricks.com/styling-cross-browser-compatible-range-inputs-css/ */\n  /* Reset default styling in all browsers */\n  input[type='range'] {\n    -webkit-appearance: none; /* Hides the slider so that custom slider can be made */\n    background: transparent; /* Otherwise white in Chrome */\n    margin: 0;\n    width: 100%; /* Specific width is required for Firefox. */\n  }\n\n  input[type='range']::-webkit-slider-thumb {\n    -webkit-appearance: none;\n  }\n\n  input[type='range']:focus {\n    outline: none; /* Removes the blue border. */\n  }\n\n  input[type='range']::-ms-track {\n    /* Hides the slider so custom styles can be added */\n    background: transparent;\n    border-color: transparent;\n    color: transparent;\n    cursor: pointer;\n    width: 100%;\n  }\n\n  /* Many styles below are shared across browsers. Unfortunately, they do not */\n  /* apply properly unless declared independently. */\n\n  /* Chrome & Safari Styles */\n  input[type='range']::-webkit-slider-thumb {\n    -webkit-appearance: none;\n    background: var(--v-colors__white);\n    border-radius: 50%;\n    border: solid 5px var(--v-colors__primary);\n    box-shadow: 0 2px 4px 0 var(--v-colors__box-shadow-25);\n    cursor: pointer;\n    height: 24px;\n    margin-top: -10px; /* You need to specify a margin in Chrome, but in Firefox and IE it is automatic */\n    position: relative;\n    width: 24px;\n    z-index: 3;\n  }\n\n  input[type='range'].error::-webkit-slider-thumb {\n    border: solid 5px var(--v-states__error-color);\n    box-shadow: 0 2px 4px 0 var(--v-states__error-box-shadow);\n  }\n\n  input[type='range'].disabled::-webkit-slider-thumb {\n    border: solid 5px var(--v-states__disabled-color);\n  }\n\n  input[type='range']::-webkit-slider-runnable-track {\n    background-color: var(--v-colors__gray);\n    border-radius: 5px;\n    cursor: pointer;\n    height: 4px;\n    width: 100%;\n  }\n\n  input[type='range'].error::-webkit-slider-runnable-track {\n    background-color: var(--v-colors__gray);\n  }\n\n  input[type='range']:focus::-webkit-slider-thumb,\n  input[type='range'].error:focus::-webkit-slider-thumb {\n    box-shadow: var(--v-states__focus-box-shadow);\n  }\n\n  #lower-fill {\n    background-color: var(--v-colors__primary);\n    border-radius: 5px 0 0 5px;\n    box-sizing: border-box;\n    height: 9px;\n    pointer-events: none;\n    position: absolute;\n    transform: translateY(-10px);\n    z-index: 2;\n  }\n\n  #lower-fill.error {\n    background-color: var(--v-states__error-color);\n  }\n\n  #lower-fill.disabled {\n    background-color: var(--v-states__disabled-color);\n  }\n\n  /* Firefox Styles */\n  input[type='range']::-moz-range-thumb {\n    background: var(--v-colors__white);\n    border-radius: 50%;\n    border: solid 5px var(--v-colors__primary);\n    box-shadow: 0 2px 4px 0 var(--v-colors__box-shadow-25);\n    box-sizing: border-box;\n    cursor: pointer;\n    height: 24px;\n    width: 24px;\n  }\n\n  input[type='range'].error::-moz-range-thumb {\n    border: solid 5px var(--v-states__error-color);\n    box-shadow: 0 2px 4px 0 var(--v-states__error-box-shadow);\n  }\n\n  input[type='range']::-moz-range-track {\n    background-color: var(--v-colors__gray);\n    border-radius: 5px;\n    cursor: pointer;\n    height: 4px;\n    width: 100%;\n  }\n\n  input[type='range'].error::-moz-range-track {\n    background-color: var(--v-colors__gray);\n  }\n\n  input[type='range']::-moz-focus-outer {\n    border: 0;\n  }\n\n  input[type='range']:focus::-moz-range-thumb,\n  input[type='range'].error:focus::-moz-range-thumb {\n    box-shadow: var(--v-states__focus-box-shadow);\n  }\n\n  input[type='range']::-moz-range-progress {\n    background-color: var(--v-colors__primary);\n    border-radius: 5px 0 0 5px;\n    height: 9px;\n  }\n\n  input[type='range'].error::-moz-range-progress {\n    background-color: var(--v-states__error-color);\n  }\n\n  input[type='range']::-ms-thumb {\n    background-color: var(--v-colors__white);\n    border-radius: 50%;\n    border: solid 5px var(--v-colors__primary);\n    box-shadow: 0 2px 4px 0 var(--v-colors__box-shadow-25);\n    box-sizing: border-box;\n    cursor: pointer;\n    height: 24px;\n    margin-top: 10%;\n    width: 24px;\n  }\n\n  input[type='range'].error::-ms-thumb {\n    border: solid 5px var(--v-states__error-color);\n    box-shadow: 0 2px 4px 0 var(--v-states__error-box-shadow);\n  }\n\n  input[type='range'].disabled::-ms-thumb {\n    border: solid 5px var(--v-states__disabled-color);\n  }\n\n  input[type='range']:focus::-ms-thumb,\n  input[type='range'].error:focus::-ms-thumb {\n    box-shadow: var(--v-states__focus-box-shadow);\n  }\n\n  /* Below styles are specific to Edge. The CSS variables for color are not */\n  /* interpreted correctly when in a border declaration. They are however */\n  /* interpreted correctly as box-shadow. */\n\n  @supports (-ms-ime-align: auto) {\n    input[type='range']::-ms-thumb {\n      border: none;\n      box-shadow: 0 2px 4px 0 var(--v-colors__box-shadow-25),\n        inset 0px 0px 0px 5px var(--v-colors__primary);\n    }\n\n    input[type='range'].error::-ms-thumb {\n      border: none;\n      box-shadow: 0 2px 4px 0 var(--v-states__error-box-shadow),\n        inset 0px 0px 0px 5px var(--v-states__error-color);\n    }\n\n    input[type='range']:focus::-ms-thumb {\n      box-shadow: inset 0px 0px 0px 5px var(--v-colors__primary),\n        var(--v-states__focus-box-shadow);\n    }\n\n    input[type='range'].error:focus::-ms-thumb {\n      box-shadow: var(--v-states__focus-box-shadow),\n        inset 0px 0px 0px 5px var(--v-states__error-color);\n    }\n  }\n\n  input[type='range']::-ms-track {\n    background: transparent;\n    border-color: transparent;\n    border-width: 16px 0;\n    color: transparent;\n    cursor: pointer;\n    height: 4px;\n    width: 100%;\n  }\n\n  input[type='range']::-ms-fill-lower {\n    background-color: var(--v-colors__primary);\n    border-radius: 5px;\n    height: 9px;\n  }\n\n  input[type='range'].error::-ms-fill-lower {\n    background-color: var(--v-states__error-color);\n  }\n\n  input[type='range'].disabled::-ms-fill-lower {\n    background-color: var(--v-states__disabled-color);\n  }\n\n  input[type='range']::-ms-fill-upper {\n    background-color: var(--v-colors__gray);\n    border-radius: 5px;\n  }\n\n  input[type='range'].error::-ms-fill-upper {\n    background-color: var(--v-colors__gray);\n  }\n\n  input[type='range'].disabled::-ms-fill-upper {\n    background-color: var(--v-colors__gray);\n  }\n\n  .hidden {\n    display: none;\n  }\n"]);
...
/* harmony default export */ var v_slider_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-slider/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_slider_taggedTemplateLiteral(["\n            <div id=\"labelledBy-", "\" class=\"hidden\">\n              ", "\n            </div>\n            <div\n              class=", "\n              id=\"lower-fill\"\n            />\n          "]);
...
function v_slider_templateObject() {
  var data = v_slider_taggedTemplateLiteral(["\n      <input\n        @change=", "\n        @input=", "\n        class=", "\n        max=", "\n        min=", "\n        step=", "\n        type=\"range\"\n        value=", "\n        ?disabled=", "\n      />\n      ", "\n    "]);

  v_slider_templateObject = function _templateObject() {
    return data;
  };
...
function v_slider_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_slider_VSlider = _decorate([Object(lit_element["c" /* customElement */])('v-slider')], function (_initialize, _LitElement) {
  var VSlider = /*#__PURE__*/function (_LitElement2) {
    _inherits(VSlider, _LitElement2);

    var _super = _createSuper(VSlider);

    // There are native CSS pseudoselectors for the "filled" section of
    // the range in IE11, Edge, and Firefox, but not Chrome or Safari.
    function VSlider() {
      var _this;
      ...
      _this.isChromeOrSafari = Object(utils["u" /* isSafari */])() || Object(utils["n" /* isChrome */])();
      return _this;
    }
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_slider_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        this.$lowerFill = this.shadowRoot.querySelector('#lower-fill');
        this.$input = this.shadowRoot.querySelector("input[type='range']"); // Added to support collapsing side menu for demopage ONLY

        if (document.querySelector('v-demo-app')) {
          this.$vDemoElement = document.querySelector('v-demo-app');
          this.$sideBarButton = this.$vDemoElement.shadowRoot.querySelector('div.demo-container button.sidebar-button');
          this.collapseSideBarHandler = this._setLowerFillForCollapsed.bind(this);
          this.$sideBarButton.addEventListener('click', this.collapseSideBarHandler);
        } // Debounce to limit the number of calls to this._setLowerFill.


        this._resizeCallback = lodash_debounce_default()(this._setLowerFill.bind(this), 30);

        this._assignAriaAttributes();

        if (this.isChromeOrSafari) window.addEventListener('resize', this._resizeCallback);
      }
    }, {
      kind: "method",
      key: "updated",
      value: function updated(changedProperties) {
        if (changedProperties.has('value')) {
          ...
          this.$input.setAttribute('aria-valuetext', this.ariaReaderPrefix + this.value + this.ariaReaderSuffix);
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_slider_templateObject(), this._handleInput, this._handleInput, Object(class_map["a" /* classMap */])({
          error: this.error,
          disabled: this.disabled
        }), this.max, this.min, this.step, this.value, this.disabled, this.isChromeOrSafari ? Object(lit_element["d" /* html */])(_templateObject2(), this.id, this.altLabel, Object(class_map["a" /* classMap */])({
          error: this.error,
          disabled: this.disabled
        })) : undefined);
      }
      ...
      kind: "method",
      key: "_assignAriaAttributes",
      value: function _assignAriaAttributes() {
        this.$input.setAttribute('role', 'slider');
        this.$input.setAttribute('aria-labelledby', 'labelledBy-' + this.id);
        this.$input.setAttribute('aria-valuenow', this.value);
        this.$input.setAttribute('aria-valuetext', this.ariaReaderPrefix + this.value + this.ariaReaderSuffix);
        this.$input.setAttribute('aria-valuemax', this.max);
        this.$input.setAttribute('aria-valuemin', this.min);
      ...
      kind: "method",
      key: "_correctValue",
      value: function _correctValue() {
        var nextValue;
        if (this.value > this.max) nextValue = this.max;
        if (this.value < this.min) nextValue = this.min;
      ...
      value: function _dispatchChangeEvent() {
        this.dispatchEvent(new CustomEvent('vslider-change', {
          bubbles: true,
          composed: true,
          detail: {
            value: this.value
      ...
      kind: "method",
      key: "_getLeftRightPadding",
      value: function _getLeftRightPadding() {
      ...
      value: function _handleInput(e) {
        ...
        if (this.isChromeOrSafari) this._setLowerFill();
        this.dispatchEvent(new CustomEvent('vpdfviewer-scroll', {
          bubbles: true,
          composed: true,
          detail: {
            value: this.value
      ...
      kind: "method",
      key: "_setLowerFill",
      value: function _setLowerFill() {
        var actualContainerWidth = this.offsetWidth - this._getLeftRightPadding();

        var ratioFilled = (this.value - this.min) / (this.max - this.min);
        var width = actualContainerWidth * ratioFilled; // These conditionals correct for minor gaps/overages in fill coverage.

        if (ratioFilled < 0.2) width += 10;
        if (ratioFilled > 0.8) width -= 10;
        this.$lowerFill.style.width = "".concat(width, "px");
      }
    }, {
      kind: "method",
      key: "_setLowerFillForCollapsed",
      value: function _setLowerFillForCollapsed() {
        // Function to handle side nav closed/reopen and maintain slider widths
        var newContainerWidth = this.offsetWidth + 250 - this._getLeftRightPadding();

        var newRatioFilled = (this.value - this.min) / (this.max - this.min);
        this.$lowerFill = this.shadowRoot.querySelector('#lower-fill');
        var width = newContainerWidth * newRatioFilled; // These conditionals correct for minor gaps/overages in fill coverage.

        if (this.ratioFilled < 0.2) width += 10;
        if (this.ratioFilled > 0.8) width -= 10;
