...
/******/ 	return __webpack_require__(__webpack_require__.s = "Ktg8");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VArticleInfoBarTopics", function() { return /* binding */ v_article_infobar_topics_VArticleInfoBarTopics; });
...
// CONCATENATED MODULE: ./src/components/v-article-infobar-topics/styles.js
...
/* harmony default export */ var v_article_infobar_topics_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-article-infobar-topics/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_article_infobar_topics_templateObject() {
  var data = v_article_infobar_topics_taggedTemplateLiteral(["\n      <div class=\"links\">\n        <a href=", " title=\"", "\">", "</a>\n      </div>\n    "]);

  v_article_infobar_topics_templateObject = function _templateObject() {
    return data;
  };
...
function v_article_infobar_topics_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_article_infobar_topics_VArticleInfoBarTopics = _decorate([Object(lit_element["c" /* customElement */])('v-article-infobar-topics')], function (_initialize, _LitElement) {
  var VArticleInfoBarTopics = /*#__PURE__*/function (_LitElement2) {
    _inherits(VArticleInfoBarTopics, _LitElement2);

    var _super = _createSuper(VArticleInfoBarTopics);

    function VArticleInfoBarTopics() {
      var _this;

      _classCallCheck(this, VArticleInfoBarTopics);
    ...
    return VArticleInfoBarTopics;
  }(_LitElement);

  return {
    F: VArticleInfoBarTopics,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_article_infobar_topics_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_article_infobar_topics_templateObject(), this.link, this.text, this.text);
      }
    }]
  };
