...
/******/ 	return __webpack_require__(__webpack_require__.s = "GXq+");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VCarousel", function() { return /* binding */ v_carousel_VCarousel; });

// EXTERNAL MODULE: ./node_modules/lit-element/lit-element.js + 5 modules
var lit_element = __webpack_require__("CQbg");

// CONCATENATED MODULE: ./src/components/v-carousel/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    display: inline;\n    position: relative;\n    width: 100%;\n  }\n  .carousel-wrapper {\n    box-shadow: 0 10px 20px -1px rgba(51, 51, 51, 0.1);\n    box-shadow: 0 10px 20px -1px var(--v-colors__box-shadow-10);\n    border-radius: 10px;\n    max-width: 1360px;\n  }\n  #carousel-container {\n    width: 100%;\n    height: auto;\n    border-radius: 10px;\n    border-bottom-right-radius: 0;\n    border-bottom-left-radius: 0;\n    color: var(--v-colors__black);\n    margin: 0 auto;\n    position: relative;\n  }\n\n  slot {\n    position: relative;\n    height: 100%;\n    display: flex;\n    overflow: hidden;\n  }\n  #next,\n  #previous {\n    transition: ease-in 4s;\n  }\n  button {\n    background: transparent;\n    border: 0;\n    font-size: 0;\n    padding: 0;\n    transition: ease-in 0.6s;\n    border-color: var(--v-colors__voya-dark-orange);\n  }\n  button:focus {\n    border-radius: 50%;\n    box-shadow: var(--v-states__focus-box-shadow);\n    outline: none;\n  }\n  svg {\n    padding: 4px;\n    border-radius: 50%;\n    width: 30px;\n    height: 30px;\n    object-fit: contain;\n    cursor: pointer;\n    box-sizing: border-box;\n    border: 2px solid black;\n    fill: black;\n  }\n  .primary svg {\n    border: 2px solid var(--v-colors__primary);\n    fill: var(--v-colors__primary);\n  }\n  .secondary svg {\n    border: 2px solid var(--v-colors__secondary);\n    fill: var(--v-colors__secondary);\n  }\n  .tertiary svg {\n    border: 2px solid var(--v-colors__tertiary);\n    fill: var(--v-colors__tertiary);\n  }\n  .grey svg {\n    border: 2px solid var(--v-colors__gray-medium-1);\n    fill: var(--v-colors__gray-medium-1);\n  }\n  .plum svg {\n    border: 2px solid var(--v-colors__quaternary);\n    fill: var(--v-colors__quaternary);\n  }\n  .dark-orange svg {\n    border: 2px solid var(--v-colors__voya-dark-orange);\n    fill: var(--v-colors__voya-dark-orange);\n  }\n\n  .controls {\n    display: flex;\n    justify-content: space-between;\n    padding: 20px 40px;\n    position: relative;\n    border-bottom-left-radius: 10px;\n    border-bottom-right-radius: 10px;\n    top: 0;\n    background-color: var(--v-colors__white);\n  }\n  .previousButtonClass {\n    transform: rotate(180deg);\n  }\n  #dots {\n    width: 70%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n  .dot {\n    border-radius: 50%;\n    background-color: var(--v-colors__white);\n    margin: 0 10px 0 0;\n    height: 12px;\n    width: 12px;\n    cursor: pointer;\n    border: 1px solid var(--v-colors__secondary);\n  }\n  .activeDot {\n    background-color: var(--v-colors__secondary);\n  }\n  .primaryDot {\n    background-color: var(--v-colors__primary);\n  }\n  .secondaryDot {\n    background-color: var(--v-colors__secondary);\n  }\n  .tertiaryDot {\n    background-color: var(--v-colors__tertiary);\n  }\n  .greyDot {\n    background-color: var(--v-colors__gray-medium-1);\n  }\n  .plumDot {\n    background-color: var(--v-colors__quaternary);\n  }\n  .darkOrangeDot {\n    background-color: var(--v-colors__voya-dark-orange);\n  }\n\n  @media (max-width: 1024px) {\n    #carousel-container {\n      height: auto;\n    }\n  }\n\n  @media (max-width: 994px) {\n    #carousel-container {\n      height: auto;\n    }\n  }\n\n  @media (max-width: 768px) {\n    #carousel-container {\n      height: auto;\n    }\n  }\n\n  @media (max-width: 700px) {\n    #carousel-container {\n      height: auto;\n    }\n  }\n\n  @media (max-width: 414px) {\n    #carousel-container {\n      height: auto;\n    }\n    .controls {\n      display: flex;\n      justify-content: space-between;\n      padding: 20px;\n      position: relative;\n      border-bottom-left-radius: 10px;\n      border-bottom-right-radius: 10px;\n      top: 0;\n    }\n  }\n\n  @media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {\n    .slot-wrapper {\n      position: relative;\n      height: 100%;\n      display: flex;\n      overflow: hidden;\n    }\n  }\n\n  @supports (-ms-ime-align: auto) {\n    /* Edge 16+ CSS */\n    .slot-wrapper {\n      position: relative;\n      height: 100%;\n      display: flex;\n      overflow: hidden;\n    }\n  }\n\n  .show {\n    display: block;\n  }\n\n  .hide {\n    display: none;\n  }\n"]);
...
/* harmony default export */ var v_carousel_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/styles/commonStyles.js
var commonStyles = __webpack_require__("ONJ/");

// CONCATENATED MODULE: ./src/components/v-carousel/svgs/chevron-right-dark.js
function chevron_right_dark_templateObject() {
  var data = chevron_right_dark_taggedTemplateLiteral(["\n  <svg\n    xmlns=\"http://www.w3.org/2000/svg\"\n    width=\"40\"\n    height=\"40\"\n    viewBox=\"0 0 40 40\"\n    aria-label=\"Chevron right icon\"\n  >\n    <path\n      fill-rule=\"nonzero\"\n      d=\"M29 20c0 .24-.124.511-.31.691L14.279 34.7c-.185.18-.464.301-.711.301a1.08 1.08 0 0 1-.711-.3l-1.547-1.504a.966.966 0 0 1-.309-.691c0-.24.124-.511.31-.691L23.463 20 11.309 8.186c-.185-.18-.309-.45-.309-.691 0-.24.124-.511.31-.691L12.855 5.3c.185-.18.464-.301.711-.301.247 0 .526.12.711.3L28.691 19.31c.185.18.309.45.309.691z\"\n    />\n  </svg>\n"]);

  chevron_right_dark_templateObject = function _templateObject() {
    return data;
  };
...
function chevron_right_dark_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


/* harmony default export */ var chevron_right_dark = (Object(lit_element["d" /* html */])(chevron_right_dark_templateObject()));
// CONCATENATED MODULE: ./src/components/v-carousel/svgs/chevron-left-dark.js
function chevron_left_dark_templateObject() {
  var data = chevron_left_dark_taggedTemplateLiteral(["\n  <svg\n    xmlns=\"http://www.w3.org/2000/svg\"\n    width=\"40\"\n    height=\"40\"\n    viewBox=\"0 0 40 40\"\n    class=\"previousButtonClass\"\n    aria-label=\"Chevron left icon\"\n  >\n    <path\n      fill-rule=\"nonzero\"\n      d=\"M29 20c0 .24-.124.511-.31.691L14.279 34.7c-.185.18-.464.301-.711.301a1.08 1.08 0 0 1-.711-.3l-1.547-1.504a.966.966 0 0 1-.309-.691c0-.24.124-.511.31-.691L23.463 20 11.309 8.186c-.185-.18-.309-.45-.309-.691 0-.24.124-.511.31-.691L12.855 5.3c.185-.18.464-.301.711-.301.247 0 .526.12.711.3L28.691 19.31c.185.18.309.45.309.691z\"\n    />\n  </svg>\n"]);

  chevron_left_dark_templateObject = function _templateObject() {
    return data;
  };
...
function chevron_left_dark_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


/* harmony default export */ var chevron_left_dark = (Object(lit_element["d" /* html */])(chevron_left_dark_templateObject()));
// CONCATENATED MODULE: ./src/utils/getAssignedElements.js
var getAssignedElements = function getAssignedElements(component) {
  return Array.prototype.filter.call(component.shadowRoot.querySelector('slot').assignedNodes(), function (e) {
    return e.nodeType === Node.ELEMENT_NODE;
  });
};

/* harmony default export */ var utils_getAssignedElements = (getAssignedElements);
// EXTERNAL MODULE: ./src/utils/keyboardAccessibility.js
var keyboardAccessibility = __webpack_require__("BAbn");

// CONCATENATED MODULE: ./src/components/v-carousel/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_carousel_taggedTemplateLiteral(["\n                <nav\n                  data-index=\"", "\"\n                  class=\"dot\"\n                  @click=", "\n                  @keypress=", "\n                  aria-label=\"Click for item ", "\"\n                  role=\"navigation\"\n                  tabindex=\"0\"\n                ></nav>\n              "]);
...
function v_carousel_templateObject() {
  var data = v_carousel_taggedTemplateLiteral(["\n      <div class=\"carousel-wrapper\">\n        <div id=\"carousel-container\">\n          <div class=\"slot-wrapper\">\n            <slot></slot>\n          </div>\n        </div>\n        <div class=\"controls\">\n          <a\n            id=\"previous\"\n            class=", "\n            data-label=\"previous\"\n            @click=", "\n            @keypress=", "\n            tabindex=\"0\"\n          >\n            ", "\n          </a>\n          <div id=\"dots\">\n            ", "\n          </div>\n          <a\n            id=\"next\"\n            class=", "\n            data-label=\"next\"\n            @click=", "\n            @keypress=", "\n            tabindex=\"0\"\n          >\n            ", "\n          </a>\n        </div>\n      </div>\n    "]);

  v_carousel_templateObject = function _templateObject() {
    return data;
  };
...
function v_carousel_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_carousel_VCarousel = _decorate([Object(lit_element["c" /* customElement */])('v-carousel')], function (_initialize, _LitElement) {
  var VCarousel = /*#__PURE__*/function (_LitElement2) {
    _inherits(VCarousel, _LitElement2);

    var _super = _createSuper(VCarousel);

    function VCarousel() {
      var _this;

      _classCallCheck(this, VCarousel);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_carousel_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        this.elements = utils_getAssignedElements(this);
        this.slideCount = this.elements.length;
        this.a = this.shadowRoot.querySelector('slot');

        for (var slideIndex = 0; slideIndex < this.slideCount; slideIndex++) {
          this.elements[slideIndex].style.display = 'none';
        }
      ...
      value: function value() {
        ...
        return function (e) {
          _this2.showSlide(_this2.index += -1);
      ...
      kind: "field",
      key: "previousOnKeypress",
      value: function value() {
        var _this3 = this;

        return function (e) {
          if (Object(keyboardAccessibility["a" /* enterKeypress */])(e)) {
            _this3.showSlide(_this3.index += -1);
      ...
      value: function value() {
        ...
        return function (e) {
          _this4.showSlide(_this4.index += 1);
      ...
      value: function value() {
        ...
        return function (e) {
          if (Object(keyboardAccessibility["a" /* enterKeypress */])(e)) {
            _this5.showSlide(_this5.index += 1);
      ...
      value: function value() {
        ...
        return function (dotIndex) {
          _this6.showSlide(_this6.index = dotIndex);
        };
      }
    }, {
      kind: "field",
      key: "goToSlideOnKeypress",
      value: function value() {
        var _this7 = this;

        return function (event, dotIndex) {
          if (Object(keyboardAccessibility["a" /* enterKeypress */])(event)) {
            _this7.showSlide(_this7.index = dotIndex);
          }
        };
      }
    }, {
      ...
      value: function value() {
        ...
        return function (index) {
          return _this8.shadowRoot.querySelector(".dot[data-index=\"".concat(index, "\"]"));
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function (index) {
          var dotColor = _this9.dotColor;

          if (index > _this9.slideCount - 1) {
            _this9.index = 0;
          }

          if (index < 0) {
            _this9.index = _this9.slideCount - 1;
          }

          var leftPos = 0;

          if (index > _this9.index) {
            if (_this9.index === 0) {
              for (var i = 0; i < _this9.slideCount; i++) {
                _this9.elements[i].style.left = 0;
              }
            } else {
              for (var _i = 0; _i < _this9.index; _i++) {
                leftPos = (_i + 1) * -100 + '%';
                _this9.elements[_i].style.left = (_i + 1) * -100 + '%';
              }
            }
          } else {
            for (var _i2 = 0; _i2 < _this9.slideCount; _i2++) {
              if (_i2 < _this9.index) {
                leftPos = (_i2 + 1) * -100 + '%';
                _this9.elements[_i2].style.left = (_i2 + 1) * -100 + '%';
              } else {
                _this9.elements[_i2].style.left = 0;
              }
            }
          }

          for (var _i3 = 0; _i3 < _this9.slideCount; _i3++) {
            if (dotColor === '') {
              _this9.getDotAt(_i3).classList.remove('activeDot', 'dotColor');
            } else {
              _this9.getDotAt(_i3).classList.remove('activeDot', dotColor);
            }
          }

          if (_this9.elements[_this9.index]) {
            _this9.elements[_this9.index].style.display = 'block';
            _this9.elements[_this9.index].style.left = leftPos;
          }

          for (var slideIndex = 0; slideIndex < _this9.slideCount; slideIndex++) {
            if (slideIndex !== _this9.index) {
              _this9.elements[slideIndex].style.display = 'none';
              _this9.elements[_this9.index].style.left = '0';
            }
          }

          _this9.currentTopic = _this9.elements[_this9.index] && _this9.elements[_this9.index].title ? _this9.elements[_this9.index].title.substring(0, 20) : '';

          if (dotColor === '') {
            _this9.getDotAt(_this9.index) && _this9.getDotAt(_this9.index).classList.add('activeDot');
          } else {
            _this9.getDotAt(_this9.index) && _this9.getDotAt(_this9.index).classList.add('activeDot', dotColor);
          }
        };
      }
    }, {
      ...
      value: function value() {
        ...
        return function () {
          return Object(lit_element["d" /* html */])(v_carousel_templateObject(), _this10.controlColor, _this10.previous, _this10.previousOnKeypress, chevron_left_dark, Array.prototype.slice.call(_this10.children).map(function (slide, index) {
            return Object(lit_element["d" /* html */])(_templateObject2(), index, function () {
              return _this10.goToSlide(index);
            }, function (event) {
              return _this10.goToSlideOnKeypress(event, index);
            }, index);
          }), _this10.controlColor, _this10.next, _this10.nextOnKeypress, chevron_right_dark);
        };
      }
    }]
  };
