...
/******/ 	return __webpack_require__(__webpack_require__.s = "OURC");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VLibraryLeftNavigation", function() { return /* binding */ v_library_left_navigation_VLibraryLeftNavigation; });

// EXTERNAL MODULE: ./node_modules/lit-element/lit-element.js + 5 modules
var lit_element = __webpack_require__("CQbg");

// CONCATENATED MODULE: ./src/components/v-library-left-navigation/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    margin-bottom: 10px;\n  }\n  .active {\n    text-decoration: underline;\n    font-weight: 600;\n    text-decoration-color: var(--v-colors__voya-dark-orange);\n    text-underline-position: under;\n  }\n  .widthFitContent {\n    width: 100%;\n  }\n  .firstLevelLink {\n    cursor: pointer;\n  }\n  .inActive {\n    display: none;\n  }\n  .activeDiv {\n    display: block;\n  }\n  .mobileViewIcon {\n    display: none;\n  }\n  .width100 {\n    width: 100%;\n  }\n  .headerClass {\n    color: var(--v-colors__primary);\n  }\n  .headerClass:hover {\n    color: var(--v-colors__primary-darker-1);\n  }\n  .wysiwyg-h5 {\n    font-size: var(--v-fonts__s);\n    margin: 0;\n    line-height: 26px;\n  }\n  .outlineColorTransparent {\n    outline-color: transparent;\n  }\n  .outlineColorBlack {\n    outline-color: var(--v-footer-disclaimer-color, #333333);\n  }\n\n  @media screen and (-ms-high-contrast: active),\n    screen and (-ms-high-contrast: none) {\n    .active {\n      text-decoration: none;\n    }\n    .active .underline {\n      border-bottom: 1px solid var(--v-colors__voya-dark-orange);\n    }\n  }\n\n  @media only screen and (max-width: 700px) {\n    :host {\n      padding-right: 10%;\n      border-bottom: 1px solid var(--v-colors__gray-medium-2);\n      margin-bottom: 0px;\n    }\n    .active {\n      text-decoration: none;\n      font-weight: 600;\n    }\n    .mobileActive {\n      font-weight: 600;\n      color: var(--v-colors__black);\n      border-bottom: none;\n    }\n    .tab {\n      font-size: var(--v-fonts__m);\n      font-weight: 600;\n      color: var(--v-colors__black);\n      margin-bottom: 0%;\n      width: 100% !important;\n      display: flex;\n    }\n    .headerClass {\n      width: 91%;\n    }\n    .mobileViewLink {\n      display: flex;\n      flex-direction: row;\n      padding: 20px 0 12px 20px;\n      width: 110%;\n      padding-left: 20px;\n    }\n\n    .mobileViewIcon {\n      display: block;\n    }\n    .mobileViewIconDown {\n      transform: rotate(90deg);\n    }\n    .widthFitContent {\n      margin-top: 0;\n    }\n  }\n"]);
...
/* harmony default export */ var v_library_left_navigation_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-library-left-navigation/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_library_left_navigation_templateObject() {
  var data = v_library_left_navigation_taggedTemplateLiteral(["\n      <div class=\"mobileViewLink\">\n        <div class=\"width100\">\n          <v-wysiwyg class=\"widthFitContent firstLevelLink tab\" tabindex=\"0\">\n            <p class=\"wysiwyg-h5 headerClass\" id=\"", "\">\n              <span class=\"underline\">", "</span>\n            </p>\n            <div class=\"mobileViewIcon\">\n              <v-icon primary name=\"chevronright\"></v-icon>\n            </div>\n          </v-wysiwyg>\n        </div>\n      </div>\n      <div id=\"", "Div\" class=\"widthFitContent inActive subDiv\">\n        <slot></slot>\n      </div>\n    "]);

  v_library_left_navigation_templateObject = function _templateObject() {
    return data;
  };
...
function v_library_left_navigation_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_library_left_navigation_VLibraryLeftNavigation = _decorate([Object(lit_element["c" /* customElement */])('v-library-left-navigation')], function (_initialize, _LitElement) {
  var VLibraryLeftNavigation = /*#__PURE__*/function (_LitElement2) {
    _inherits(VLibraryLeftNavigation, _LitElement2);

    var _super = _createSuper(VLibraryLeftNavigation);

    function VLibraryLeftNavigation() {
      var _this;

      _classCallCheck(this, VLibraryLeftNavigation);
    ...
    return VLibraryLeftNavigation;
  }(_LitElement);

  return {
    F: VLibraryLeftNavigation,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_library_left_navigation_styles];
      }
    }, {
      kind: "method",
      key: "connectedCallback",
      value: function connectedCallback() {
        ...
        _get(_getPrototypeOf(VLibraryLeftNavigation.prototype), "connectedCallback", this).call(this);

        this.shadowRoot.addEventListener('activateRightPanel', function (e) {
          _this2._activateRightPanel(e.detail);
        });
      }
    }, {
      kind: "method",
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        this.shadowRoot.removeEventListener('activateRightPanel', this._activateRightPanel);

        _get(_getPrototypeOf(VLibraryLeftNavigation.prototype), "disconnectedCallback", this).call(this);

        this.$tab.removeEventListener('mousedown', this._setListener);
        this.$tab.removeEventListener('keyup', this._setListener);
      }
    }, {
      kind: "field",
      key: "firstUpdated",
      value: function value() {
        ...
        return function () {
          _this3.$tab = _this3.shadowRoot.querySelector('.tab');
          _this3.$subDiv = _this3.shadowRoot.querySelector('.subDiv');
          _this3.$headerClass = _this3.shadowRoot.querySelector('.headerClass');
          _this3.$mobileViewIcon = _this3.shadowRoot.querySelector('.mobileViewIcon');
          _this3.$assignedElements = Object(utils["j" /* getSlottedElements */])(_this3);

          _this3._setTabListeners();
        };
      }
    }, {
      kind: "method",
      ...
      value: function updated(changedProperties) {
        if (changedProperties.has('selected')) {
          if (this.selected) {
            this.$tab.dispatchEvent(new Event('mousedown'));
          }
        }
      }
    }, {
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_library_left_navigation_templateObject(), this.subID, this.subHeaderText, this.subID);
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          _this4.$tab.addEventListener('mousedown', _this4._setListener);

          _this4.$tab.addEventListener('keyup', _this4._setListener);
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function (event) {
          if (event.type === 'mousedown') {
            _this5.$tab.classList.add('outlineColorTransparent');

            _this5.$tab.classList.remove('outlineColorBlack');
          } else if (Object(keyboardAccessibility["e" /* tabKeyup */])(event)) {
            _this5.$tab.classList.remove('outlineColorTransparent');

            _this5.$tab.classList.add('outlineColorBlack');
          }

          if (event.type === 'mousedown' || Object(keyboardAccessibility["b" /* enterKeyup */])(event)) {
            var classList = _this5.$subDiv.classList;

            if (classList.contains('inActive') || !Object(utils["t" /* isMobileDevice */])()) {
              _this5.$tab.classList.add('active');

              _this5.$subDiv.classList.add('activeDiv');

              _this5.$subDiv.classList.remove('inActive');

              _this5.$headerClass.classList.add('mobileActive'); //Opening Right panel


              if (!Object(utils["t" /* isMobileDevice */])() && !_this5.directLink) {
                var leftNavigationLinkRef = _this5.$headerClass.getAttribute('id') + '@';

                _this5.$assignedElements.forEach(function (leftNavigation) {
                  leftNavigationLinkRef = leftNavigationLinkRef + leftNavigation.getAttribute('linkref') + '~';
                });

                _this5._fire('activateParentRightPanelForMainLink', leftNavigationLinkRef + _this5.subHeaderText);
              } else if (!Object(utils["t" /* isMobileDevice */])() && _this5.directLink) {
                var _leftNavigationLinkRef = _this5.$headerClass.getAttribute('id') + '@' + _this5.linkRef;

                _this5._fire('activateParentRightPanelForMainLink', _leftNavigationLinkRef + '~' + _this5.subHeaderText);
              } else if (Object(utils["t" /* isMobileDevice */])() && _this5.directLink) {
                _this5._fire('activateParentRightPanel', _this5.linkRef + '~' + _this5.subHeaderText);
              } else {
                _this5.$mobileViewIcon.classList.add('mobileViewIconDown');

                var _leftNavigationLinkRef2 = _this5.$headerClass.getAttribute('id') + '@' + _this5.linkRef;

                _this5._fire('activateParentRightPanelForMainLinkMobile', _leftNavigationLinkRef2);
              }
            } else {
              if (Object(utils["t" /* isMobileDevice */])()) {
                _this5.$tab.classList.remove('active');

                _this5.$subDiv.classList.add('inActive');

                _this5.$subDiv.classList.remove('activeDiv');

                _this5.$headerClass.classList.remove('mobileActive');

                _this5.$mobileViewIcon.classList.remove('mobileViewIconDown');
              }
            }
          }
        };
      ...
      kind: "field",
      key: "_activateRightPanel",
      value: function value() {
        var _this6 = this;

        return function (linkRef) {
          _this6.$assignedElements.forEach(function (assignedElement) {
            var navigatonLink = assignedElement.shadowRoot.querySelector('.anch');
          ...
          _this6._fire('activateParentRightPanel', linkRef + '~' + _this6.subHeaderText);
        };
      }
    }, {
      kind: "method",
      key: "_fire",
      value: function _fire(eventType, tabName) {
