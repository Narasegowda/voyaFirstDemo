...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vPagination", function() { return /* binding */ v_pagination_vPagination; });
...
// CONCATENATED MODULE: ./src/components/v-pagination/styles.js
function _templateObject() {
...
/* harmony default export */ var v_pagination_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/keyboardAccessibility.js
var keyboardAccessibility = __webpack_require__("BAbn");

// CONCATENATED MODULE: ./src/components/v-pagination/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject3() {
  var data = v_pagination_taggedTemplateLiteral(["<span\n          >Showing ", " - ", " of ", "\n          results</span\n        >"]);
...
function _templateObject2() {
  var data = v_pagination_taggedTemplateLiteral([" <a\n                    aria-label=\"", "\"\n                    class=", "\n                    @click=", "\n                    @keypress=", "\n                    tabindex=\"", "\"\n                    >", "</a\n                  >"]);
...
function v_pagination_templateObject() {
  var data = v_pagination_taggedTemplateLiteral(["\n            <div class=\"pagination-container\">\n              ", "\n\n              <div class=\"pagination\">\n                <a\n                  aria-label=\"previous page\"\n                  @click=", "\n                  tabindex=\"", "\"\n                  @keypress=", "\n                >\n                  <v-icon\n                    size=\"30px\"\n                    color=", "\n                    class=\"", "\"\n                    name=\"chevronLeftCircle\"\n                  ></v-icon>\n                </a>\n\n                ", "\n\n                <a\n                  aria-label=\"next page\"\n                  @click=", "\n                  tabindex=\"", "\"\n                  @keypress=", "\n                >\n                  <v-icon\n                    size=\"30px\"\n                    color=", "\n                    class=\"", "\"\n                    name=\"chevronLeftCircle\"\n                  ></v-icon>\n                </a>\n              </div>\n            </div>\n          "]);

  v_pagination_templateObject = function _templateObject() {
    return data;
  };
...
function v_pagination_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_pagination_vPagination = _decorate([Object(lit_element["c" /* customElement */])('v-pagination')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_pagination_styles];
      }
    }, {
      kind: "field",
      ...
      value: function shouldUpdate() {
        if (this.config && Number(this.config.dataSize) !== this.dataSize && this.dataSize !== 0) {
          this.pages = [];
          this.dataSize = Number(this.config.dataSize);
          this.currentPage = Number(this.config.currentPage);
          this.itemsPerPage = Number(this.config.itemsPerPage);
      ...
      value: function render() {
        ...
        return this.config ? this.config.dataSize <= this.itemsPerPage ? undefined : Object(lit_element["d" /* html */])(v_pagination_templateObject(), this._getListMessage(), function () {
          ...
          return Object(lit_element["d" /* html */])(_templateObject2(), 'page ' + (page === '...' ? 'collapsed' : page), Object(class_map["a" /* classMap */])({
            pages: true,
      ...
      value: function value() {
        ...
        return function (event) {
          if (Object(keyboardAccessibility["a" /* enterKeypress */])(event) && _this5.currentPage < _this5.pages.length) {
            ++_this5.currentPage;
      ...
      value: function _getListMessage() {
        ...
        return this.config.conjunction === 'table' ? Object(lit_element["d" /* html */])(_templateObject3(), startIndex + 1, endIndex, this.config.dataSize) : undefined;
      }
    }, {
      kind: "method",
