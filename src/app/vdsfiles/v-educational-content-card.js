...
/******/ 	return __webpack_require__(__webpack_require__.s = "I9Lm");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VEducationalContentCard", function() { return /* binding */ v_educational_content_card_VEducationalContentCard; });
...
// CONCATENATED MODULE: ./src/components/v-educational-content-card/styles.js
...
/* harmony default export */ var v_educational_content_card_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./node_modules/resize-observer-polyfill/dist/ResizeObserver.es.js
var ResizeObserver_es = __webpack_require__("bdgK");

// CONCATENATED MODULE: ./src/components/v-educational-content-card/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject6() {
  var data = v_educational_content_card_taggedTemplateLiteral(["\n            <div class=", ">\n              <div class=\"card-details\">\n                <img\n                  class=\" headingDiv card-image\"\n                  alt=", "\n                  src=", "\n                />\n                <div class=\"heading4Div\">\n                  <div class=\"card-title hd-4\">", "</div>\n                </div>\n                <div>\n                  <p class=\"card-subtitle\">", "</p>\n                </div>\n                <div>", "</div>\n              </div>\n            </div>\n          "]);
...
function _templateObject3() {
  var data = v_educational_content_card_taggedTemplateLiteral(["\n            <v-button class=\"buttonPosition\" primary href=", "\n              >", "</v-button\n            >\n          "]);
...
function _templateObject2() {
  var data = v_educational_content_card_taggedTemplateLiteral(["\n            <v-button class=\"buttonPosition\" secondary href=", "\n              >", "</v-button\n            >\n          "]);
...
function v_educational_content_card_templateObject() {
  var data = v_educational_content_card_taggedTemplateLiteral(["\n      ", "\n    "]);

  v_educational_content_card_templateObject = function _templateObject() {
    return data;
  };
...
function v_educational_content_card_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_educational_content_card_VEducationalContentCard = _decorate([Object(lit_element["c" /* customElement */])('v-educational-content-card')], function (_initialize, _LitElement) {
  var VEducationalContentCard = /*#__PURE__*/function (_LitElement2) {
    _inherits(VEducationalContentCard, _LitElement2);

    var _super = _createSuper(VEducationalContentCard);

    function VEducationalContentCard() {
      var _this;

      _classCallCheck(this, VEducationalContentCard);

      _this = _super.call(this);

      _initialize(_assertThisInitialized(_this));

      _this.getContainerWidth = _this.getContainerWidth.bind(_assertThisInitialized(_this));
      return _this;
    }

    return VEducationalContentCard;
  }(_LitElement);

  return {
    F: VEducationalContentCard,
    d: [{
      kind: "field",
      ...
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(VEducationalContentCard.prototype), "connectedCallback", this) && _get(_getPrototypeOf(VEducationalContentCard.prototype), "connectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        ...
        _get(_getPrototypeOf(VEducationalContentCard.prototype), "disconnectedCallback", this) && _get(_getPrototypeOf(VEducationalContentCard.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "get",
      "static": true,
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_educational_content_card_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
              ...
              switch (_context.prev = _context.next) {
                ...
                case 4:
                  this.resizeObserver = new ResizeObserver_es["a" /* default */](function (entries) {
                    entries.length > 0 ? _this2.getContainerWidth() : undefined;
                  });
                  this.resizeObserver.observe(this.shadowRoot.querySelector('.card'));

                  if (this.noButton) {
                    el = this.shadowRoot.querySelector('.card');

                    if (el) {
                      el.classList.add('clickable');
                      el.addEventListener('click', this.redirect);
                    }
                  }

                  if (this.noShadow) {
                    _el = this.shadowRoot.querySelector('.card');

                    if (_el) {
                      _el.classList.add('noShadow');
                    }
                  }
      ...
      kind: "method",
      key: "smallClass",
      value: function smallClass() {
        return this.small ? 'card small' : 'card';
      }
    }, {
      kind: "method",
      key: "getSecondaryButton",
      value: function getSecondaryButton() {
        return Object(lit_element["d" /* html */])(v_educational_content_card_templateObject(), this.secondaryButton ? Object(lit_element["d" /* html */])(_templateObject2(), this.href, this.buttonText) : Object(lit_element["d" /* html */])(_templateObject3(), this.href, this.buttonText));
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          _this3.isEccLoaded = true;
          var offsetWidth = _this3.offsetWidth;
          var titleHeight = 'auto';
          var subTitleHeight = 'auto';

          if (offsetWidth < 270) {
            titleHeight = '150px';
            subTitleHeight = '198px';
          } else if (offsetWidth > 270 && offsetWidth <= 304) {
            titleHeight = '120px';
            subTitleHeight = '138px';
          } else if (offsetWidth > 305 && offsetWidth <= 413) {
            //335
            titleHeight = '90px';
            subTitleHeight = '118px';
          } else if (offsetWidth > 413 && offsetWidth <= 440) {
            titleHeight = '80px';
            subTitleHeight = '116px';
          } else if (offsetWidth > 440) {
            //630 0670
            titleHeight = '50px';
            subTitleHeight = '74px';
          }

          if (_this3.shadowRoot.querySelector('.card-title')) {
            _this3.shadowRoot.querySelector('.card-title').style.height = titleHeight;
          }

          if (_this3.shadowRoot.querySelector('.card-subtitle')) {
            _this3.shadowRoot.querySelector('.card-subtitle').style.height = subTitleHeight;
          }
        };
      }
    }, {
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(_templateObject4(), this.noButton ? Object(lit_element["d" /* html */])(_templateObject5(), this.smallClass(), this.imgAlt, this.imgSrc, this.title, this.body) : Object(lit_element["d" /* html */])(_templateObject6(), this.smallClass(), this.imgAlt, this.imgSrc, this.title, this.body, this.getSecondaryButton()));
      }
    }, {
      kind: "field",
      key: "redirect",
