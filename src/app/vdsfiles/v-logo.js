...
/******/ 	return __webpack_require__(__webpack_require__.s = "efWC");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VLogo", function() { return /* binding */ v_logo_VLogo; });
...
// CONCATENATED MODULE: ./src/components/v-logo/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  .logo_container {\n    box-shadow: 0 10px 20px -1px rgba(85, 27, 87, 0.1);\n    background-color: var(--v-colors__white);\n    width: 100%;\n  }\n  .logo_container nav {\n    min-height: 90px;\n    display: flex;\n    align-items: center;\n    justify-content: space-between;\n  }\n  .logo_container img {\n    width: 145px;\n  }\n  .brand-stripe_container {\n    position: relative;\n    width: 100%;\n    height: 25px;\n  }\n  .brand-stripe {\n    position: relative;\n    width: 100%;\n    height: 5px;\n    background-color: #f26622;\n    max-width: 1440px;\n    padding-right: 40px;\n  }\n\n  .link_wrapper a v-icon {\n    margin-right: 5px;\n  }\n\n  .link_wrapper a {\n    font-size: 18px;\n    display: flex;\n    align-items: center;\n    color: var(--v-colors__primary);\n    cursor: pointer;\n    text-decoration: underline;\n  }\n\n  .logoNav {\n    max-width: 1440px;\n    margin: auto;\n    padding: 0px 40px;\n  }\n\n  .logo_container .headerLogo {\n    margin: 0px;\n  }\n\n  .imageLogo {\n    width: fit-content;\n    height: auto;\n  }\n\n  @media only screen and (max-width: 1024px) {\n    .logoNav {\n      padding: 0px 20px;\n    }\n    .brand-stripe {\n      padding-right: 30px;\n    }\n    .brand-stripe_container {\n      padding-right: 30px;\n    }\n  }\n\n  @media only screen and (max-width: 768px) {\n    .brand-stripe {\n      padding-right: 20px;\n    }\n    .brand-stripe_container {\n      padding-right: 20px;\n    }\n  }\n"]);
...
/* harmony default export */ var v_logo_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/keyboardAccessibility.js
var keyboardAccessibility = __webpack_require__("BAbn");

// CONCATENATED MODULE: ./src/components/v-logo/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject11() {
  var data = v_logo_taggedTemplateLiteral([""]);
...
function _templateObject10() {
  var data = v_logo_taggedTemplateLiteral(["<div class=\"brand-stripe_container\">\n            <v-brand-stripe></v-brand-stripe>\n          </div>"]);
...
function _templateObject9() {
  var data = v_logo_taggedTemplateLiteral(["<div\n            class=\"brand-stripe\"\n            style=\"height:", ";\"\n          ></div>"]);
...
function _templateObject8() {
  var data = v_logo_taggedTemplateLiteral(["<a href=\"", "\" target=\"", "\">\n                <img\n                  alt=", "\n                  src=", "\n                  style=\"width:100%;max-width:", ";max-height:", "\"\n              /></a>"]);
...
function _templateObject7() {
  var data = v_logo_taggedTemplateLiteral([" <img\n                alt=", "\n                src=", "\n                class=\"imageLogo\"\n                style=\"width:100%;max-width:", ";max-height:", "\"\n              />"]);
...
function _templateObject5() {
  var data = v_logo_taggedTemplateLiteral(["<a\n                      @click=", "\n                      @keyup=", "\n                      class=\"anchor\"\n                      tabindex=\"0\"\n                    >\n                      <v-icon\n                        name=", "\n                        width=\"18px\"\n                        height=\"18px\"\n                        color=\"--v-colors__primary\"\n                      ></v-icon>\n                      ", "\n                    </a>"]);
...
function v_logo_templateObject() {
  var data = v_logo_taggedTemplateLiteral([" <div class=\"logo_container\">\n          ", "\n          <nav role=\"navigation\" class=\"logoNav\">\n            <div class=\"image_wrapper\">\n              ", "\n            </div>\n            <div class=\"link_wrapper\">\n              ", "\n            </div>\n          </nav>\n        </div>"]);

  v_logo_templateObject = function _templateObject() {
    return data;
  };
...
function v_logo_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_logo_VLogo = _decorate([Object(lit_element["c" /* customElement */])('v-logo')], function (_initialize, _LitElement) {
  var VLogo = /*#__PURE__*/function (_LitElement2) {
    _inherits(VLogo, _LitElement2);

    var _super = _createSuper(VLogo);

    function VLogo() {
      var _this;

      _classCallCheck(this, VLogo);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_logo_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        ...
        var cdnLogoUrl = cdnBaseUrl ? "".concat(cdnBaseUrl, "/global/images/logo/1.0.1/logo.svg") : '';
        var logoSrcUrl = this.src || cdnLogoUrl;
        var altText = this.alt || 'Voya Financial';
        var logoWidth = this.width;
        var logoHeight = this.height;
        return this._getHeaderLink(logoSrcUrl, altText, logoWidth, logoHeight);
      }
    }, {
      kind: "method",
      key: "_getHeaderLink",
      value: function _getHeaderLink(logoSrcUrl, altText, logoWidth, logoHeight) {
        var _this$config, _this$config$link, _this$config2, _this$config2$link;

        if (this.header && !this.config || this.header && this.config && !this.config.width) {
          logoWidth = '110px';
        } else if (this.config && this.config.width) {
          logoWidth = this.config.width;
        }

        if (this.config && this.config.height) {
          logoHeight = this.config.height;
        }

        return this.config || this.header ? Object(lit_element["d" /* html */])(v_logo_templateObject(), this._getBrandStripe(), this.logohref === '#' || !this.logohref ? Object(lit_element["d" /* html */])(_templateObject2(), altText, logoSrcUrl, logoWidth, logoHeight) : Object(lit_element["d" /* html */])(_templateObject3(), this.logohref, this.logotarget, this.target === '_blank' ? 'opens ' + altText + ' in new tab' : 'redirects to ' + altText + ' page', altText, logoSrcUrl, logoWidth, logoHeight), this.config && this.config.link ? this.config.link.href ? Object(lit_element["d" /* html */])(_templateObject4(), this.config.link.href || '#', this.config.link.target, this.config.link.icon, (_this$config = this.config) === null || _this$config === void 0 ? void 0 : (_this$config$link = _this$config.link) === null || _this$config$link === void 0 ? void 0 : _this$config$link.name) : Object(lit_element["d" /* html */])(_templateObject5(), this._dispatchEvent, this._handleKeyUp, this.config.link.icon, (_this$config2 = this.config) === null || _this$config2 === void 0 ? void 0 : (_this$config2$link = _this$config2.link) === null || _this$config2$link === void 0 ? void 0 : _this$config2$link.name) : "") : Object(lit_element["d" /* html */])(_templateObject6(), this.logohref === '#' || !this.logohref ? Object(lit_element["d" /* html */])(_templateObject7(), altText, logoSrcUrl, logoWidth, logoHeight) : Object(lit_element["d" /* html */])(_templateObject8(), this.logohref, this.logotarget, altText, logoSrcUrl, logoWidth, logoHeight));
      }
    }, {
      kind: "method",
      key: "_getBrandStripe",
      value: function _getBrandStripe() {
        var _this$config3, _this$config4;

        return ((_this$config3 = this.config) === null || _this$config3 === void 0 ? void 0 : _this$config3.brandStripe) ? ((_this$config4 = this.config) === null || _this$config4 === void 0 ? void 0 : _this$config4.stripeHeight) ? Object(lit_element["d" /* html */])(_templateObject9(), this.config.stripeHeight) : Object(lit_element["d" /* html */])(_templateObject10()) : Object(lit_element["d" /* html */])(_templateObject11());
      }
    }, {
      kind: "method",
      key: "_handleKeyUp",
      ...
      value: function _dispatchEvent(e) {
        this.dispatchEvent(new CustomEvent('vlogo-header-link-click', {
          bubbles: true,
          composed: true,
          detail: {
