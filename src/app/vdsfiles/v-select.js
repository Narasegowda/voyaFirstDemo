...
/******/ 	return __webpack_require__(__webpack_require__.s = "PjO/");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VSelect", function() { return /* binding */ v_select_VSelect; });
...
/* harmony default export */ var v_select_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/index.js + 8 modules
var utils = __webpack_require__("7Qib");

// CONCATENATED MODULE: ./src/components/v-select/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject5() {
  var data = v_select_taggedTemplateLiteral(["\n      <li\n        ?aria-selected=", "\n        @mousedown=", "\n        class=", "\n        data-index=", "\n        id=", "\n        role=\"option\"\n        value=", "\n      >\n        ", "\n      </li>\n    "]);
...
function _templateObject2() {
  var data = v_select_taggedTemplateLiteral([" <span>*</span> "]);
...
function v_select_templateObject() {
  var data = v_select_taggedTemplateLiteral(["\n      ", "\n      <div class=\"forWidth\"></div>\n      <button\n        ?aria-expanded=", "\n        ?disabled=", "\n        @click=", "\n        @keydown=", "\n        aria-haspopup=\"listbox\"\n        @keypress=", "\n        type=\"button\"\n        class=", "\n      >\n        <span>", "</span>\n        <v-icon\n          color=\"--v-colors__primary\"\n          class=", "\n          ?disabled=", "\n          ?error=", "\n          name=\"caretDown\"\n          size=\"15px\"\n        >\n        </v-icon>\n      </button>\n      <ul\n        aria-labelledby=", "\n        class=", "\n        role=\"listbox\"\n        tabindex=\"-1\"\n        id=", "\n        aria-activedescendant=", "\n        style=\"max-height:", "\"\n      >\n        ", "\n      </ul>\n      ", "\n      <slot></slot>\n    "]);

  v_select_templateObject = function _templateObject() {
    return data;
  };
...
function v_select_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_select_VSelect = _decorate([Object(lit_element["c" /* customElement */])('v-select')], function (_initialize, _LitElement) {
  var VSelect = /*#__PURE__*/function (_LitElement2) {
    _inherits(VSelect, _LitElement2);

    var _super = _createSuper(VSelect);

    // Properties that correspond to native `<select id="id" name="name" />` attributes
  ...
  return {
    ...
    d: [{
      ...
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(VSelect.prototype), "connectedCallback", this).call(this);
      ...
      value: function disconnectedCallback() {
        ...
        _get(_getPrototypeOf(VSelect.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "createRenderRoot",
      value: function createRenderRoot() {
        ...
        return this.hasAttribute('disable-shadow') ? this : _get(_getPrototypeOf(VSelect.prototype), "createRenderRoot", this).call(this);
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        if (!this.hasAttribute('disable-shadow')) {
          ...
          this.options = this.config && this.config.options && this.config.options.length > 0 && this.config.options.map(function (option, idx) {
            var text = option.innerText || option.text;
            var value = option.value;
            if (value === _this2.getAttribute('value')) _this2.selectedIdx = idx;
            return {
              text: text,
              value: value
            };
      ...
      value: function _appyWidth() {
        ...
        if (this.hasAttribute('disable-shadow')) {
          this.$wrapper = this.querySelector('.forWidth');
          this.$button = this.querySelector('.vSelectButton');
        } else {
          this.$wrapper = this.shadowRoot.querySelector('.forWidth');
          this.$button = this.shadowRoot.querySelector('.vSelectButton');
        }

        this.$wrapper.appendChild(div);
        this.options.forEach(function (option) {
          var para = document.createElement('P');
          para.innerHTML = option.text;
          div.appendChild(para);
        });
        var details = div.getBoundingClientRect();
        div.parentNode.removeChild(div);
        var width = details.width + 75;
        this.$wrapper.style.width = "".concat(width, "px");

        if (this.hasAttribute('disable-shadow') && this.width && this.width !== '') {
          this.querySelector('.vSelectButton').style.width = this.width;
        } else if (this.hasAttribute('disable-shadow')) {
          this.$button.style.width = "".concat(width, "px");
        }
      }
    }, {
      kind: "get",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_select_styles];
      }
    }, {
      kind: "method",
      key: "updated",
      value: function updated(changedProperties) {
        ...
        if (this.expanded && this.hasAttribute('disable-shadow')) {
          this.querySelector('.vSelectUl').style.width = this.querySelector('.vSelectButton').offsetWidth + 'px';
        }
      }
    }, {
      kind: "method",
      ...
      value: function render() {
        ...
        return Object(lit_element["d" /* html */])(v_select_templateObject(), this._labelTemplate(), this.expanded, this.disabled, this._toggleExpanded, this._handleKeyDown, this._handleKeyPress, Object(class_map["a" /* classMap */])({
          'has-error-text': Boolean(this.errorText),
          error: this.error,
          expanded: this.expanded,
          vSelectButton: 'vSelectButton'
        }), this._selectedOption().text, Object(class_map["a" /* classMap */])({
          vSelectIcon: 'vSelectIcon'
        }), this.disabled, this.error, this._ariaLabelledBy(), Object(class_map["a" /* classMap */])({
          expanded: this.expanded,
          vSelectUl: 'vSelectUl'
        }), this.id + 'selectbox', this._selectedOption().value, Object(lit_element["g" /* unsafeCSS */])(this.selectMaxHeight), this.options && this.options.length > 0 && this.options.map(function (_ref, index) {
          var text = _ref.text,
              value = _ref.value;
          return _this3._optionTemplate({
            index: index,
            text: text,
            value: value
          });
        }), this._errorTextTemplate());
      }
    }, {
      kind: "method",
      key: "_ariaLabelledBy",
      value: function _ariaLabelledBy() {
        return this.labelId ? this.labelId : this.ariaLabelledBy;
      }
    }, {
      kind: "method",
      key: "_assignOptions",
      value: function _assignOptions() {
        ...
        this.$options = Object(utils["j" /* getSlottedElements */])(this);
        this.options = this.$options && this.$options.length > 0 && this.$options.map(function (option, idx) {
          var text = option.innerText;
          var value = option.getAttribute('value');
          if (value === _this4.getAttribute('value')) _this4.selectedIdx = idx;
          return {
            text: text,
            value: value
          };
      ...
      kind: "method",
      key: "_asteriskTemplate",
      value: function _asteriskTemplate() {
        return this.required ? Object(lit_element["d" /* html */])(_templateObject2()) : undefined;
      }
    }, {
      kind: "method",
      key: "_dispatchChangeEvent",
      value: function _dispatchChangeEvent() {
        this.dispatchEvent(new CustomEvent('vselect-change', {
          bubbles: true,
          composed: true,
          detail: {
            value: this.value
      ...
      value: function _dispatchExpandEvent() {
        this.dispatchEvent(new CustomEvent('vselect-expand', {
          bubbles: true,
          composed: true,
          detail: {
            expanded: this.expanded
      ...
      kind: "method",
      key: "_errorTextTemplate",
      value: function _errorTextTemplate() {
        return this.errorText ? Object(lit_element["d" /* html */])(_templateObject3(), this.errorText, Object(class_map["a" /* classMap */])({
          vSelectErrorText: 'vSelectErrorText'
        }), Object(class_map["a" /* classMap */])({
          vSelectHr: 'vSelectHr'
        })) : undefined;
      }
    }, {
      ...
      value: function _handleKeyDown(e) {
        ...
        if (![27, 32, 38, 40].includes(keyCode)) return;
        e.preventDefault();

        if (!this.expanded || keyCode === 32) {
          this._toggleExpanded();
        } else if (keyCode === 27) {
          this._setExpandedFalse();
        } else if (keyCode === 38 && this.selectedIdx > 0) {
          this.selectedIdx--;
        } else if (keyCode === 40 && this.selectedIdx < this.options.length - 1) {
          this.selectedIdx++;
        }

        var elmnt = e.target.nextElementSibling.getElementsByTagName('li')[this.selectedIdx];
      ...
      value: function _handleKeyPress(e) {
        ...
        for (i; i < this.options.length; i++) {
          itemname = this.options[i].text.toLowerCase();

          if (this.options[i + 1] !== undefined) {
            nextitemname = this.options[i + 1].text.toLowerCase();
            var res = itemname.charAt(0);

            if (res === e.key) {
              if (nextitemname.charAt(0) === e.key) {
                if (this.prevkey === e.key) {
                  this.selectedIdx++;
                } else {
                  this.selectedIdx = i;
                  this.prevkey = e.key;
      ...
      value: function _handleMouseDown(e) {
        ...
        this.selectedIdx = parseInt(idx);

        this._setExpandedFalse();

        e.preventDefault();
        this.googleAnalytic(e);
      }
    }, {
      kind: "method",
      key: "_labelTemplate",
      value: function _labelTemplate() {
        return this.labelText ? Object(lit_element["d" /* html */])(_templateObject4(), Object(class_map["a" /* classMap */])({
          disabled: this.disabled,
          error: this.error,
          vSelectLabel: 'vSelectLabel'
        }), this.labelId, this._asteriskTemplate(), this.labelText) : undefined;
      }
    }, {
      kind: "method",
      key: "_optionTemplate",
      value: function _optionTemplate(_ref2) {
        var index = _ref2.index,
            text = _ref2.text,
            value = _ref2.value;
        return Object(lit_element["d" /* html */])(_templateObject5(), index === this.selectedIdx, this._handleMouseDown, Object(class_map["a" /* classMap */])({
          option: true,
          selected: index === this.selectedIdx,
          vSelectLi: 'vSelectLi'
        }), index, value + this.id, value, text);
      }
    }, {
      kind: "method",
      key: "_selectedOption",
      value: function _selectedOption() {
        return this.options[this.selectedIdx] || {};
      }
    }, {
      kind: "method",
      key: "_setExpandedFalse",
      value: function _setExpandedFalse() {
        this.expanded = false;
      }
    }, {
      kind: "method",
      ...
      kind: "method",
      key: "googleAnalytic",
      value: function googleAnalytic(e) {
        var nodes = [];
        ...
        if (window.dataLayer && typeof window.dataLayer.push === 'function') {
          window.dataLayer.push({
            event: 'GAEvent',
            eventCategory: 'V-SELECT',
            eventAction: 'change',
            eventLabel: '<value: ' + e.target.getAttribute('value') + '>',
            eventValue: 0,
