...
/******/ 	return __webpack_require__(__webpack_require__.s = "N3Bb");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vArticleList", function() { return /* binding */ v_article_list_vArticleList; });
...
/* harmony default export */ var v_article_list_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-article-list/slottedStyles.js
/* harmony default export */ var slottedStyles = ("\n  v-article-list-item {\n    padding: 0 0 40px 0;\n  }\n\n  v-article-list-item:last-of-type {\n    padding-right: 0px;\n  }\n\n  v-article-list[horizontal] v-article-list-item {\n    padding: 0 40px 0 0;\n  }\n\n  @media screen and (max-width: 768px) {\n    v-article-list-item {\n      padding: 0 0 40px 0;\n      width: 100%;\n    }\n\n    v-article-list[horizontal] v-article-list-item {\n      padding: 0 0 40px 0;\n    }\n  }\n");
// CONCATENATED MODULE: ./src/components/v-article-list/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_article_list_templateObject() {
  var data = v_article_list_taggedTemplateLiteral(["\n      <h2 class=\"article-header\">", "</h2>\n      <div class=\"", "\">\n        <slot></slot>\n      </div>\n      <v-button href=", " secondary>", "</v-button>\n    "]);

  v_article_list_templateObject = function _templateObject() {
    return data;
  };
...
function v_article_list_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_article_list_vArticleList = _decorate([Object(lit_element["c" /* customElement */])('v-article-list')], function (_initialize, _LitElement) {
  var vArticleList = /*#__PURE__*/function (_LitElement2) {
    _inherits(vArticleList, _LitElement2);

    var _super = _createSuper(vArticleList);

    function vArticleList() {
      var _this;

      _classCallCheck(this, vArticleList);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_article_list_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_article_list_templateObject(), this.listTitle, this.horizontal ? 'container' : '', this.buttonHref, this.buttonText);
      }
    }, {
      kind: "method",
