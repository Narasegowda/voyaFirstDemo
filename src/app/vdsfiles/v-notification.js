...
/******/ 	return __webpack_require__(__webpack_require__.s = "cBsO");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vNotification", function() { return /* binding */ v_notification_vNotification; });
...
// CONCATENATED MODULE: ./src/components/v-notification/styles.js
function _templateObject() {
...
/* harmony default export */ var v_notification_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-notification/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject4() {
  var data = v_notification_taggedTemplateLiteral([""]);
...
function v_notification_templateObject() {
  var data = v_notification_taggedTemplateLiteral(["\n      ", "\n    "]);

  v_notification_templateObject = function _templateObject() {
    return data;
  };
...
function v_notification_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_notification_vNotification = _decorate([Object(lit_element["c" /* customElement */])('v-notification')], function (_initialize, _LitElement) {
  var vNotification = /*#__PURE__*/function (_LitElement2) {
    _inherits(vNotification, _LitElement2);

    var _super = _createSuper(vNotification);

    function vNotification() {
      var _this;

      _classCallCheck(this, vNotification);
  ...
  return {
    ...
    d: [{
      ...
      kind: "field",
      decorators: [Object(lit_element["e" /* internalProperty */])({
        type: Boolean
      })],
      key: "notificationSeen",
      value: function value() {
        return false;
      }
    }, {
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], global_styles["a" /* default */], v_notification_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        if (!this.showOnClose && sessionStorage.getItem("".concat(this.name, "notificationSeen"))) {
      ...
      value: function closeNotification() {
        this.shadowRoot.querySelector('.notification-block').classList.add('hide');

        this._handleButtonClick();

        if (!this.showOnClose && this.name !== 'default') {
          this.notificationSeen = true;
          sessionStorage.setItem("".concat(this.name, "notificationSeen"), true);
        }
      }
    }, {
      kind: "method",
      ...
      value: function _handleButtonClick() {
        this.dispatchEvent(new CustomEvent('vnotification-close', {
          bubbles: true,
          composed: true
        }));
      }
      ...
      kind: "method",
      key: "_handleMouseover_button",
      value: function _handleMouseover_button() {
        this.shadowRoot.querySelector('.closeIcon').setAttribute('color', this.hoverColor);
      }
    }, {
      kind: "method",
      key: "_handleMouseout_button",
      value: function _handleMouseout_button() {
        this.shadowRoot.querySelector('.closeIcon').setAttribute('color', '--v-colors__black');
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_notification_templateObject(), !this.notificationSeen ? Object(lit_element["d" /* html */])(_templateObject2(), this.icon, this.iconColor, Object(unsafe_html["a" /* unsafeHTML */])(this.notificationText), this.linkHref && this.linkText ? Object(lit_element["d" /* html */])(_templateObject3(), this.linkHref, this.linkText) : '', this.closeNotification, this._handleMouseover_button, this._handleMouseout_button, this.disableClose ? 'close close-hidden' : 'close') : Object(lit_element["d" /* html */])(_templateObject4()));
      }
    }]
  };
