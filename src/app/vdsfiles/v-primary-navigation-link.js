...
/******/ 	return __webpack_require__(__webpack_require__.s = "BxYJ");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VPrimaryNavigationLink", function() { return /* binding */ v_primary_navigation_link_VPrimaryNavigationLink; });
...
/* harmony default export */ var v_primary_navigation_link_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/styles/commonStyles.js
var commonStyles = __webpack_require__("ONJ/");

// CONCATENATED MODULE: ./src/components/v-primary-navigation-link/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject3() {
  var data = v_primary_navigation_link_taggedTemplateLiteral([""]);
...
function _templateObject2() {
  var data = v_primary_navigation_link_taggedTemplateLiteral(["<div class=\"indicator-tab\"></div>"]);
...
function v_primary_navigation_link_templateObject() {
  var data = v_primary_navigation_link_taggedTemplateLiteral(["\n      <a href=", " class=", ">\n        <slot></slot>\n      </a>\n      ", "\n    "]);

  v_primary_navigation_link_templateObject = function _templateObject() {
    return data;
  };
...
function v_primary_navigation_link_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_primary_navigation_link_VPrimaryNavigationLink = _decorate([Object(lit_element["c" /* customElement */])('v-primary-navigation-link')], function (_initialize, _LitElement) {
  var VPrimaryNavigationLink = /*#__PURE__*/function (_LitElement2) {
    _inherits(VPrimaryNavigationLink, _LitElement2);

    var _super = _createSuper(VPrimaryNavigationLink);

    function VPrimaryNavigationLink() {
      var _this;

      _classCallCheck(this, VPrimaryNavigationLink);
    ...
    return VPrimaryNavigationLink;
  }(_LitElement);

  return {
    F: VPrimaryNavigationLink,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_primary_navigation_link_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        this.$primaryLinks = this.shadowRoot.querySelector('a');

        if (this.path && this.path === '') {
          this.activateSecondaryMenu();
        }
      }
    }, {
      kind: "method",
      ...
      value: function render() {
        return Object(lit_element["d" /* html */])(v_primary_navigation_link_templateObject(), this.path, this._anchorClasses(), this.active ? Object(lit_element["d" /* html */])(_templateObject2()) : Object(lit_element["d" /* html */])(_templateObject3()));
      }
    }, {
      kind: "method",
      key: "_anchorClasses",
      value: function _anchorClasses() {
      ...
      kind: "method",
      key: "activateSecondaryMenu",
      value: function activateSecondaryMenu() {
        var _this2 = this;

        this.$primaryLinks.addEventListener('click', function () {
          var linkName = _this2.primaryMenuIndex;

          _this2.dispatchEvent(new CustomEvent('activatesecondarymenu', {
            detail: {
              index: linkName,
              path: _this2.path
            },
