...
/******/ 	return __webpack_require__(__webpack_require__.s = "vCF/");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VProgressNavItem", function() { return /* binding */ v_progress_nav_item_VProgressNavItem; });
...
// CONCATENATED MODULE: ./src/components/v-progress-nav-item/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    display: flex;\n    flex: 1 1 0;\n    flex-direction: column;\n    align-items: center;\n    min-width: 140px;\n  }\n  .circle {\n    background-color: var(--v-colors__white);\n    width: 50px;\n    height: 50px;\n    border: 2px solid var(--v-colors__gray);\n    border-radius: 50%;\n    line-height: 50px;\n    text-align: center;\n    z-index: 1;\n  }\n  .circle:hover {\n    cursor: pointer;\n  }\n  .line {\n    border-top: 2px solid var(--v-colors__gray);\n    width: 100%;\n    position: relative;\n    top: -25px;\n    left: 50%;\n  }\n  .label-text {\n    text-align: center;\n    margin-top: 5px;\n    max-width: 100px;\n  }\n  .mobile-expand-collapse {\n    display: none;\n  }\n  v-icon {\n    position: relative;\n  }\n  v-icon.check,\n  v-icon.ellipsis,\n  v-icon.exclamation {\n    top: 4px;\n  }\n"]);
...
/* harmony default export */ var v_progress_nav_item_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-progress-nav-item/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject15() {
  var data = v_progress_nav_item_taggedTemplateLiteral(["var(--v-colors__green)"]);
...
function _templateObject14() {
  var data = v_progress_nav_item_taggedTemplateLiteral(["var(--v-states__error-color)"]);
...
function _templateObject13() {
  var data = v_progress_nav_item_taggedTemplateLiteral(["var(--v-colors__gray)"]);
...
function _templateObject11() {
  var data = v_progress_nav_item_taggedTemplateLiteral([""]);
...
function _templateObject10() {
  var data = v_progress_nav_item_taggedTemplateLiteral(["<v-icon\n          class=\"check\"\n          name=\"check\"\n          color=\"--v-colors__green\"\n        ></v-icon>"]);
...
function _templateObject6() {
  var data = v_progress_nav_item_taggedTemplateLiteral(["<div class=\"line\"></div>"]);
...
function _templateObject4() {
  var data = v_progress_nav_item_taggedTemplateLiteral(["<a\n            class=\"circle\"\n            href=\"", "\"\n            aria-label=\"", "\"\n            >", "</a\n          >"]);
...
function _templateObject3() {
  var data = v_progress_nav_item_taggedTemplateLiteral(["<div\n            @click=", "\n            class=\"circle\"\n            aria-label=\"", "\"\n          >\n            ", "\n          </div>"]);
...
function v_progress_nav_item_templateObject() {
  var data = v_progress_nav_item_taggedTemplateLiteral(["\n        .circle {\n          border-color: var(--outlineColor, #333);\n        }\n        .line {\n          border-color: var(--lineColor, #6e6e6e);\n        }\n      "]);

  v_progress_nav_item_templateObject = function _templateObject() {
    return data;
  };
...
function v_progress_nav_item_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_progress_nav_item_VProgressNavItem = _decorate([Object(lit_element["c" /* customElement */])('v-progress-nav-item')], function (_initialize, _LitElement) {
  var VProgressNavItem = /*#__PURE__*/function (_LitElement2) {
    _inherits(VProgressNavItem, _LitElement2);

    var _super = _createSuper(VProgressNavItem);

    function VProgressNavItem() {
      var _this;

      _classCallCheck(this, VProgressNavItem);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_progress_nav_item_styles, Object(lit_element["b" /* css */])(v_progress_nav_item_templateObject())];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        this.style.setProperty('--outlineColor', this.getOutlineColor());
        this.style.setProperty('--lineColor', this.lineColor);
      }
    }, {
      kind: "method",
      key: "updated",
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(_templateObject2(), this.isSPA ? Object(lit_element["d" /* html */])(_templateObject3(), this.handleClick, this.labelText, this.getIcon()) : Object(lit_element["d" /* html */])(_templateObject4(), this.href, this.labelText, this.getIcon()), this.noLine ? Object(lit_element["d" /* html */])(_templateObject5()) : Object(lit_element["d" /* html */])(_templateObject6()), this.labelText);
      }
    }, {
      kind: "method",
      key: "getIcon",
      value: function getIcon() {
        switch (this.state) {
          case 'notstarted':
            this.lineColor = 'var(--v-colors__gray)';
            return Object(lit_element["d" /* html */])(_templateObject7());

          case 'inprogress':
            this.lineColor = 'var(--v-colors__gray)';
            return Object(lit_element["d" /* html */])(_templateObject8());

          case 'attention':
            this.lineColor = 'var(--v-states__gray)';
            return Object(lit_element["d" /* html */])(_templateObject9());

          case 'completed':
            this.lineColor = 'var(--v-colors__green)';
            return Object(lit_element["d" /* html */])(_templateObject10());
      ...
      value: function getOutlineColor() {
        switch (this.state) {
          case 'notstarted':
            return Object(lit_element["b" /* css */])(_templateObject12());

          case 'inprogress':
            return Object(lit_element["b" /* css */])(_templateObject13());

          case 'attention':
            return Object(lit_element["b" /* css */])(_templateObject14());

          case 'completed':
            return Object(lit_element["b" /* css */])(_templateObject15());
        }
      }
    }, {
      kind: "method",
      ...
      value: function handleClick() {
        this.dispatchEvent(new CustomEvent('vprogressnavitem-click', {
          detail: this.href,
          bubbles: true,
          composed: true
        }));
