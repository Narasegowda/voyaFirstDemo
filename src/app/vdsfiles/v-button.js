...
/******/ 	return __webpack_require__(__webpack_require__.s = "LSWK");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VButton", function() { return /* binding */ v_button_VButton; });
...
/* harmony default export */ var v_button_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-button/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject6() {
  var data = v_button_taggedTemplateLiteral([""]);
...
function _templateObject5() {
  var data = v_button_taggedTemplateLiteral([" <div class=\"spinner\">", "</div> "]);
...
function v_button_templateObject() {
  var data = v_button_taggedTemplateLiteral(["\n          <a\n            ?disabled=", "\n            @click=", "\n            href=", "\n            target=", "\n            style=\"text-transform:", "\"\n            aria-label=", "\n          >\n            <slot></slot>\n            ", "\n          </a>\n        "]);

  v_button_templateObject = function _templateObject() {
    return data;
  };
...
function v_button_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_button_VButton = _decorate([Object(lit_element["c" /* customElement */])('v-button')], function (_initialize, _LitElement) {
  var VButton = /*#__PURE__*/function (_LitElement2) {
    _inherits(VButton, _LitElement2);
  ...
  return {
    ...
    d: [{
      ...
      kind: "method",
      key: "_updatedRun",
      value: function _updatedRun() {
        this.$button = this.shadowRoot.querySelector('button') || this.shadowRoot.querySelector('a');
        this.primary && this.$button.classList.add('primaryButton');
        this.secondary && this.$button.classList.add('secondary');

        if (!this.target && !Object(utils["o" /* isHostMatchWithVoya */])(this.href) && Object(utils["m" /* isAbsoluteUrl */])(this.href) && !this.arialabel) {
          this.$button.setAttribute('target', '_blank');
          this.$button.setAttribute('aria-label', 'opens new window');
        }
      }
    }, {
      kind: "method",
      ...
      value: function connectedCallback() {
        ...
        _get(_getPrototypeOf(VButton.prototype), "connectedCallback", this).call(this);

        var formName = this.closest(this, function (el) {
        ...
        var targetOrHref = this.target === '_blank' || !this.target && !Object(utils["o" /* isHostMatchWithVoya */])(this.href);

        if (targetOrHref && this.href && this.href !== '#') {
          this.shadowRoot.addEventListener('mouseover', function (e) {
            _this2._handleMouseOver(e.detail);
          });
          this.shadowRoot.addEventListener('mouseout', function (e) {
            _this2._handleMouseOut(e.detail);
          });
        }
      }
    }, {
      ...
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        var hrefOrTarget = this.target === '_blank' || !this.target && !Object(utils["o" /* isHostMatchWithVoya */])(this.href) && Object(utils["m" /* isAbsoluteUrl */])(this.href);

        if (hrefOrTarget && this.href && this.href !== '#') {
        ...
        _get(_getPrototypeOf(VButton.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "updated",
      value: function updated(changedProperties) {
        if (this.busy) {
          this.$button.classList.add('avoid-click');
        } else {
          this.$button.classList.remove('avoid-click');
        }
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_button_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return this.href && this.href !== '#' ? Object(lit_element["d" /* html */])(v_button_templateObject(), this.disabled, this._handleClick, this.href, this.target === '_blank' ? '_blank' : '_self', this.textFormat, this.arialabel ? this.arialabel : this.target === '_blank' ? 'opens ' + this.href + ' in new window' : 'redirects to ' + this.href, this.target === '_blank' || !this.target && !Object(utils["o" /* isHostMatchWithVoya */])(this.href) && Object(utils["m" /* isAbsoluteUrl */])(this.href) ? Object(lit_element["d" /* html */])(_templateObject2(), this.primary ? '--v-colors__white' : '--v-colors__primary') : Object(lit_element["d" /* html */])(_templateObject3())) : Object(lit_element["d" /* html */])(_templateObject4(), this.disabled, this._handleClick, this.type, this.target === '_blank' ? '_blank' : '_self', this.textFormat, this.arialabel, this.busy ? Object(lit_element["d" /* html */])(_templateObject5(), src_images["y" /* spinner */]) : Object(lit_element["d" /* html */])(_templateObject6()));
      }
    }, {
      kind: "field",
      key: "closest",
      ...
      value: function _handleClick() {
        if (this.type === 'submit') {
          ...
          this.dispatchEvent(new CustomEvent('vbutton-click', {
            bubbles: true,
            composed: true
          }));
        }
      ...
      value: function _handleMouseOver() {
        ...
        if (this.secondary && this.$vIcon && this.$vIcon.getAttribute('color') === '--v-colors__primary') {
          this.$vIcon.setAttribute('color', '--v-colors__white');
        }
      }
    }, {
      kind: "method",
      ...
      value: function _handleMouseOut() {
        ...
        if (this.secondary && this.$vIcon && this.$vIcon.getAttribute('color') === '--v-colors__white') {
          this.$vIcon.setAttribute('color', '--v-colors__primary');
        }
      }
    }]
  };
