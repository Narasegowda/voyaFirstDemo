...
/******/ 	return __webpack_require__(__webpack_require__.s = "Ow6A");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VModal", function() { return /* binding */ v_modal_VModal; });
...
// CONCATENATED MODULE: ./src/components/v-modal/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  .container {\n    align-items: center;\n    background-color: var(--v-modal__overlay-color);\n    display: none;\n    height: 100%;\n    justify-content: center;\n    left: 0;\n    position: fixed;\n    top: 0;\n    width: 100%;\n    z-index: 100;\n  }\n\n  ::-webkit-scrollbar {\n    width: 0px;\n    background: transparent; /* make scrollbar transparent */\n  }\n\n  .container.open {\n    display: flex;\n    /* when modal open it takes priority  than any other z-index like simple-nav sticky etc*/\n    z-index: 1000000000;\n  }\n\n  .modal-content {\n    background-color: var(--v-colors__white);\n    border-radius: 10px;\n    box-shadow: 0 10px 20px -1px var(--v-colors__box-shadow-10);\n    max-height: 100vh;\n    overflow-y: auto;\n    min-height: 150px;\n    min-width: 200px;\n    padding: 50px 20px;\n    position: relative;\n    text-align: center;\n    max-width: 588px;\n    scrollbar-width: none; /* Firefox */\n    -ms-overflow-style: none; /* IE 10+ */\n  }\n\n  .x-button {\n    background-color: var(--v-colors__white);\n    border: none;\n    height: 20px;\n    padding: 0;\n    position: absolute;\n    right: 20px;\n    top: 20px;\n  }\n\n  .x-button:focus {\n    box-shadow: var(--v-states__focus-box-shadow);\n    outline: none;\n  }\n\n  .x-button::-moz-focus-inner {\n    border: 0;\n  }\n\n  .with-illustration.modal-content::before {\n    bottom: var(--v-modal__bottom-illustration-position-bottom);\n    content: var(--v-modal__bottom-illustration-src);\n    left: var(--v-modal__bottom-illustration-position-left);\n    position: absolute;\n    z-index: -1;\n  }\n\n  .with-illustration.modal-content::after {\n    content: var(--v-modal__top-illustration-src);\n    position: absolute;\n    right: var(--v-modal__top-illustration-position-right);\n    top: var(--v-modal__top-illustration-position-top);\n    z-index: -1;\n  }\n\n  @media screen and (max-width: 768px) {\n    .modal-content {\n      max-width: 375px;\n    }\n  }\n"]);
...
/* harmony default export */ var v_modal_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/styles/global_styles.js
var global_styles = __webpack_require__("KtIl");

// CONCATENATED MODULE: ./src/components/v-modal/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_modal_taggedTemplateLiteral(["\n                <button @click=", " class=\"x-button\">\n                  <v-icon primary name=\"x\" size=\"20px\"></v-icon>\n                </button>\n              "]);
...
function v_modal_templateObject() {
  var data = v_modal_taggedTemplateLiteral(["\n      <div\n        @click=", "\n        class=", "\n      >\n        <div\n          class=\"modal-content ", " ", "\"\n        >\n          ", "\n          <slot></slot>\n        </div>\n      </div>\n    "]);

  v_modal_templateObject = function _templateObject() {
    return data;
  };
...
function v_modal_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_modal_VModal = _decorate([Object(lit_element["c" /* customElement */])('v-modal')], function (_initialize, _LitElement) {
  var VModal = /*#__PURE__*/function (_LitElement2) {
    _inherits(VModal, _LitElement2);

    var _super = _createSuper(VModal);

    function VModal() {
      var _this;

      _classCallCheck(this, VModal);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [global_styles["a" /* default */], commonStyles["a" /* default */], v_modal_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        this.$contentArea = this.shadowRoot.querySelector('.modal-content');
        this.$slottedItems = Object(utils["j" /* getSlottedElements */])(this);
        this.addEventListener('keyup', function (e) {
          if (e.key === 'Escape' && _this2.open) {
            _this2.closeModal();
          }
        });

        this._setButtonAndSlot();
      }
    }, {
      kind: "method",
      key: "_setButtonAndSlot",
      value: function _setButtonAndSlot() {
        this.$slottedItems = Object(utils["j" /* getSlottedElements */])(this);
        this.$slottedItems.forEach(function (slottedItem) {
          if (slottedItem.nodeName === 'V-BUTTON') {
            slottedItem.style.paddingTop = '10px';
            slottedItem.style.paddingBottom = '30px';
          } else {
            slottedItem.style.paddingBottom = '30px';
          }
        });
      ...
      value: function value() {
        ...
        return function (e) {
          ...
          Object(utils["g" /* gaEvent */])(e, 'V-MODAL', 'impression', "<id: ".concat(_this3.id, ">"));
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          ...
          if (_this5.withXButton) {
            result = _this5.shadowRoot.querySelectorAll('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"] ), v-input-field, v-button, v-select, v-textarea, v-checkbox, v-radio-group, v-search-field');
          } else {
            var nodesAll = _this5.shadowRoot.querySelector('slot').assignedNodes();

            for (var index = 0; index < nodesAll.length; index++) {
              var nodes = nodesAll[index];

              if (nodes.querySelectorAll) {
                result = _this5._selectFocusable(nodes);

                if ((result === null || result.length < 1) && nodes.parentNode && nodes.parentNode.querySelectorAll) {
                  result = _this5._selectFocusable(nodes.parentNode);
                }
              }
      ...
      kind: "method",
      key: "_selectFocusable",
      value: function _selectFocusable(node) {
        return node ? Array.from(node.querySelectorAll('v-button, button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"]), v-input-field, v-select, v-textarea, v-checkbox, v-radio-group, v-search-field')) : null;
      }
    }, {
      kind: "field",
      key: "updated",
      value: function value() {
        ...
        return function () {
          /**
           * set focus on tabbable elements in the the modal.
           */
          _this6.updateComplete.then(function () {
            var focusable = _this6.getFocusable();

            var firstFocusable = focusable && focusable[0];

            if (firstFocusable) {
              if (_this6.open) {
                if (firstFocusable.shadowRoot) {
                  var focusTo = firstFocusable.shadowRoot.querySelectorAll('input, button, textarea');
                  var firstFocusableTo = focusTo && focusTo[0];

                  if (firstFocusableTo) {
                    firstFocusable.setAttribute('tabindex', 0);
                    firstFocusableTo.focus();
                  } else {
                    firstFocusable.setAttribute('tabindex', 0);
            ...
            _this6._setButtonAndSlot();
          });
        };
      }
    }, {
      kind: "field",
      key: "_containerClassList",
      value: function value() {
        var _this7 = this;
      ...
      value: function value() {
        ...
        return function (e) {
          if (!_this8.withXButton) return;
          var parent = e.target.parentNode;
          var clickedInside = false;
          _this8.$slottedItems = Object(utils["j" /* getSlottedElements */])(_this8);

          _this8.$slottedItems.forEach(function (slottedItem) {
            var parentNodeSlotted = parent && parent.isEqualNode(slottedItem) || parent.parentNode && parent.parentNode.isEqualNode(slottedItem);

            if (slottedItem.isEqualNode(e.target) || parentNodeSlotted) {
              clickedInside = true;
            }
          });

          if (e.target !== _this8.$contentArea && parent !== _this8 && parent !== _this8.$contentArea && !clickedInside) {
            _this8.closeModal();
          }
        };
      }
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_modal_templateObject(), this._handleClickOutside, this._containerClassList(), this.withXButton ? 'with-x' : 'without-x', this.withIllustration ? 'with-illustration' : '', this.withXButton ? Object(lit_element["d" /* html */])(_templateObject2(), this.closeModal) : '');
      }
    }]
  };
