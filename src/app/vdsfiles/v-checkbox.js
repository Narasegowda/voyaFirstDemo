...
/******/ 	return __webpack_require__(__webpack_require__.s = "pyw4");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VCheckbox", function() { return /* binding */ v_checkbox_VCheckbox; });
...
// CONCATENATED MODULE: ./src/components/v-checkbox/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    display: inline-block;\n  }\n\n  .checkbox-container {\n    align-items: center;\n    display: inline-flex;\n    position: relative;\n    cursor: pointer;\n  }\n\n  .checkbox {\n    align-items: center;\n    border-radius: 5px;\n    border: 1px solid var(--v-colors__primary);\n    display: inline-block;\n    height: 23px;\n    width: 23px;\n    min-width: 23px;\n    margin-right: 10px;\n    padding: 4px 3px 2px 3px;\n  }\n\n  :host([checked]) .checkbox {\n    background-color: var(--v-colors__primary);\n  }\n\n  v-icon {\n    display: none;\n  }\n\n  :host([checked]) .checkbox > v-icon {\n    display: block;\n  }\n\n  input {\n    cursor: inherit;\n    height: 100%;\n    left: 0;\n    margin: 0;\n    opacity: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n  }\n\n  .label {\n    width: 100%;\n    color: var(--v-colors__black);\n    font-family: var(--v-fonts__primary);\n    font-size: 16px;\n    float: right;\n    pointer-events: none;\n  }\n\n  input:focus + .checkbox {\n    box-shadow: var(--v-states__focus-box-shadow-with-inset);\n    outline: none;\n  }\n\n  :host .checkbox-container:hover .checkbox {\n    border: 1px solid var(--v-colors__primary-darker-1);\n    box-shadow: none;\n  }\n\n  :host([checked]) .checkbox-container:hover .checkbox {\n    background-color: var(--v-colors__primary-darker-1);\n    border: 1px solid var(--v-colors__primary-darker-1);\n    box-shadow: none;\n  }\n\n  :host .checkbox-container:hover input:focus ~ .checkbox {\n    box-shadow: var(--v-states__focus-box-shadow-with-inset);\n  }\n\n  :host .checkbox-container:active .checkbox {\n    border: 1px solid var(--v-colors__active_color);\n  }\n\n  :host([error]) .checkbox-container:active input ~ .checkbox,\n  :host([error]) .checkbox-container:active input:focus ~ .checkbox {\n    box-shadow: inset 0 0 0 1px var(--v-colors__active_color),\n      0 0 0 1px var(--v-colors__white),\n      0 0 3px 3px var(--v-ticker__negative-color);\n  }\n\n  :host .checkbox-container:active input:focus ~ .checkbox {\n    box-shadow: var(--v-states__focus-box-shadow-with-inset);\n    outline: none;\n  }\n\n  :host([checked]) .checkbox-container:active .checkbox {\n    background-color: var(--v-colors__primary-darker-2);\n    border: 1px solid var(--v-colors__primary-darker-2);\n  }\n\n  :host([disabled]) .checkbox-container {\n    cursor: not-allowed;\n  }\n\n  :host([disabled]) .checkbox-container .checkbox {\n    border-color: var(--v-states__disabled-color);\n    background-color: rgba(204, 204, 204, 1);\n  }\n\n  :host([disabled][checked]) .checkbox-container .checkbox {\n    border-color: var(--v-states__disabled-color);\n    background-color: var(--v-states__disabled-color);\n  }\n\n  :host([disabled]) input ~ .label {\n    color: var(--v-states__disabled-color);\n    cursor: not-allowed;\n  }\n\n  :host([error]) .checkbox-container .label {\n    color: var(--v-ticker__negative-color);\n  }\n\n  :host([error]) .checkbox-container:not(:active) .checkbox,\n  :host([error][checked])\n    .checkbox-container:not(:active)\n    input:not(:focus)\n    .checkbox {\n    border: 1px solid var(--v-ticker__negative-color);\n    box-shadow: inset 0 0 0 1px var(--v-ticker__negative-color);\n  }\n\n  :host([error][checked]) .checkbox-container:not(:active) .checkbox {\n    background-color: var(--v-ticker__negative-color);\n  }\n\n  :host([error]) .checkbox-container:not(:active) input:focus + .checkbox {\n    box-shadow: inset 0 0 0 1px var(--v-ticker__negative-color),\n      0 0 0 1px var(--v-colors__white),\n      0 0 3px 3px var(--v-ticker__negative-color);\n    outline: none;\n  }\n\n  v-error-text {\n    margin-top: 10px;\n  }\n  .label-link {\n    position: absolute;\n    display: inline;\n    color: var(--v-colors__black);\n    font-family: var(--v-fonts__primary);\n    font-size: 16px;\n    margin-left: 5px;\n    pointer-events: auto;\n  }\n"]);
...
/* harmony default export */ var v_checkbox_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-checkbox/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_checkbox_taggedTemplateLiteral(["\n          <v-error-text\n            text=", "\n            class=", "\n          >\n          </v-error-text>\n        "]);
...
function v_checkbox_templateObject() {
  var data = v_checkbox_taggedTemplateLiteral(["\n      <div\n        class=", "\n      >\n        <input\n          @change=", "\n          ?checked=", "\n          ?disabled=", "\n          ?error=", "\n          tabindex=", "\n          type=\"checkbox\"\n          id=", "\n          name=", "\n          value=", "\n          class=", "\n          aria-label=", "\n        />\n        <div\n          class=", "\n        >\n          <v-icon\n            color=\"--v-colors__white\"\n            class=", "\n            name=\"check\"\n            size=\"15px\"\n          >\n          </v-icon>\n        </div>\n        <div class=\"label\">\n          <span>\n            <label\n              for=\"", "\"\n              class=", "\n              aria-label=\"", "\"\n              >", "</label\n            >\n          </span>\n        </div>\n      </div>\n      <div class=\"label-link\" @click=", ">\n        <slot name=\"labelLink\"> </slot>\n      </div>\n      <div>", "</div>\n    "]);

  v_checkbox_templateObject = function _templateObject() {
    return data;
  };
...
function v_checkbox_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_checkbox_VCheckbox = _decorate([Object(lit_element["c" /* customElement */])('v-checkbox')], function (_initialize, _LitElement) {
  var VCheckbox = /*#__PURE__*/function (_LitElement2) {
    _inherits(VCheckbox, _LitElement2);
    ...
    function VCheckbox() {
      ...
      _this.implicitSubmit = _this.implicitSubmit.bind(_assertThisInitialized(_this));
      return _this;
    }
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_checkbox_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      ...
      value: function createRenderRoot() {
        ...
        return this.hasAttribute('disable-shadow') ? this : _get(_getPrototypeOf(VCheckbox.prototype), "createRenderRoot", this).call(this);
      }
    }, {
      kind: "method",
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(VCheckbox.prototype), "connectedCallback", this).call(this);
        ...
        if (formName) {
          ...
          this.addEventListener('keypress', this.implicitSubmit);
        }
      }
    }, {
      kind: "method",
      ...
      value: function formDataAppend(event) {
        event.formData.append(this.name, this.checked ? this.value : '');
      }
    }, {
      kind: "field",
      key: "implicitSubmit",
      ...
      value: function disconnectedCallback() {
        ...
        if (formName) {
          ...
          this.removeEventListener('keypress', this.implicitSubmit);
        }

        _get(_getPrototypeOf(VCheckbox.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "updated",
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_checkbox_templateObject(), Object(class_map["a" /* classMap */])({
          'checkbox-container': true,
          checkboxContainerGlobal: true
        }), this._handleChange, this.checked, this.disabled, this.error, this.tabIndex, this.id, this.name, this.value, Object(class_map["a" /* classMap */])({
          checkboxInput: true
        }), this.altLabel, Object(class_map["a" /* classMap */])({
          checkbox: true,
          checkboxGlobal: true
        }), Object(class_map["a" /* classMap */])({
          checkboxIcon: true
        }), this.id, Object(class_map["a" /* classMap */])({
          checkboxLabel: true
        }), this.altLabel, this.labelText, this._handleClick, this._errorText());
      }
    }, {
      kind: "method",
      key: "_handleClick",
      value: function _handleClick(e) {
        ...
        if (((_e$target = e.target) === null || _e$target === void 0 ? void 0 : (_e$target$tagName = _e$target.tagName) === null || _e$target$tagName === void 0 ? void 0 : _e$target$tagName.toLowerCase()) !== 'a') {
          e.preventDefault();
      ...
      value: function _toggleChecked() {
        ...
        this.dispatchEvent(new CustomEvent('vcheck', {
          detail: {
      ...
      value: function value() {
        ...
        return function () {
          return _this2.errorText ? Object(lit_element["d" /* html */])(_templateObject2(), _this2.errorText, Object(class_map["a" /* classMap */])({
            vCheckboxErrorText: 'vCheckboxErrorText'
          })) : undefined;
        };
      }
    }]
