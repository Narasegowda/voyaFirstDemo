...
/******/ 	return __webpack_require__(__webpack_require__.s = "xPRE");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VTooltip", function() { return /* binding */ v_tooltip_VTooltip; });
...
// CONCATENATED MODULE: ./src/components/v-tooltip/styles.js
function _templateObject() {
...
/* harmony default export */ var v_tooltip_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-tooltip/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject4() {
  var data = v_tooltip_taggedTemplateLiteral([" <slot @click=", "></slot> "]);
...
function _templateObject3() {
  var data = v_tooltip_taggedTemplateLiteral(["<button\n          class=", "\n          @click=", "\n          @mouseenter=", "\n          @mouseleave=", "\n          type=\"button\"\n          aria-label=", "\n        >\n          <v-icon\n            color=", "\n            name=", "\n            width=\"auto\"\n            height=\"20px\"\n          ></v-icon>\n        </button>"]);
...
function _templateObject2() {
  var data = v_tooltip_taggedTemplateLiteral(["\n          <v-icon\n            linkText\n            name=", "\n            color=", "\n            @click=", "\n            aria-label=", "\n            width=\"auto\"\n            height=\"20px\"\n          >\n            ", "</v-icon\n          >\n        "]);
...
function v_tooltip_templateObject() {
  var data = v_tooltip_taggedTemplateLiteral(["", "\n    ", " "]);

  v_tooltip_templateObject = function _templateObject() {
    return data;
  };
...
function v_tooltip_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_tooltip_VTooltip = _decorate([Object(lit_element["c" /* customElement */])('v-tooltip')], function (_initialize, _LitElement) {
  var VTooltip = /*#__PURE__*/function (_LitElement2) {
    _inherits(VTooltip, _LitElement2);

    var _super = _createSuper(VTooltip);
  ...
  return {
    ...
    d: [{
      ...
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        if (!this.isComposed) this._removeClickListener();
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        if (this.isComposed) this.classList.add('composed');
        this.$speechBubble = Object(utils["j" /* getSlottedElements */])(this)[0];

        this._styleSpeechBubble();
      }
    }, {
      kind: "method",
      key: "updated",
      value: function updated(changedProperties) {
        if (changedProperties.has('active') || changedProperties.has('hover')) {
          this.showSpeechBubble = this.active || this.hover;
        }
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_tooltip_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_tooltip_templateObject(), this.linkText ? Object(lit_element["d" /* html */])(_templateObject2(), this.icon, this.iconcolor, this._toggleActive, this.altLabel, this.linkText) : Object(lit_element["d" /* html */])(_templateObject3(), Object(class_map["a" /* classMap */])({
          active: this.active,
          hover: this.hover,
          'icon-only': true
        }), this._toggleActive, this._handleMouseEnter, this._handleMouseLeave, this.altLabel, this._iconColor(), this.icon), this.showSpeechBubble ? Object(lit_element["d" /* html */])(_templateObject4(), this._handleClickSlot) : undefined);
      }
    }, {
      kind: "method",
      ...
      value: function _dispatchChangeEvent() {
        this.dispatchEvent(new CustomEvent('vtooltip-change', {
          detail: {
      ...
      value: function _iconColor() {
        return this.active || this.hover ? '--v-colors__secondary' : '--v-colors__primary';
      }
    }, {
      kind: "method",
      key: "_toggleActive",
      ...
      kind: "method",
      key: "_handleClickSlot",
      value: function _handleClickSlot(e) {
        e.stopPropagation();
      }
    }, {
      kind: "method",
      ...
      value: function _removeClickListener() {
        ...
        window.removeEventListener('click', function (event) {
          return _this2._handleClickOutside(event);
        });
      ...
      value: function _removeEscapeListener() {
        ...
        window.removeEventListener('keyup', function (event) {
          return _this3._handleEscapeKey(event);
        });
      }
    }, {
      kind: "method",
      ...
      value: function googleAnalytic(e) {
        ...
        var text = this.querySelector('v-speech-bubble').innerHTML ? this.querySelector('v-speech-bubble').innerHTML.replace(/(<([^>]+)>)/gi, '') : '';
        var eventLabel = "<hover: open><text: ".concat(text.trim().substring(0, 20), ">");
        window.dataLayer.push({
          event: 'GAEvent',
          eventCategory: 'V-TOOLTIP V-ICON',
          eventAction: 'hover',
          eventLabel: eventLabel,
          eventValue: 0,
          eventDetail: '<place: ' + eventDetail + '>',
      ...
      kind: "method",
      key: "_styleSpeechBubble",
      value: function _styleSpeechBubble() {
        var style = document.createElement('style');
