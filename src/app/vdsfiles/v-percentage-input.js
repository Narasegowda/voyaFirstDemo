...
/******/ 	return __webpack_require__(__webpack_require__.s = "uAH1");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ var v_percentage_input_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/styles/commonStyles.js
var commonStyles = __webpack_require__("ONJ/");

// CONCATENATED MODULE: ./src/components/v-percentage-input/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_percentage_input_templateObject() {
  var data = v_percentage_input_taggedTemplateLiteral(["\n      <div\n        ?disabled=", "\n        ?error=", "\n        ?valid=", "\n        class=\"wrapper\"\n      >\n        <button\n          ?disabled=", "\n          @click=", "\n          type=\"button\"\n        >\n          Decrement\n          <v-icon\n            ?disabled=", "\n            ?error=", "\n            primary\n            name=\"collapse\"\n          ></v-icon>\n        </button>\n        <div class=\"input-wrapper\" style=\"width:", "\">\n          <input\n            ?autofocus=", "\n            ?disabled=", "\n            ?required=", "\n            @change=", "\n            @input=", "\n            form=", "\n            id=", "\n            max=", "\n            min=", "\n            name=", "\n            step=", "\n            style=", "\n            type=\"number\"\n            value=", "\n            aria-label=", "\n          />\n          <span class=\"percent\">%</span>\n        </div>\n        <button\n          ?disabled=", "\n          @click=", "\n          type=\"button\"\n        >\n          Increment\n          <v-icon\n            ?disabled=", "\n            ?error=", "\n            primary\n            name=\"expand\"\n          ></v-icon>\n        </button>\n      </div>\n    "]);

  v_percentage_input_templateObject = function _templateObject() {
    return data;
  };
...
function v_percentage_input_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_percentage_input_VPercentageInput = _decorate([Object(lit_element["c" /* customElement */])('v-percentage-input')], function (_initialize, _LitElement) {
  var VPercentageInput = /*#__PURE__*/function (_LitElement2) {
    _inherits(VPercentageInput, _LitElement2);

    var _super = _createSuper(VPercentageInput);

    function VPercentageInput() {
      var _this;

      _classCallCheck(this, VPercentageInput);
  ...
  return {
    ...
    d: [{
      ...
      kind: "method",
      key: "firstUpdated",
      value: // Properties that correspond to native `<input type="number" />` attributes
      // and map one-to-one to the input element attributes.
      function firstUpdated() {
        this.$input = this.shadowRoot.querySelector("input[type='number']");
      ...
      kind: "method",
      key: "googleAnalytic",
      value: function googleAnalytic(button) {
        window.dataLayer.push({
          event: 'GAEvent',
          eventCategory: 'V-PERCENTAGE-INPUT V-ICON',
          eventAction: 'change',
          eventLabel: '<name: ' + button + '><value: ' + this.$input.value + '>',
          eventValue: 0,
          eventDetail: '<place: V-ICON V-PERCENTAGE-INPUT V-DEMO-APP>',
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_percentage_input_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_percentage_input_templateObject(), this.disabled, this.error, this.valid, this.disabled, this._decrement, this.disabled, this.error, Object(lit_element["g" /* unsafeCSS */])(this.width), this.autoFocus, this.disabled, this.required, this._handleChange, this._handleInput, this.form, this.inputId, this.max, this.min, this.name, this.step, this._inputStyle(), this.value, this.altLabel, this.disabled, this._increment, this.disabled, this.error);
      }
    }, {
      kind: "method",
      key: "checkValidity",
      ...
      kind: "method",
      key: "_handleInput",
      value: function _handleInput(_ref) {
        var target = _ref.target;
        this.value = target.value;
        this.size = target.value.toString().length;
      }
    }, {
      kind: "method",
      key: "_increment",
      value: function _increment() {
        ...
        this.googleAnalytic('expand');
      }
    }, {
      kind: "method",
      key: "_inputStyle",
      value: function _inputStyle() {
        return "width: ".concat(this.size, "ch;");
      }
    }, {
      kind: "method",
      key: "_setDefaults",
      value: function _setDefaults() {
        this.size = this.value.toString().length;
      }
    }, {
      kind: "method",
      key: "_updateLength",
      ...
      key: "_up",
      value: function _up() {
        if (typeof this.$input.stepUp === 'function') {
          try {
            this.$input.stepUp();
          } catch (ex) {
      ...
      value: function _down() {
        if (typeof this.$input.stepDown === 'function') {
          try {
            this.$input.stepDown();
          } catch (ex) {
            this.$input.value = Number(this.$input.value) - this.step;
