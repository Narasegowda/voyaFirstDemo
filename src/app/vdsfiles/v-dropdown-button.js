...
/******/ 	return __webpack_require__(__webpack_require__.s = "ZNFl");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VDropdownButton", function() { return /* binding */ v_dropdown_button_VDropdownButton; });
...
/* harmony default export */ var v_dropdown_button_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-dropdown-button/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_dropdown_button_templateObject() {
  var data = v_dropdown_button_taggedTemplateLiteral(["\n      <button\n        ?disabled=", "\n        @click=", "\n        @focusin=", "\n        @focusout=", "\n        @mouseover=", "\n        @mouseout=", "\n        class=", "\n      >\n        <span>", "</span>\n        <v-icon\n          color=", "\n          name=\"caretdown\"\n          size=\"15px\"\n        ></v-icon>\n      </button>\n      <div\n        id=\"optionBoxx\"\n        style=\"width:", "\"\n        class=", "\n      >\n        <slot></slot>\n      </div>\n    "]);

  v_dropdown_button_templateObject = function _templateObject() {
    return data;
  };
...
function v_dropdown_button_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_dropdown_button_VDropdownButton = _decorate([Object(lit_element["c" /* customElement */])('v-dropdown-button')], function (_initialize, _LitElement) {
  var VDropdownButton = /*#__PURE__*/function (_LitElement2) {
    _inherits(VDropdownButton, _LitElement2);

    var _super = _createSuper(VDropdownButton);

    function VDropdownButton() {
      var _this;

      _classCallCheck(this, VDropdownButton);

      _this = _super.call(this);

      _initialize(_assertThisInitialized(_this));

      window.addEventListener('click', _this._handleClickOutside);
      window.addEventListener('outside-button-click', _this._handleClickOutside);
      return _this;
    }

    return VDropdownButton;
  }(_LitElement);
  ...
  return {
    ...
    d: [{
      ...
      value: function firstUpdated() {
        this.$dropdownItems = Object(utils["j" /* getSlottedElements */])(this);
      }
    }, {
      kind: "method",
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        ...
        window.removeEventListener('outside-button-click', this._handleClickOutside);
      }
    }, {
      kind: "get",
      "static": true,
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_dropdown_button_styles];
      }
    }, {
      kind: "field",
      key: "render",
      value: function value() {
        ...
        return function () {
          return Object(lit_element["d" /* html */])(v_dropdown_button_templateObject(), _this2.disabled, _this2._toggleButton, function () {
            _this2._handleFocusin();
          }, function () {
            _this2._handleFocusout();
          }, function () {
            _this2._handleMouseover();
          }, function () {
            _this2._handleMouseout();
          }, Object(class_map["a" /* classMap */])({
            button: true,
            active: _this2.active
          }), _this2.text, _this2._iconColor(), Object(lit_element["g" /* unsafeCSS */])(_this2.optionBoxWidth), _this2._dropdownClasses());
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          return Object(class_map["a" /* classMap */])({
            ...
            'dropdown-content-left': _this3.left,
            'dropdown-content-right': _this3.right
          });
        };
      }
    }, {
      ...
      value: function value() {
        ...
        return function () {
          if (_this9.active || _this9.hover || _this9.focus) {
            return '--v-colors__white';
          } else if (_this9.disabled) {
            return '--v-states__disabled-color';
          } else {
      ...
      value: function value() {
        ...
        return function (e) {
          e.stopPropagation();
          var active = _this10.active;
          var event = new CustomEvent('outside-button-click');
          window.dispatchEvent(event);
          _this10.active = !active;
        };
      }
    }]
  };
