...
/******/ 	return __webpack_require__(__webpack_require__.s = "PVYf");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VSecondaryNavigationTab", function() { return /* binding */ v_secondary_navigation_tab_VSecondaryNavigationTab; });
...
// CONCATENATED MODULE: ./src/components/v-secondary-navigation-tab/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    flex-basis: 0;\n    flex-grow: 1;\n  }\n\n  :host(:first-of-type) > .tab {\n    border-radius: 10px 0 0 0;\n  }\n\n  :host(:last-of-type) > .tab {\n    border-radius: 0 10px 0 0;\n  }\n\n  .tab {\n    align-items: center;\n    background-color: var(--v-colors__gray-light);\n    display: flex;\n    font-size: 18px;\n    height: 60px;\n    justify-content: center;\n    margin-right: 2px;\n    outline: none;\n    padding: 0 20px;\n    text-align: center;\n  }\n\n  .link:hover {\n    cursor: pointer;\n  }\n\n  .link.focused {\n    padding: 0px;\n  }\n\n  .tab:focus {\n    box-shadow: var(--v-states__focus-box-shadow);\n    position: relative;\n    z-index: 2;\n  }\n\n  :host(:last-of-type) > .tab {\n    margin-right: 0px;\n  }\n\n  .tab.active {\n    color: var(--v-colors__primary);\n    background-color: var(--v-colors__white);\n    font-weight: 600;\n  }\n\n  .tab.focused {\n    background-color: var(--v-colors__white);\n    position: relative;\n    z-index: 2;\n  }\n\n  .tabAnchor:focus {\n    outline: none;\n    box-shadow: var(--v-states__focus-box-shadow);\n  }\n\n  .tab > a {\n    text-decoration: none;\n    color: inherit;\n    display: flex;\n    width: 100%;\n    height: 100%;\n    justify-content: center;\n    align-items: center;\n  }\n\n  .tab-link-row {\n    align-items: center;\n    background-color: var(--v-colors__white);\n    display: none;\n    height: 82px;\n    left: 0;\n    padding-left: 30px;\n    position: absolute;\n    width: 100%;\n  }\n\n  .tab-link-row.focused {\n    display: flex;\n  }\n\n  .illustration {\n    display: flex;\n    justify-content: center;\n    position: relative;\n    max-width: 268px;\n  }\n\n  .illustration > svg {\n    position: absolute;\n    top: 0;\n    transition: top 0.5s;\n    z-index: -1;\n  }\n\n  /* This resolves a flexbug issue with IE11 */\n  @media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {\n    .illustration > svg {\n      transform: translateX(-50%);\n    }\n  }\n\n  .illustration.active > svg {\n    transition: top 0.5s, transform 1s;\n  }\n\n  .docmagnifier > svg {\n    top: -60px;\n  }\n  .active.docmagnifier > svg {\n    transform: rotate(360deg);\n  }\n\n  .dollarbill > svg {\n    top: -55px;\n  }\n  .active.dollarbill > svg {\n    transform: rotate(360deg);\n  }\n\n  .bargraph > svg {\n    top: -53px;\n  }\n  .active.bargraph > svg {\n    transform: rotate(360deg);\n  }\n\n  .hand > svg {\n    top: -91px;\n  }\n  .active.hand > svg {\n    transform: rotate(360deg);\n  }\n\n  .documents > svg {\n    top: -77px;\n  }\n  .active.documents > svg {\n    transform: rotate(360deg);\n  }\n  .external {\n    margin-left: 10px;\n  }\n"]);
...
/* harmony default export */ var v_secondary_navigation_tab_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-secondary-navigation-tab/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject4() {
  var data = v_secondary_navigation_tab_taggedTemplateLiteral(["", ""]);
...
function _templateObject3() {
  var data = v_secondary_navigation_tab_taggedTemplateLiteral(["<v-icon\n                    class=\"external\"\n                    name=\"externalLink\"\n                    color=\"--v-colors__primary\"\n                    size=\"15px\"\n                  ></v-icon> "]);
...
function _templateObject2() {
  var data = v_secondary_navigation_tab_taggedTemplateLiteral(["<a\n              class=\"tabAnchor\"\n              tabindex=\"-1\"\n              href=\"", "\"\n              target=\"", "\"\n              >", "\n              ", "</a\n            >"]);
...
function v_secondary_navigation_tab_templateObject() {
  var data = v_secondary_navigation_tab_taggedTemplateLiteral(["\n      <div class=", ">\n        ", "\n      </div>\n      <div class=\"tab ", "\" tabindex=\"0\">\n        ", "\n      </div>\n      <div class=\"tab-link-row ", "\">\n        <slot></slot>\n      </div>\n    "]);

  v_secondary_navigation_tab_templateObject = function _templateObject() {
    return data;
  };
...
function v_secondary_navigation_tab_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var navIllustrations = {
  docmagnifier: src_images["h" /* docmagnifier */],
  dollarbill: src_images["j" /* dollarbill */],
  bargraph: src_images["b" /* bargraph */],
  hand: src_images["m" /* hand */],
  documents: src_images["i" /* documents */]
};
var v_secondary_navigation_tab_VSecondaryNavigationTab = _decorate([Object(lit_element["c" /* customElement */])('v-secondary-navigation-tab')], function (_initialize, _LitElement) {
  var VSecondaryNavigationTab = /*#__PURE__*/function (_LitElement2) {
    _inherits(VSecondaryNavigationTab, _LitElement2);

    var _super = _createSuper(VSecondaryNavigationTab);

    function VSecondaryNavigationTab() {
      var _this;

      _classCallCheck(this, VSecondaryNavigationTab);
    ...
    return VSecondaryNavigationTab;
  }(_LitElement);

  return {
    F: VSecondaryNavigationTab,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_secondary_navigation_tab_styles];
      }
    }, {
      kind: "field",
      key: "firstUpdated",
      value: function value() {
        ...
        return function () {
          _this2.$tab = _this2.shadowRoot.querySelector('.tab');
          _this2.$tabAnchor = _this2.shadowRoot.querySelector('.tabAnchor');
          _this2.$linkRow = _this2.shadowRoot.querySelector('.tab-link-row');
          _this2.$links = Object(utils["j" /* getSlottedElements */])(_this2);

          _this2._setFirstLink();

          _this2._setTabListeners();

          _this2._setLinkRowListeners();
        };
      }
    }, {
      kind: "method",
      ...
      value: function render() {
        ...
        return Object(lit_element["d" /* html */])(v_secondary_navigation_tab_templateObject(), this._illustrationClassList(), this._tabIllustration(), this._activeClassList(), ['', '#', '/', 'undefined'].every(function (value) {
          return _this3.link !== value;
        }) ? Object(lit_element["d" /* html */])(_templateObject2(), this.link, this.target, this.tabtext, this.target === '_blank' ? Object(lit_element["d" /* html */])(_templateObject3()) : '') : Object(lit_element["d" /* html */])(_templateObject4(), this.tabtext), this._activeClassList());
      }
    }, {
      kind: "method",
      key: "updated",
      value: function updated(changedProperties) {
        ...
        if (this.link !== '' && this.link !== '#' && this.link !== '/' && this.link !== 'undefined') {
          isLink = true;
        }

        if (changedProperties.has('active') && this.active) {
          if (!isLink) {
            this._fire('activatetab');
          }
        }
      }
    }, {
      ...
      value: function value() {
        ...
        return function () {
          ...
          if (_this4.link !== '' && _this4.link !== '#' && _this4.link !== '/' && _this4.link !== 'undefined') {
            isLink = true;
          }

          if (_this4.$tabAnchor && isLink) {
            _this4.$tabAnchor.addEventListener('mouseenter', function () {
              _this4._fire('focustab');
            });
          }

          _this4.$tab.addEventListener('mouseenter', function () {
            if (_this4.$tab && !_this4.$tab.classList.contains('active')) {
              _this4._setAllLinkInactive();
            }

            _this4._fire('focustab');
          });

          _this4.$tab.addEventListener('focus', function () {
            if (_this4.$tab && !_this4.$tab.classList.contains('active')) {
              _this4._setAllLinkInactive();
            }
          ...
          _this4.$tab.addEventListener('keypress', function (e) {
            if (e.key === 'Enter' || 13 === e.keyCode) {
              this.querySelector('.tabAnchor').click();
            }
          });

          _this4.$tab.addEventListener('mouseout', function (e) {
            if (!e.relatedTarget || !e.relatedTarget.classList.contains('tab-link-row')) {
              _this4._fire('resetfocustab');
            }
          });

          _this4.$tab.addEventListener('click', function () {
            if (!isLink) {
              _this4._setFirstLinkActive();

              _this4._fire('activatetab');
            }
          });
        };
      }
      ...
      kind: "field",
      key: "_setLinkRowListeners",
      value: function value() {
        var _this5 = this;

        return function () {
          _this5.$linkRow.addEventListener('mouseleave', function (e) {
            if (_this5.shadowRoot !== (e.relatedTarget && e.relatedTarget.parentNode)) {
              _this5._fire('resetfocustab');
            }
          });

          _this5.$links.forEach(function (link) {
            link.addEventListener('click', function () {
              var activeLink = [_this5.id, link.id];

              _this5.dispatchEvent(new CustomEvent('activatelink', {
                bubbles: true,
                detail: activeLink
              }));
            });
      ...
      kind: "field",
      key: "_tabIllustration",
      value: function value() {
        var _this6 = this;

        return function () {
          return navIllustrations[_this6.illustration];
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          return Object(class_map["a" /* classMap */])({
            active: _this7.active,
            focused: _this7.focused,
            link: _this7.link !== '' && _this7.link !== '#' && _this7.link !== '/' && _this7.link !== 'undefined'
          });
        };
      }
    }, {
      kind: "field",
      key: "_illustrationClassList",
      value: function value() {
        var _this8 = this;

        return function () {
          return "illustration ".concat(_this8.illustration, " ").concat(_this8.active ? 'active' : '');
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          var lastLink = Object(utils["j" /* getSlottedElements */])(_this9)[0];

          if (lastLink !== undefined) {
            lastLink.classList.add('first-of-type');
          }
        };
      }
    }, {
      kind: "field",
      key: "_setFirstLinkActive",
      value: function value() {
        var _this10 = this;

        return function () {
          var firstLink = Object(utils["j" /* getSlottedElements */])(_this10)[0];

          if (firstLink !== undefined) {
            firstLink.setAttribute('active', true);
          }
        };
      }
    }, {
      kind: "field",
      key: "_setAllLinkInactive",
      value: function value() {
        var _this11 = this;

        return function () {
          var allLink = Object(utils["j" /* getSlottedElements */])(_this11);

          if (allLink !== undefined) {
            allLink.forEach(function (navLink) {
