...
/******/ 	return __webpack_require__(__webpack_require__.s = "JQyG");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vTile", function() { return /* binding */ v_tile_vTile; });
...
/* harmony default export */ var v_tile_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./node_modules/resize-observer-polyfill/dist/ResizeObserver.es.js
var ResizeObserver_es = __webpack_require__("bdgK");

// CONCATENATED MODULE: ./src/components/v-tile/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject4() {
  var data = v_tile_taggedTemplateLiteral(["\n                <img\n                  src=\"", "\"\n                  alt=\"", "\"\n                  width=\"", "\"\n                  height=\"", "\"\n                  class=\"tile-img\"\n                />\n              "]);
...
function _templateObject2() {
  var data = v_tile_taggedTemplateLiteral(["\n                <v-video class=\"video-player\">\n                  <iframe\n                    id=\"kaltura_player_1567627110\"\n                    src=\"https://cdnapisec.kaltura.com/p/1234081/sp/123408100/embedIframeJs/uiconf_id/44499851/partner_id/1234081?iframeembed=true&playerId=kaltura_player_1567627110&entry_id=", "\"\n                    width=\"", "\"\n                    height=\"", "\"\n                    allowfullscreen\n                    webkitallowfullscreen\n                    mozAllowFullScreen\n                    aria-label=\"", "\"\n                    allow=\"autoplay *; fullscreen *; encrypted-media *\"\n                    frameborder=\"0\"\n                  ></iframe>\n                </v-video>\n              "]);
...
function v_tile_templateObject() {
  var data = v_tile_taggedTemplateLiteral(["\n    <a class=\"anchor-wrapper\" href=", " aria-label=", " tabindex=\"0\">\n      <div\n        class=", ">\n       \n        ", "\n        <div class=\"tile-details\">\n          <div>\n            <div class=\"", "\"\">", "</div>\n          </div>\n          <div>\n            <p class=\"tile-subtitle\">", "</p>\n          </div>\n        </div>\n       \n      </div>\n      </a>\n    "]);

  v_tile_templateObject = function _templateObject() {
    return data;
  };
...
function v_tile_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_tile_vTile = _decorate([Object(lit_element["c" /* customElement */])('v-tile')], function (_initialize, _LitElement) {
  var vTile = /*#__PURE__*/function (_LitElement2) {
    _inherits(vTile, _LitElement2);

    var _super = _createSuper(vTile);

    function vTile() {
      var _this;

      _classCallCheck(this, vTile);
  ...
  return {
    ...
    d: [{
      ...
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(vTile.prototype), "connectedCallback", this) && _get(_getPrototypeOf(vTile.prototype), "connectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        if (!this.isLibrary && this.isTileLoaded) {
          var _this$resizeObserver;

          (_this$resizeObserver = this.resizeObserver) === null || _this$resizeObserver === void 0 ? void 0 : _this$resizeObserver.disconnect();
        }

        _get(_getPrototypeOf(vTile.prototype), "disconnectedCallback", this) && _get(_getPrototypeOf(vTile.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "get",
      "static": true,
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_tile_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 5:
                  ...
                  this.resizeObserver.observe(this.shadowRoot.querySelector('.tile-wrapper'));
      ...
      value: function value() {
        ...
        return function () {
          var tileTitleContainer = _this3.shadowRoot.querySelector('.tile-title');

          var tileSubtitleContainer = _this3.shadowRoot.querySelector('.tile-subtitle');
          ...
          if (offsetWidth < 240) {
            titleHeight = '180px';
            subTitleHeight = '128px';
          } else if (offsetWidth >= 240 && offsetWidth < 325) {
            titleHeight = '130px';
            subTitleHeight = '128px';
          } else if (offsetWidth >= 325 && offsetWidth < 335) {
            //335
            titleHeight = '84px';
            subTitleHeight = '62px';
            ...
            titleHeight = '84px';
            subTitleHeight = '62px';
          } else if (offsetWidth >= 440 && offsetWidth < 630) {
            titleHeight = '53px';
            subTitleHeight = '62px';
          } else if (offsetWidth >= 630) {
            //630 0670
            titleHeight = '53px';
            subTitleHeight = '40px';
          }

          if (tileTitleContainer) {
            tileTitleContainer.style.height = titleHeight;
          }

          if (tileSubtitleContainer) {
            tileSubtitleContainer.style.height = subTitleHeight;
          }

          _this3.getImageHeight();
        };
      }
    }, {
      kind: "method",
      ...
      value: function getImageHeight() {
        this.isTileLoaded = true;
        var tileWrapperContainer = this.shadowRoot.querySelector('.tile-wrapper');

        if (tileWrapperContainer) {
          var aspctHeight = parseInt((tileWrapperContainer === null || tileWrapperContainer === void 0 ? void 0 : tileWrapperContainer.clientWidth) * (316 / 670));
          this.height = aspctHeight > 0 ? aspctHeight : 'auto';
        }
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_tile_templateObject(), this.tileHref, 'Redirects to ' + this.tileTitle, this.noShadow ? 'tile-wrapper noShadow' : 'tile-wrapper', this.video && this.videoType === 'kaltura' ? Object(lit_element["d" /* html */])(_templateObject2(), this.entryID, this.width, this.height, this.alt) : this.video && this.videoType === 'youtube' ? Object(lit_element["d" /* html */])(_templateObject3(), this.entryID, this.width, this.height, this.alt) : Object(lit_element["d" /* html */])(_templateObject4(), this.tileImg, this.alt, this.width, this.height), this.titleColor == 'dark-orange' ? 'hd-3 tile-title' : 'hd-3 tile-title black', this.tileTitle, this.tileSubtitle);
      }
    }]
  };
