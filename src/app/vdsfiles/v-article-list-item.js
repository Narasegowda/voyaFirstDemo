...
/******/ 	return __webpack_require__(__webpack_require__.s = "gqGM");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vArticleListItem", function() { return /* binding */ v_article_list_item_vArticleListItem; });
...
// CONCATENATED MODULE: ./src/components/v-article-list-item/styles.js
function _templateObject() {
...
/* harmony default export */ var v_article_list_item_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/index.js + 8 modules
var utils = __webpack_require__("7Qib");

// CONCATENATED MODULE: ./src/components/v-article-list-item/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_article_list_item_templateObject() {
  var data = v_article_list_item_taggedTemplateLiteral(["\n      <div class=\"flex\">\n        <div class=\"img-container\">\n          <img src=", " alt=", " height=\"70px\" width=\"100px\" />\n        </div>\n        <div class=\"block\">\n          <h5 class=\"date\" aria-level=\"2\">", "</h5>\n          <h4 class=\"title\" aria-level=\"3\">\n            <a class=\"anchorClass\" target=", " href=", "\n              >", "</a\n            >\n          </h4>\n        </div>\n      </div>\n    "]);

  v_article_list_item_templateObject = function _templateObject() {
    return data;
  };
...
function v_article_list_item_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_article_list_item_vArticleListItem = _decorate([Object(lit_element["c" /* customElement */])('v-article-list-item')], function (_initialize, _LitElement) {
  var vArticleListItem = /*#__PURE__*/function (_LitElement2) {
    _inherits(vArticleListItem, _LitElement2);

    var _super = _createSuper(vArticleListItem);

    function vArticleListItem() {
      var _this;

      _classCallCheck(this, vArticleListItem);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_article_list_item_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        this.$anchor = this.shadowRoot.querySelector('.anchorClass');
        this.$anchor.setAttribute('aria-label', 'redirects to ' + this.articleTitle);

        if (this.target === '' && this.articleURL && this.checkURL() && this.articleURL !== '#') {
          this.$anchor.setAttribute('target', '_blank');
          this.$anchor.setAttribute('aria-label', 'opens ' + this.articleTitle + ' in new window');
        }
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_article_list_item_templateObject(), this.img, this.alt, this.date, this.target, this.articleURL, this.articleTitle);
      }
    }, {
      kind: "method",
      key: "checkURL",
      value: function checkURL() {
        return !Object(utils["o" /* isHostMatchWithVoya */])(this.articleURL) && Object(utils["m" /* isAbsoluteUrl */])(this.articleURL);
      }
    }]
  };
