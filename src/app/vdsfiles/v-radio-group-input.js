...
/******/ 	return __webpack_require__(__webpack_require__.s = "q1f6");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VRadioGroupInput", function() { return VRadioGroupInput; });
...
var VRadioGroupInput = _decorate([Object(lit_element__WEBPACK_IMPORTED_MODULE_0__[/* customElement */ "c"])('v-radio-group-input')], function (_initialize, _LitElement) {
  var VRadioGroupInput = /*#__PURE__*/function (_LitElement2) {
    _inherits(VRadioGroupInput, _LitElement2);

    var _super = _createSuper(VRadioGroupInput);

    function VRadioGroupInput() {
      var _this;

      _classCallCheck(this, VRadioGroupInput);
  ...
  return {
    ...
    d: [{
      kind: "method",
      key: "render",
      value: // See v-radio-group for context on this component.
      function render() {
        return undefined;
      }
    }]
