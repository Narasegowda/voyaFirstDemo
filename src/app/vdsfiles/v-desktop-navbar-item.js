...
/******/ 	return __webpack_require__(__webpack_require__.s = "/EL3");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VDesktopNavbarItem", function() { return /* binding */ v_desktop_navbar_item_VDesktopNavbarItem; });
...
// CONCATENATED MODULE: ./src/components/v-desktop-navbar-item/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    height: 100%;\n    position: relative;\n    --v-desktop-navbar-item-background-color: var(--v-colors__white);\n    --v-desktop-navbar-item-padding: 15px;\n    min-height: auto;\n  }\n\n  .container {\n    display: inline-block;\n    position: relative;\n    min-height: inherit;\n    height: 100%;\n  }\n\n  :host([hover]) {\n    z-index: 1;\n  }\n\n  button,\n  a {\n    align-items: center;\n    background-color: var(--v-desktop-navbar-item-background-color);\n    border: none;\n    color: var(--v-colors__black);\n    cursor: pointer;\n    display: inline-flex;\n    font-family: var(--v-fonts__primary);\n    font-weight: normal;\n    height: 100%;\n    justify-content: center;\n    padding: var(--v-desktop-navbar-item-padding);\n    max-height: 84px;\n  }\n\n  a {\n    text-decoration: none;\n    text-align: center;\n  }\n\n  button.selected,\n  a.selected {\n    color: var(--v-colors__primary);\n    font-weight: 600;\n  }\n\n  button:focus,\n  a:focus {\n    box-shadow: var(--v-states__focus-box-shadow);\n    outline: none;\n  }\n\n  .dropdown:focus {\n    box-shadow: var(--v-states__focus-box-shadow);\n    border-radius: 5px;\n    outline: none;\n  }\n\n  span {\n    margin-left: 10px;\n    margin-top: 2px;\n  }\n\n  button:hover svg.profile .fillable,\n  a:hover svg.profile .fillable,\n  button.selected svg.profile .fillable,\n  a.selected svg.profile .fillable {\n    fill: var(--v-colors__secondary);\n  }\n\n  button:hover svg.profile .circle,\n  a:hover svg.profile .circle,\n  button.selected svg.profile .circle,\n  a.selected svg.profile .circle {\n    stroke: var(--v-colors__secondary);\n    stroke-width: 2px;\n  }\n\n  button.hover svg.profile .fillable,\n  a.hover svg.profile .fillable {\n    fill: var(--v-colors__secondary);\n  }\n\n  button.hover svg.profile .circle,\n  a.hover svg.profile .circle {\n    stroke: var(--v-colors__secondary);\n    stroke-width: 2px;\n  }\n\n  button:active svg.profile .fillable,\n  a:active svg.profile .fillable {\n    fill: var(--v-colors__secondary-darker);\n  }\n\n  button:active svg.profile .circle,\n  a:active svg.profile .circle {\n    stroke: var(--v-colors__secondary-darker);\n    stroke-width: 2px;\n  }\n\n  /* This fixes the variable width on hover, due to change in font-weight. */\n  button span::after,\n  a span::after {\n    color: transparent;\n    content: attr(data-fix-width);\n    display: block;\n    font-weight: bold;\n    height: 1px;\n    overflow: hidden;\n    visibility: hidden;\n  }\n\n  .tab {\n    border-bottom: 2px solid var(--v-colors__secondary);\n    background-color: var(--v-colors__secondary);\n    border-radius: 5px 5px 0px 0px;\n    border-top: 3px solid var(--v-colors__secondary);\n    display: none;\n    margin: 0 auto;\n    position: absolute;\n    left: 45%;\n    transform: translateX(-50%) translateY(100%) translateY(-5px);\n    width: 60px;\n  }\n\n  .primary-nav-span {\n    margin: 18px 0px;\n  }\n\n  button.selected .tab,\n  a.selected .tab,\n  button.hover .tab,\n  a.hover .tab {\n    bottom: 0;\n    display: block;\n  }\n\n  button::-moz-focus-inner {\n    border: 0;\n  }\n\n  v-icon {\n    margin-left: 10px;\n  }\n\n  .dropdown {\n    background-color: var(--v-colors__white);\n    border-radius: 11px;\n    box-shadow: 0px 10px 45px -1px var(--v-colors__box-shadow-33);\n    color: var(--v-colors__primary);\n    display: none;\n    flex-direction: column;\n    position: absolute;\n    right: 0;\n    top: 75%;\n    white-space: nowrap;\n    text-align: left;\n    cursor: pointer;\n  }\n\n  .primaryNavDropdown {\n    max-width: 260px;\n    min-width: 200px;\n  }\n\n  .dropdown.with-icon:not(.open-up) {\n    top: calc(75% + 16px);\n  }\n\n  .dropdown.with-icon.open-up {\n    bottom: calc(75% + 10px);\n    top: auto;\n  }\n\n  .dropdown.hover.has-dropdown {\n    display: block;\n  }\n\n  .dropdown:not(.open-up):before {\n    border: solid transparent;\n    border-bottom-color: var(--v-colors__white);\n    border-width: 10px;\n    bottom: 100%;\n    content: '';\n    height: 0;\n    right: 12px;\n    pointer-events: none;\n    position: absolute;\n    width: 0;\n  }\n\n  .dropdown.open-up::after {\n    border: solid transparent;\n    border-bottom-color: var(--v-colors__white);\n    border-width: 10px;\n    content: '';\n    height: 0;\n    right: 12px;\n    pointer-events: none;\n    position: absolute;\n    width: 0;\n    transform: rotate(180deg);\n    -webkit-transform: rotate(180deg);\n  }\n\n  .dropdown.first-item-hovered:before {\n    border-bottom-color: var(--v-colors__primary);\n  }\n\n  .button-content {\n    display: flex;\n    align-items: center;\n    height: fit-content;\n  }\n\n  .button-content span span {\n    margin: 0;\n  }\n\n  .container_left {\n    width: 260px;\n    white-space: normal;\n  }\n"]);
...
/* harmony default export */ var v_desktop_navbar_item_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-desktop-navbar-item/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject6() {
  var data = v_desktop_navbar_item_taggedTemplateLiteral([" <div class=\"tab\"></div> "]);
...
function _templateObject5() {
  var data = v_desktop_navbar_item_taggedTemplateLiteral(["\n            <v-icon\n              name=", "\n              color=", "\n              size=\"15px\"\n            ></v-icon>\n          "]);
...
function _templateObject4() {
  var data = v_desktop_navbar_item_taggedTemplateLiteral([" <div class=\"button-content\" aria-hidden=\"true\">\n      <slot name=\"icon\"></slot>\n      <span\n        class=\"", "\"\n        data-fix-width=", "\n        >", "</span\n      >\n      ", "\n      ", "\n    </div>"]);
...
function v_desktop_navbar_item_templateObject() {
  var data = v_desktop_navbar_item_taggedTemplateLiteral(["<span class=\"container\" @focusout=", ">\n      ", "\n      <div class=\"dropdown-container\">\n        <div\n          class=", "\n          @keyup=", "\n          @mouseout=", "\n          @mouseover=", "\n          @vdropdownitem-select=", "\n          tabindex=\"-1\"\n          id=", "\n          role=\"menu\"\n        >\n          <slot></slot>\n        </div></div\n    ></span> "]);

  v_desktop_navbar_item_templateObject = function _templateObject() {
    return data;
  };
...
function v_desktop_navbar_item_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_desktop_navbar_item_VDesktopNavbarItem = _decorate([Object(lit_element["c" /* customElement */])('v-desktop-navbar-item')], function (_initialize, _LitElement) {
  var VDesktopNavbarItem = /*#__PURE__*/function (_LitElement2) {
    _inherits(VDesktopNavbarItem, _LitElement2);

    var _super = _createSuper(VDesktopNavbarItem);

    function VDesktopNavbarItem() {
      var _this;

      _classCallCheck(this, VDesktopNavbarItem);
    ...
    return VDesktopNavbarItem;
  }(_LitElement);

  return {
    F: VDesktopNavbarItem,
    d: [{
      kind: "field",
      ...
      value: function firstUpdated() {
        ...
        this.$dropdownItems = assignedElementsBySlot[utils["a" /* DEFAULT_SLOT_NAME */]];
        this.$icon = assignedElementsBySlot.icon[0];

        if (this.$icon) {
          this.withIcon = true;
        }

        this.boundClickOutside = this._handleClickOutside.bind(this);

        this._addEventListeners();

        this._setValue();

        this.dropdownId = Object(utils["l" /* getUniqueId */])();

        if (this.inPrimaryNav) {
          this.$dropdown.classList.add('primaryNavDropdown');
        }
      }
    }, {
      kind: "method",
      ...
      value: function _setValue() {
        ...
        if (this.$dropdownItems) {
          this.$dropdownItems.forEach(function (item) {
            ...
            if (!item.getAttribute('link') && item.getAttribute('selected') !== null) {
              _this2.value = item.getAttribute('value');
              _this2.text = item.getAttribute('text');
            }
          });
      ...
      kind: "method",
      key: "_setAriaLabel",
      value: function _setAriaLabel() {
        if (this.ariaLabelText.includes('{}')) {
          this.ariaLabel = this.ariaLabelText.replace('{}', this.text).replace(/<[^>]*>?/gm, '');
        } else {
          this.ariaLabel = (this.ariaLabelText + this.text).replace(/<[^>]*>?/gm, '');
        }
      }
    }, {
      kind: "method",
      ...
      value: function updated(changedProperties) {
        ...
        if (changedProperties.has('withIcon') && this.withIcon) {
          this.text ? this.$icon.classList.add('with-text') : this.$icon.classList.remove('with-text');
        }

        if (changedProperties.has('fontSize')) {
          this._assignFontSize();
        }

        if (changedProperties.has('expanded')) {
          if (this.expanded) {
            this.$button.setAttribute('aria-expanded', true);
            var details = this.$dropdown.getBoundingClientRect();

            if (this.inPrimaryNav) {
              if (details.width > 259) {
                this.$dropdown.classList.add('container_left');
              } else {
                this.$dropdown.classList.remove('container_left');
              }
            }
          } else {
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_desktop_navbar_item_styles];
      }
    }, {
      kind: "method",
      key: "_removeFocus",
      value: function _removeFocus() {
        ...
        setTimeout(function () {
          var assignedElementsBySlot = Object(utils["k" /* getSlottedElementsBySlotName */])(_this3);
          var slotdropdownItems = assignedElementsBySlot[utils["a" /* DEFAULT_SLOT_NAME */]];
          var shouldclosed = true;
          slotdropdownItems.forEach(function (item) {
            if (item.name === 'profile-options') {
              var doubleSlottedProfile = Object(utils["h" /* getAssignedElements */])(item);
              doubleSlottedProfile.forEach(function (inneritem) {
                if (inneritem.focused || _this3.$dropdown.getAttribute('focused') === 'true') {
                  shouldclosed = false;

                  _this3.$dropdown.setAttribute('focused', 'false');
                }
              });
            } else {
              if (item.focused || _this3.$dropdown.getAttribute('focused') === 'true') {
                shouldclosed = false;
      ...
      value: function render() {
        return Object(lit_element["d" /* html */])(v_desktop_navbar_item_templateObject(), this._removeFocus, this._button(), this._dropdownClasses(), this._dropdownKeyup, this._mouseOut, this._mouseOver, this._selectChanged, this.dropdownId);
      }
    }, {
      kind: "method",
      key: "_dropdownKeyup",
      value: function _dropdownKeyup(e) {
        if (this.hasDropdown) {
          if (e.keyCode === 38) {
            ...
            this.focused = this._getNextFocus(true);

            this._assignFocus();
          } else if (e.keyCode === 40) {
            if (this.focused === undefined) {
              this.focused = this.$dropdownItems.length - 1;
            }

            this.focused = this._getNextFocus(false);

            this._assignFocus();
          } else if (e.keyCode === 27 || Object(keyboardAccessibility["d" /* spaceKeyup */])(e) || Object(keyboardAccessibility["b" /* enterKeyup */])(e)) {
            window.removeEventListener('keydown', this._preventScrolling);
            e.preventDefault();
      ...
      key: "_focusButton",
      value: function () {
        var _focusButton2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return this.shadowRoot.updateComplete;
        ...
        function _focusButton() {
          return _focusButton2.apply(this, arguments);
        }
      ...
      key: "_assignFocus",
      value: function () {
        var _assignFocus2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
          var container;
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  container = this.shadowRoot.querySelector('.dropdown');
                  _context2.next = 3;
                  return container.updateComplete;

                case 3:
                  this.$dropdownItems[this.focused].shadowRoot.querySelector('div').focus();
        ...
        function _assignFocus() {
          return _assignFocus2.apply(this, arguments);
        }
      ...
      kind: "method",
      key: "_getNextFocus",
      value: function _getNextFocus(isUp) {
        var next;
        ...
        return this._mod(next, this.$dropdownItems.length);
      }
    }, {
      kind: "method",
      key: "_mod",
      ...
      key: "_openDropdown",
      value: function () {
        var _openDropdown2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  this.expanded = true;
                  _context3.next = 5;
                  return this.shadowRoot.querySelector('.dropdown-container').updateComplete;

                case 5:
                  this.$dropdown.focus();
                  this.$dropdown.setAttribute('focused', 'true');
                  this.addEventListener('keydown', this._preventScrolling);
        ...
        function _openDropdown() {
          return _openDropdown2.apply(this, arguments);
        }
      ...
      value: function _selectChanged(e) {
        if (e.detail.value !== this.value) {
          ...
          this.$dropdownItems.forEach(function (dropdownItem) {
            if (e.detail.value === dropdownItem.getAttribute('value')) {
              dropdownItem.setAttribute('selected', true);
            } else {
              dropdownItem.removeAttribute('selected');
            }
          });
          this.dispatchEvent(new CustomEvent('vdesktopnavbaritem-select-changed', {
            bubbles: true,
            composed: true,
            detail: {
      ...
      value: function _addEventListeners() {
        this.$button.addEventListener('focusout', this._handleFocusOut);
        ...
        window.addEventListener('desktop-navbar-touchstart', this.boundClickOutside);
      }
    }, {
      kind: "method",
      key: "_handleClickOutside",
      value: function _handleClickOutside() {
        this.hover = false;
        this.active = false;
        this.expanded = false;
        this.requestUpdate('hover', this.hover);
      }
    }, {
      kind: "method",
      ...
      value: function disconnectedCallback() {
        ...
        window.removeEventListener('desktop-navbar-touchstart', this.boundClickOutside);
      }
    }, {
      kind: "method",
      key: "_addDropdownEventListeners",
      value: function _addDropdownEventListeners() {
        var firstDropdownItem = Object(utils["i" /* getElementByIdx */])(this.$dropdownItems, 0);
        var lastDropdownItem = Object(utils["i" /* getElementByIdx */])(this.$dropdownItems, this.$dropdownItems.length - 1);
        firstDropdownItem.addEventListener('mouseover', this._toggleFirstItemHovered);
        firstDropdownItem.addEventListener('mouseout', this._toggleFirstItemHovered);
        lastDropdownItem.addEventListener('focusout', this._handleDropdownItemFocusout);
      }
    }, {
      kind: "method",
      key: "_button",
      value: function _button() {
        return this.link ? Object(lit_element["d" /* html */])(_templateObject2(), this._handleMousedown, this._handleMouseout, this._setHoverTrue, this._buttonClasses(), this.link, this.ariaLabel, this._buttonContent()) : Object(lit_element["d" /* html */])(_templateObject3(), this._mouseOut, this._mouseOver, this._handleTouchStart, this._handleKeyup, this._preventScrolling, this._buttonClasses(), this.ariaLabel, this.dropdownId, this._buttonContent());
      }
    }, {
      kind: "method",
      key: "_buttonClasses",
      value: function _buttonClasses() {
        return Object(class_map["a" /* classMap */])({
          button: true,
          hover: this.hover,
      ...
      kind: "method",
      key: "_buttonContent",
      value: function _buttonContent() {
        return Object(lit_element["d" /* html */])(_templateObject4(), this.inPrimaryNav ? 'primary-nav-span' : '', this.text.replace(/<[^>]*>?/gm, ''), Object(unsafe_html["a" /* unsafeHTML */])(this.text), this.hasDropdown ? Object(lit_element["d" /* html */])(_templateObject5(), this._caretType(), this._caretColor()) : undefined, !this.withIcon ? Object(lit_element["d" /* html */])(_templateObject6()) : undefined);
      }
    }, {
      kind: "method",
      key: "_caretType",
      value: function _caretType() {
        return this.openUp ? 'caretup' : 'caretdown';
      }
    }, {
      kind: "method",
      key: "_caretColor",
      value: function _caretColor() {
        return '--v-colors__primary';
      }
    }, {
      kind: "method",
      key: "_dropdownClasses",
      value: function _dropdownClasses() {
        return Object(class_map["a" /* classMap */])({
          dropdown: true,
          hover: this.hover,
          'first-item-hovered': this.firstItemHovered,
      ...
      kind: "method",
      key: "_handleDropdownItemFocusout",
      value: function _handleDropdownItemFocusout() {
        this.hover = false;
        this.expanded = false;
      }
    }, {
      ...
      value: function _handleFocusOut(e) {
        if (e.relatedTarget && e.relatedTarget.tagName !== 'V-DROPDOWN-ITEM') {
          this.hover = false;
          this.expanded = false;
        }
      }
      ...
      value: function () {
        var _handleTouchStart2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(e) {
          var hover, active, event;
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  hover = this.hover;
                  active = this.active;
                  event = new CustomEvent('desktop-navbar-touchstart');
                  window.dispatchEvent(event);
                  this.hover = !hover;
                  this.active = !active;
                  this.expanded = this.hover ? true : false;
        ...
        function _handleTouchStart(_x) {
          return _handleTouchStart2.apply(this, arguments);
        }
      ...
      kind: "method",
      key: "_toggleFirstItemHovered",
      value: function _toggleFirstItemHovered() {
        this.firstItemHovered = !this.firstItemHovered;
      }
    }, {
      kind: "field",
      key: "_updateIconAttribute",
      value: function value() {
        var _this4 = this;

        return function (_ref) {
          var changedProperties = _ref.changedProperties,
              attribute = _ref.attribute;

          if (_this4.$icon && changedProperties.has(attribute)) {
            _this4[attribute] ? _this4.$icon.setAttribute(attribute, '') : _this4.$icon.removeAttribute(attribute);
          }
        };
      }
    }, {
      kind: "method",
      key: "_assignFontSize",
      value: function _assignFontSize() {
