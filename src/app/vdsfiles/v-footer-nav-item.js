...
/******/ 	return __webpack_require__(__webpack_require__.s = "D3sR");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VFooterNavItem", function() { return /* binding */ v_footer_nav_item_VFooterNavItem; });
...
// CONCATENATED MODULE: ./src/components/v-footer-nav-item/styles.js
...
/* harmony default export */ var v_footer_nav_item_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/index.js + 8 modules
var utils = __webpack_require__("7Qib");

// CONCATENATED MODULE: ./src/components/v-footer-nav-item/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_footer_nav_item_taggedTemplateLiteral(["\n      <v-icon\n        linkButton\n        aria-label=\"", "\"\n        name=", "\n        href=", "\n        target=", "\n        size=", "\n      >\n        <slot class=\"textShow\"></slot>\n      </v-icon>\n    "]);
...
function v_footer_nav_item_templateObject() {
  var data = v_footer_nav_item_taggedTemplateLiteral([" <slot></slot> "]);

  v_footer_nav_item_templateObject = function _templateObject() {
    return data;
  };
...
function v_footer_nav_item_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_footer_nav_item_VFooterNavItem = _decorate([Object(lit_element["c" /* customElement */])('v-footer-nav-item')], function (_initialize, _LitElement) {
  var VFooterNavItem = /*#__PURE__*/function (_LitElement2) {
    _inherits(VFooterNavItem, _LitElement2);

    var _super = _createSuper(VFooterNavItem);

    function VFooterNavItem() {
      var _this;

      _classCallCheck(this, VFooterNavItem);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_footer_nav_item_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return !this.linkName ? this._listOfItem() : this._normal();
      }
    }, {
      kind: "method",
      key: "_listOfItem",
      value: function _listOfItem() {
        return Object(lit_element["d" /* html */])(v_footer_nav_item_templateObject());
      }
    }, {
      kind: "method",
      key: "_normal",
      value: function _normal() {
        return Object(lit_element["d" /* html */])(_templateObject2(), this._setTarget() === '_blank' ? this.getAttribute('aria-label') ? 'open in ' + this.getAttribute('aria-label') + ' new tab' : '' : this.getAttribute('aria-label') ? 'redirects to ' + this.getAttribute('aria-label') : '', this.linkName, this.linkRef, this._setTarget(), this.iconSize);
      }
    }, {
      kind: "method",
      key: "_setTarget",
      value: function _setTarget() {
        var linkRef = this.linkRef && !Object(utils["o" /* isHostMatchWithVoya */])(this.linkRef) && Object(utils["m" /* isAbsoluteUrl */])(this.linkRef) && this.linkRef !== '#';

        if (!this.target && linkRef || this.target === '_blank') {
          return '_blank';
        } else {
          return '_self';
        }
