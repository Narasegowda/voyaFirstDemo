...
/******/ 	return __webpack_require__(__webpack_require__.s = "aqis");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VArticleInfoBar", function() { return /* binding */ v_article_infobar_VArticleInfoBar; });
...
// CONCATENATED MODULE: ./src/components/v-article-infobar/styles.js
function _templateObject() {
...
/* harmony default export */ var v_article_infobar_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-article-infobar/slottedStyles.js
function slottedStyles_templateObject() {
  var data = slottedStyles_taggedTemplateLiteral(["\n  v-article-infobar-topics::after {\n    content: ', ';\n    float: right;\n    position: relative;\n    top: -20px;\n  }\n\n  v-article-infobar-topics:nth-last-child(2)::after {\n    content: '';\n  }\n\n  @media screen and (max-width: 768px) {\n    v-article-infobar-topics::after {\n      top: -15px;\n      content: ' , ';\n    }\n  }\n"]);

  slottedStyles_templateObject = function _templateObject() {
    return data;
  };
...
function slottedStyles_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


/* harmony default export */ var slottedStyles = (Object(lit_element["b" /* css */])(slottedStyles_templateObject()));
// CONCATENATED MODULE: ./src/components/v-article-infobar/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_article_infobar_templateObject() {
  var data = v_article_infobar_taggedTemplateLiteral(["\n      <div class=\"infobar\">\n        <div class=\"article-info\">\n          <div id=\"source\" class=\"info-text\">", "</div>\n          <div id=\"author\" class=\"info-text\">By ", "</div>\n        </div>\n\n        <div class=\"", "\">\n          <div id=\"related\" class=\"info-text\">Related Topics:</div>\n          <slot></slot>\n        </div>\n      </div>\n    "]);

  v_article_infobar_templateObject = function _templateObject() {
    return data;
  };
...
function v_article_infobar_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_article_infobar_VArticleInfoBar = _decorate([Object(lit_element["c" /* customElement */])('v-article-infobar')], function (_initialize, _LitElement) {
  var VArticleInfoBar = /*#__PURE__*/function (_LitElement2) {
    _inherits(VArticleInfoBar, _LitElement2);

    var _super = _createSuper(VArticleInfoBar);

    function VArticleInfoBar() {
      var _this;

      _classCallCheck(this, VArticleInfoBar);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_article_infobar_styles];
      }
    }, {
      kind: "method",
      ...
      value: function render() {
        ...
        if (this.getElementsByTagName('v-article-infobar-topics').length < 1) {
          noTopics = true;
        }

        return Object(lit_element["d" /* html */])(v_article_infobar_templateObject(), this.source, this.author, noTopics ? 'topics noTopics' : 'topics');
      }
    }]
  };
