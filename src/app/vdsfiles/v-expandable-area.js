...
/******/ 	return __webpack_require__(__webpack_require__.s = "75xt");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VExpandableArea", function() { return /* binding */ v_expandable_area_VExpandableArea; });
...
/* harmony default export */ var v_expandable_area_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-expandable-area/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject4() {
  var data = v_expandable_area_taggedTemplateLiteral(["\n          <v-icon primary focusable=\"false\" name=\"expand\" size=\"26px\"></v-icon>\n        "]);
...
function _templateObject2() {
  var data = v_expandable_area_taggedTemplateLiteral(["<slot name=\"expandableContent\"></slot>"]);
...
function v_expandable_area_templateObject() {
  var data = v_expandable_area_taggedTemplateLiteral(["\n      <div class=\"container ", "\">\n        <div class=\"banner-content\">\n          <button\n            class=\"", "\"\n            tabindex=", "\n          >\n            ", "\n          </button>\n          <slot name=\"bannerContent\"></slot>\n        </div>\n        <div class=\"expandable-content ", "\">\n          <div\n            class=\"expandable-content-inner ", "\"\n          >\n            ", "\n          </div>\n        </div>\n      </div>\n    "]);

  v_expandable_area_templateObject = function _templateObject() {
    return data;
  };
...
function v_expandable_area_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_expandable_area_VExpandableArea = _decorate([Object(lit_element["c" /* customElement */])('v-expandable-area')], function (_initialize, _LitElement) {
  var VExpandableArea = /*#__PURE__*/function (_LitElement2) {
    _inherits(VExpandableArea, _LitElement2);

    var _super = _createSuper(VExpandableArea);

    function VExpandableArea() {
      var _this;

      _classCallCheck(this, VExpandableArea);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], global_styles["a" /* default */], v_expandable_area_styles];
      }
    }, {
      kind: "method",
      key: "toggle",
      value: function toggle(event) {
        ...
        if (!Object(utils["p" /* isIE */])() && (event.detail === 1 || Object(keyboardAccessibility["a" /* enterKeypress */])(event) || Object(keyboardAccessibility["c" /* spaceKeypress */])(event))) {
          this.open = !this.open;
        } else if (Object(utils["p" /* isIE */])()) {
          if (!this.clickinprogress) {
            this.clickinprogress = true;
            this.open = !this.open;
            setTimeout(function () {
              _this2.clickinprogress = false;
            }, 500);
          }
        }
      }
      ...
      value: function render() {
        return Object(lit_element["d" /* html */])(v_expandable_area_templateObject(), this.lightColor ? 'light' : '', this.compactSize ? 'compact button' : 'button', this.tabIndex, this._toggleIcon(), this.open ? 'open' : '', this.compactSize ? 'compact' : '', this.open ? Object(lit_element["d" /* html */])(_templateObject2()) : "");
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        this.$icon = this.shadowRoot.querySelector('button');

        if (this.$icon) {
          this.$icon.addEventListener('click', function (e) {
            _this3.toggle(e);
          }, true);
          this.$icon.addEventListener('keypress', function (e) {
            _this3.toggle(e);
          }, true);
        }
      }
      ...
      value: function value() {
        ...
        return function () {
          var element = _this4.shadowRoot.querySelector('.expandable-content');
      ...
      value: function value() {
        ...
        return function () {
          var element = _this5.shadowRoot.querySelector('.expandable-content');
      ...
      value: function value() {
        ...
        return function () {
          return _this6.open ? Object(lit_element["d" /* html */])(_templateObject3()) : Object(lit_element["d" /* html */])(_templateObject4());
        };
      }
    }, {
      kind: "method",
      key: "_openClass",
      value: function _openClass() {
