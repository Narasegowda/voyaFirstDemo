...
/******/ 	return __webpack_require__(__webpack_require__.s = "7nF/");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VTextArea", function() { return /* binding */ v_textarea_VTextArea; });
...
// CONCATENATED MODULE: ./src/components/v-textarea/styles.js
...
/* harmony default export */ var v_textarea_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-textarea/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject4() {
  var data = v_textarea_taggedTemplateLiteral(["\n          <label\n            class=", "\n            for=", "\n            >", "", "</label\n          >\n        "]);
...
function _templateObject2() {
  var data = v_textarea_taggedTemplateLiteral([" <span>*</span> "]);
...
function v_textarea_templateObject() {
  var data = v_textarea_taggedTemplateLiteral(["\n      ", "\n      <textarea\n        ?autofocus=", "\n        class=", "\n        ?disabled=", "\n        ?error=", "\n        ?readonly=", "\n        ?required=", "\n        @input=", "\n        autocomplete=", "\n        id=", "\n        maxlength=", "\n        minlength=", "\n        name=", "\n        placeholder=", "\n        size=", "\n        tabindex=", "\n        value=", "\n        aria-label=\"", "\"\n        style=\"width:", "\"\n        pattern=", "\n      ></textarea>\n      <span id=\"", "-remainingC\"\n        >Maximum ", " characters</span\n      >\n      ", "\n    "]);

  v_textarea_templateObject = function _templateObject() {
    return data;
  };
...
function v_textarea_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_textarea_VTextArea = _decorate([Object(lit_element["c" /* customElement */])('v-textarea')], function (_initialize, _LitElement) {
  var VTextArea = /*#__PURE__*/function (_LitElement2) {
    _inherits(VTextArea, _LitElement2);

    var _super = _createSuper(VTextArea);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_textarea_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        this.$input = this.hasAttribute('disable-shadow') ? this.querySelector('textarea') : this.shadowRoot.querySelector('textarea');
        this.$remainingC = this.hasAttribute('disable-shadow') ? this.querySelector('#' + this.id + '-remainingC') : this.shadowRoot.querySelector('#' + this.id + '-remainingC');
      }
    }, {
      kind: "field",
      key: "closest",
      ...
      value: function createRenderRoot() {
        ...
        return this.hasAttribute('disable-shadow') ? this : _get(_getPrototypeOf(VTextArea.prototype), "createRenderRoot", this).call(this);
      }
    }, {
      kind: "method",
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(VTextArea.prototype), "connectedCallback", this).call(this);
      ...
      value: function value() {
        ...
        return function (event) {
          if (event.keyCode === 13) {
            if (_this2.disableSubmit === false) {
              var form = _this2.closest(_this2, function (el) {
                return el.localName === 'form';
              });
      ...
      value: function disconnectedCallback() {
        ...
        _get(_getPrototypeOf(VTextArea.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_textarea_templateObject(), this._label(), this.autoFocus, Object(class_map["a" /* classMap */])({
          vtextArea: true
        }), this.disabled, this.error, this.readOnly, this.required, this._handleInput, this.autoComplete, this.id, this.maxLength, this.minLength, this.name, this.placeholder, this.size, this.inputTabIndex, this.value, this.altLabel, Object(lit_element["g" /* unsafeCSS */])(this.width), this.pattern, this.id, this.maxLength, this._errorText());
      }
    }, {
      kind: "field",
      key: "checkValidity",
      value: function value() {
        ...
        return function () {
          return _this3.$input.checkValidity();
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          return _this4.required ? Object(lit_element["d" /* html */])(_templateObject2()) : undefined;
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          return _this5.errorText ? Object(lit_element["d" /* html */])(_templateObject3(), _this5.errorText, Object(class_map["a" /* classMap */])({
            vtextAreaErrorText: 'vTextAreaErrorText'
          })) : undefined;
        };
      }
    }, {
      ...
      kind: "method",
      key: "_updateCharacterMessage",
      value: function _updateCharacterMessage() {
        var text_length = this.value.length;
        var text_remaining = this.maxLength - text_length;
        var htmlText = 'Maximum ' + this.maxLength + ' characters';

        if (text_remaining < this.maxLength) {
          htmlText = 'Maximum ' + this.maxLength + ' characters (' + text_remaining + ' characters remaining )';
        }

        this.$remainingC.innerHTML = htmlText;
      }
    }, {
      kind: "field",
      key: "_label",
      value: function value() {
        ...
        return function () {
          return _this6.labelText ? Object(lit_element["d" /* html */])(_templateObject4(), Object(class_map["a" /* classMap */])({
            disabled: _this6.disabled,
            error: _this6.error,
            vtextAreaLabel: true
          }), _this6.id, _this6._asterisk(), _this6.labelText) : undefined;
        };
      }
    }, {
      kind: "method",
      ...
      value: function dispatchValidity() {
        this.dispatchEvent(new CustomEvent('vtextarea-checkvalidity', {
