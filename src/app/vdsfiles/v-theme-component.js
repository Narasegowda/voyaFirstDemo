...
/******/ 	return __webpack_require__(__webpack_require__.s = "wtdK");
/******/ })
/************************************************************************/
/******/ ({
...
/* MIT license */
var colorNames = __webpack_require__("T016");
var swizzle = __webpack_require__("JRS9");
...
var isArrayish = __webpack_require__("8MvT");
...
var colorString = __webpack_require__("GrlX");
var convert = __webpack_require__("uxXc");
...
// CONCATENATED MODULE: ./src/functions/consts.js
var THEME_CLASS = 'vds-theme';
// EXTERNAL MODULE: ./node_modules/color/index.js
var color = __webpack_require__("aSns");
...
// CONCATENATED MODULE: ./src/functions/themeComponents.js



var themeComponents_themeComponents = function themeComponents() {
  var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var CSS_START = ':root{';
  var CSS_END = '}';
  /**
   * calculate primary colors as RGB string (e.g. 100,100,100)
   */

  var primaryColor = opts.primaryColor || '#145a7b';
  var primaryColorRgb = color_default.a.rgb(primaryColor);
  var pDarker10 = opts.primaryDarker || color_default()(primaryColor).darken(0.1).rgb() || '#02385b';
  var pDarkerRgb10 = color_default.a.rgb(pDarker10);
  var pDarker20 = opts.primaryDarker || color_default()(primaryColor).darken(0.2).rgb() || '#02385b';
  var pLighter80 = color_default()(primaryColor).lighten(0.8).rgb() || '#02385b';
  var pDarkerRgb20 = color_default.a.rgb(pDarker20);
  var pLighterRgb80 = color_default.a.rgb(pLighter80);
  /**
   * calculate secondary colors as RGB string (e.g. 100,100,100)
   */

  var secondaryColor = opts.secondaryColor || '#d75426';
  var secondaryColorRgb = color_default.a.rgb(secondaryColor);
  var secondaryDarker = opts.primaryDarker || color_default()(primaryColor).darken(0.2).rgb() || '#d75426';
  var secondaryDarkerRgb = color_default.a.rgb(secondaryDarker);
  var theme = {
    /**
     * use the rgb color strings in the css custom variables to make
     * them all become automatically updated when
     * the primary or secondary colors are updated
     */
    '--v-var__primaryRGB': "".concat(primaryColorRgb.array().join()),
    '--v-var__primaryDarkerRGB': "".concat(pDarkerRgb10.array().join()),
    '--v-var__primaryDarkerRGB20': "".concat(pDarkerRgb20.array().join()),
    '--v-var__primaryLighterRGB80': "".concat(pLighterRgb80.array().join()),
    '--v-var__secondaryRGB': "".concat(secondaryColorRgb.array().join()),
    '--v-var__secondaryDarkerRGB': "".concat(secondaryDarkerRgb.array().join()),
    // Fonts
    ...
    // Colors
    '--v-colors__primary': 'rgba(var(--v-var__primaryRGB), 1)' || false,
    '--v-colors__primary-darker-1': 'rgba(var(--v-var__primaryDarkerRGB), 1)' || false,
    '--v-colors__primary-darker-2': 'rgba(var(--v-var__primaryDarkerRGB20), 1)' || false,
    '--v-colors__primary-lighter': '#bba4bc',
    '--v-colors__primary-lighter-2': 'rgba(var(--v-var__primaryLighterRGB80), .2)' || false,
    ...
    '--v-colors__secondary': 'rgba(var(--v-var__secondaryRGB), 1)' || false,
    '--v-colors__secondary-darker-brand': '#f26622',
    '--v-colors__secondary-darker': 'rgba(var(--v-var__secondaryDarkerRGB), 1)' || false,
    '--v-colors__secondary-10': 'rgba(var(--v-var__secondaryRGB), .1)' || false,
  ...
  if (!Object(featureDetection["a" /* browserSupportsCssVariables */])()) {
    // eslint-disable-next-line
    ShadyCSS.styleDocument(theme);
  } else {
    var css_content = '';
    Object.keys(theme).forEach(function (key) {
      css_content = "".concat(css_content).concat(key, ": ").concat(theme[key], ";");
    });
    var css = CSS_START + css_content + CSS_END;
    var styles = document.querySelector(THEME_CLASS) || document.createElement('style');
    styles.innerText = css;

    if (!document.querySelector('head').contains(styles)) {
      styles.className = THEME_CLASS;
...
// CONCATENATED MODULE: ./src/utils/voyaBaseConfigs.js
var voyaBaseConfigs = function voyaBaseConfigs() {
  var ssoBaseUrl = '';
  var cdnBaseUrl = '';
  var region = '';
  var origin = '';
  ...
  var hostSplit = host && host.split('.');

  if (host.includes('accp')) {
    ssoBaseUrl = "https://".concat(hostSplit[0], ".accp.voya.com");
    cdnBaseUrl = 'https://cdn.accp.voya.com';
    region = 'accp';
  } else if (host.includes('intg')) {
    ssoBaseUrl = "https://".concat(hostSplit[0], ".intg.voya.com");
    cdnBaseUrl = 'https://cdn.intg.voya.com';
    region = 'intg';
  } else if (host.includes('unit')) {
    ssoBaseUrl = "https://".concat(hostSplit[0], ".unit.voya.com");
    cdnBaseUrl = 'https://cdn.unit.voya.com';
    region = 'unit';
  } else if (host.includes('localhost') || host.includes('github.voya.net') //TO make it work in demo pages to pull from unit region.
  ) {
      // DEVELOPMENT env
      ssoBaseUrl = 'https://my3.unit.voya.com';
      cdnBaseUrl = 'https://cdn.unit.voya.com';
      region = 'local';
    } else {
    // Deafualt to Prod env
    ssoBaseUrl = 'https://my.voya.com';
    cdnBaseUrl = 'https://cdn.voya.com';
    region = 'prod';
  }
  ...
  voya.host = host;
  voya.origin = origin;
  voya.baseUrls.ssoBaseUrl = ssoBaseUrl;
  voya.baseUrls.cdnBaseUrl = cdnBaseUrl;
  window.vds = voya;
  return window.vds;
};
...
// CONCATENATED MODULE: ./src/components/v-theme-component/index.js
...
voyaBaseConfigs();
Object(loadFontAwesome["a" /* loadFontAwesome */])();

if (!document.querySelector(".".concat(THEME_CLASS))) {
  //if no custom theme has been defined, set the default theme
  themeComponents_themeComponents();
}

if (typeof window.themeComponents !== 'function') {
  window.themeComponents = themeComponents_themeComponents;
}

Object(googleAnalytics["b" /* listenForEvents */])();
