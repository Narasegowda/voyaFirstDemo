...
/******/ 	return __webpack_require__(__webpack_require__.s = "MJj8");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VBrandStripe", function() { return /* binding */ v_brand_stripe_VBrandStripe; });
...
// CONCATENATED MODULE: ./src/components/v-brand-stripe/styles.js
...
/* harmony default export */ var v_brand_stripe_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/index.js + 8 modules
var utils = __webpack_require__("7Qib");

// CONCATENATED MODULE: ./src/components/v-brand-stripe/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject3() {
  var data = v_brand_stripe_taggedTemplateLiteral([""]);
...
function _templateObject2() {
  var data = v_brand_stripe_taggedTemplateLiteral([" <img\n                  src=\"", "\"\n                  alt=\"brandStrip\"\n                  class=", "\n                />"]);
...
function v_brand_stripe_templateObject() {
  var data = v_brand_stripe_taggedTemplateLiteral(["\n      <div class=\"", "\">\n        <div class=\"", "\">\n          <div\n            class=\"", "\"\n            style=\"background: linear-gradient(to left,", ",", ");\"\n          >\n            ", "\n          </div>\n        </div>\n      </div>\n    "]);

  v_brand_stripe_templateObject = function _templateObject() {
    return data;
  };
...
function v_brand_stripe_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_brand_stripe_VBrandStripe = _decorate([Object(lit_element["c" /* customElement */])('v-brand-stripe')], function (_initialize, _LitElement) {
  var VBrandStripe = /*#__PURE__*/function (_LitElement2) {
    _inherits(VBrandStripe, _LitElement2);

    var _super = _createSuper(VBrandStripe);

    function VBrandStripe() {
      var _this;

      _classCallCheck(this, VBrandStripe);
  ...
  return {
    ...
    d: [{
      ...
      value: function value() {
        return '/global/images/voya-bar/1.0.0/voya-bar-72x45.png';
      }
    }, {
      kind: "field",
      decorators: [Object(lit_element["f" /* property */])({
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_brand_stripe_styles];
      }
    }, {
      kind: "method",
      key: "connectedCallback",
      value: function connectedCallback() {
        ...
        if (this.imageSource !== '') {
          this.imageSource = "".concat(cdnBaseUrl).concat(this.imageSource);
        }

        _get(_getPrototypeOf(VBrandStripe.prototype), "connectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        ...
        return Object(lit_element["d" /* html */])(v_brand_stripe_templateObject(), defaultColor ? 'stripeContainer' : '', defaultColor ? 'hostContainer' : 'hostCustomContainer', defaultColor ? 'container defaultStrip' : 'container custom', Object(lit_element["g" /* unsafeCSS */])(this.colorFrom), Object(lit_element["g" /* unsafeCSS */])(this.colorTo), this.imageSource ? Object(lit_element["d" /* html */])(_templateObject2(), this.imageSource, Object(utils["p" /* isIE */])() ? 'stripeImage imgIE' : 'stripeImage') : Object(lit_element["d" /* html */])(_templateObject3()));
      }
    }]
  };
