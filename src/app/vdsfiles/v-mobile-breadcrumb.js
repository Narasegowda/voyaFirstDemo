...
/******/ 	return __webpack_require__(__webpack_require__.s = "mprP");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VMobileBreadcrumb", function() { return /* binding */ v_mobile_breadcrumb_VMobileBreadcrumb; });
...
// CONCATENATED MODULE: ./src/components/v-mobile-breadcrumb/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  .mobile_BreadCrumb_Text {\n    font-family: var(--v-fonts__primary);\n    font-size: 14px;\n    font-weight: 300;\n    color: var(--v-colors__black);\n  }\n"]);
...
/* harmony default export */ var v_mobile_breadcrumb_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-mobile-breadcrumb/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_mobile_breadcrumb_templateObject() {
  var data = v_mobile_breadcrumb_taggedTemplateLiteral(["\n      <v-icon\n        linkButton\n        tabIndex=", "\n        href=", "\n        name=\"chevronleftcircle\"\n        size=\"35px\"\n        primary\n      >\n        <slot class=\"mobile_BreadCrumb_Text\"></slot>\n      </v-icon>\n    "]);

  v_mobile_breadcrumb_templateObject = function _templateObject() {
    return data;
  };
...
function v_mobile_breadcrumb_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_mobile_breadcrumb_VMobileBreadcrumb = _decorate([Object(lit_element["c" /* customElement */])('v-mobile-breadcrumb')], function (_initialize, _LitElement) {
  var VMobileBreadcrumb = /*#__PURE__*/function (_LitElement2) {
    _inherits(VMobileBreadcrumb, _LitElement2);

    var _super = _createSuper(VMobileBreadcrumb);

    function VMobileBreadcrumb() {
      var _this;

      _classCallCheck(this, VMobileBreadcrumb);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_mobile_breadcrumb_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_mobile_breadcrumb_templateObject(), this.buttonTabIndex, this.href);
      }
    }]
  };
