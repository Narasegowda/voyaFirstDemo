...
/******/ 	return __webpack_require__(__webpack_require__.s = "ucBr");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vCustomSlider", function() { return /* binding */ v_custom_slider_vCustomSlider; });
...
/* harmony default export */ var v_custom_slider_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-custom-slider/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_custom_slider_templateObject() {
  var data = v_custom_slider_taggedTemplateLiteral(["\n      <div style=\"position:relative;height:", "\">\n        <div class=\"slider-wrapper\">\n          <div id=\"slider-container\" style=\"touch-action: none;height:100%\">\n            <div class=\"slider-progress\" id=\"slider-progress\">\n              <div id=\"draggable-point\" style=\"top:0px\">\n                <div id=\"slider-progress-handle\"></div>\n              </div>\n              <div\n                id=\"slider-progress-bar\"\n                class=\"bar\"\n                style=\" height: 0px;\"\n              ></div>\n            </div>\n          </div>\n        </div>\n      </div>\n    "]);

  v_custom_slider_templateObject = function _templateObject() {
    return data;
  };
...
function v_custom_slider_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_custom_slider_vCustomSlider = _decorate([Object(lit_element["c" /* customElement */])('v-custom-slider')], function (_initialize, _LitElement) {
  var vCustomSlider = /*#__PURE__*/function (_LitElement2) {
    _inherits(vCustomSlider, _LitElement2);

    var _super = _createSuper(vCustomSlider);

    function vCustomSlider() {
      var _this;

      _classCallCheck(this, vCustomSlider);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_custom_slider_styles];
      }
    }, {
      kind: "method",
      key: "attributeChangedCallback",
      value: function attributeChangedCallback(name, oldVal, newVal) {
        _get(_getPrototypeOf(vCustomSlider.prototype), "attributeChangedCallback", this).call(this, name, oldVal, newVal);
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_custom_slider_templateObject(), this.sliderHeight);
      }
    }, {
      kind: "method",
      key: "calcualteOffset",
      value: function calcualteOffset(value) {
        var wrapperHeight = this.pageScrollHeight;
        var scrollContainerHeight = this.getContainerHeight('slider-container') - 25;
        return parseFloat(wrapperHeight / scrollContainerHeight) * value;
      }
    }, {
      kind: "method",
      key: "_dispatchChangeEvent",
      value: function _dispatchChangeEvent() {
        this.dispatchEvent(new CustomEvent('vslider-event', {
          bubbles: true,
          composed: true,
          detail: {
            value: this.value
      ...
      kind: "method",
      key: "setScroll",
      value: function setScroll(sliderScrollValue) {
        this.value = this.calcualteOffset(sliderScrollValue);
      ...
      value: function firstUpdated() {
        this.elementRef = this.shadowRoot.getElementById('draggable-point');

        if (Object(utils["s" /* isMobile */])()) {
          this.elementRef.ontouchstart = this.touchDown;
        } else {
          this.elementRef.onmousedown = this.dragMouseDown;
        }
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          ...
          _this2.preDirection = 'none';
        };
      }
    }, {
      kind: "field",
      key: "closeTouchElement",
      value: function value() {
        var _this3 = this;
        ...
        return function () {
          ...
          _this3.preDirection = 'none';
        };
      }
    }, {
      kind: "method",
      key: "getContainerHeight",
      value: function getContainerHeight(elemrefId) {
        if (this.shadowRoot.getElementById(elemrefId)) {
          return this.shadowRoot.getElementById(elemrefId).clientHeight;
        } else {
          return 0;
        }
      }
      ...
      value: function value() {
        ...
        return function (e) {
          e = e || window.event;
          e.preventDefault();
          var top = _this4.elementRef.style.top;
          var touch = e.touches[0];
          var clientPos = touch.clientY;

          if (top) {
            if (top.indexOf('px') !== -1) {
              _this4.defaultPos = clientPos - parseFloat(top.substring(0, top.lastIndexOf('px')));
            } else if (top.indexOf('%') !== -1) {
              _this4.defaultPos = clientPos - parseFloat(top.substring(0, top.lastIndexOf('px')));
            } else {
              _this4.defaultPos = clientPos;
            }
          } else {
            _this4.defaultPos = e.clientY;
          }

          document.ontouchend = _this4.closeTouchElement; // call a function whenever the cursor moves:

          document.ontouchmove = _this4.elementDrag;
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function (e) {
          e = e || window.event;
          e.preventDefault();
          var top = _this5.elementRef.style.top;

          if (top) {
            if (top.indexOf('px') !== -1) {
              _this5.defaultPos = e.clientY - parseFloat(top.substring(0, top.lastIndexOf('px')));
            } else if (top.indexOf('%') !== -1) {
              _this5.defaultPos = e.clientY - parseFloat(top.substring(0, top.lastIndexOf('px')));
            } else {
              _this5.defaultPos = e.clientY;
            }
          } else {
            _this5.defaultPos = e.clientY;
          }

          document.onmouseup = _this5.closeDragElement; // call a function whenever the cursor moves:

          document.onmousemove = _this5.elementDrag;
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function (e) {
          ...
          var containerEle = _this6.shadowRoot.getElementById('slider-container');

          var containerEleHeight = containerEle.clientHeight - 25;
          var perVal = 0;
          var clientPos = 0;

          if (Object(utils["s" /* isMobile */])()) {
            var touch = e.touches[0];
            clientPos = touch.clientY;
          } else {
            clientPos = e.clientY;
          }

          var change = false;
          var currentCursorPos = clientPos - _this6.defaultPos;

          if (containerEleHeight + 5 < currentCursorPos) {
            _this6.setScroll(containerEleHeight);

            return;
          } else if (-5 > currentCursorPos) {
            _this6.setScroll(0);

            return;
          }

          if (currentCursorPos >= 0 && currentCursorPos <= containerEleHeight) {
            _this6.prePos = _this6.nextPos;
            _this6.nextPos = currentCursorPos;

            if (_this6.nextPos < _this6.prePos) {
              if (_this6.preDirection === 'down' && _this6.prePos - _this6.nextPos < 2) {
                return;
              }

              _this6.preDirection = 'up';
              perVal = currentCursorPos > 0 ? currentCursorPos : 0;
              _this6.shadowRoot.getElementById('slider-progress-bar').style.height = perVal + 2 + 'px';
              _this6.shadowRoot.getElementById('draggable-point').style.top = perVal + 'px';
              change = true;
            } else if (_this6.nextPos > _this6.prePos) {
              if (_this6.preDirection === 'up' && _this6.nextPos - _this6.prePos < 3) {
                return;
              }

              _this6.preDirection = 'down';
              change = true;
              perVal = currentCursorPos;
              _this6.shadowRoot.getElementById('slider-progress-bar').style.height = perVal + 2 + 'px';
              _this6.shadowRoot.getElementById('draggable-point').style.top = perVal + 'px';
            }

            if (change) {
              _this6.setScroll(perVal);
