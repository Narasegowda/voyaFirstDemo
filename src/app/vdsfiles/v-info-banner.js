...
/******/ 	return __webpack_require__(__webpack_require__.s = "40fk");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VCalloutBanner", function() { return /* binding */ v_info_banner_VCalloutBanner; });
...
/* harmony default export */ var v_info_banner_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-info-banner/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject5() {
  var data = v_info_banner_taggedTemplateLiteral([""]);
...
function _templateObject4() {
  var data = v_info_banner_taggedTemplateLiteral(["<div class=\"hd-4\">", "</div>"]);
...
function _templateObject3() {
  var data = v_info_banner_taggedTemplateLiteral(["\n      <div\n        slot=\"bannerContent\"\n        class=", "\n      >\n        <v-icon\n          size=\"30px\"\n          color=\"--v-colors__secondary\"\n          name=", "\n        ></v-icon>\n        <div class=\"content-area content-area-IE\">\n          ", "\n          <slot name=\"bannerContent\"></slot>\n        </div>\n      </div>\n      <slot name=\"expandableContent\" slot=\"expandableContent\"></slot>\n    "]);
...
function v_info_banner_templateObject() {
  var data = v_info_banner_taggedTemplateLiteral(["\n          <v-expandable-area\n            compactsize\n            ?lightcolor=", "\n            ?open=", "\n          >\n            ", "\n          </v-expandable-area>\n        "]);

  v_info_banner_templateObject = function _templateObject() {
    return data;
  };
...
function v_info_banner_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_info_banner_VCalloutBanner = _decorate([Object(lit_element["c" /* customElement */])('v-info-banner')], function (_initialize, _LitElement) {
  var VCalloutBanner = /*#__PURE__*/function (_LitElement2) {
    _inherits(VCalloutBanner, _LitElement2);

    var _super = _createSuper(VCalloutBanner);

    function VCalloutBanner() {
      var _this;

      _classCallCheck(this, VCalloutBanner);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_info_banner_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        if (this.expandType === 'area' || this.expandType === 'both') {
          var banner = this.shadowRoot.querySelector('v-expandable-area').querySelector('div');
          ...
          if (assignedElementsBySlot && assignedElementsBySlot['bannerContent'] && assignedElementsBySlot['bannerContent'].length > 0) {
            if (assignedElementsBySlot['bannerContent'][0].querySelector('a')) {
              assignedElementsBySlot['bannerContent'][0].querySelector('a').addEventListener('click', function (e) {
                e.stopPropagation();
              });
            }
          }
      ...
      value: function render() {
        return this.expandable ? Object(lit_element["d" /* html */])(v_info_banner_templateObject(), this.lightColor, this.open, this._banner()) : Object(lit_element["d" /* html */])(_templateObject2(), this._banner());
      }
    }, {
      kind: "method",
      key: "_banner",
      value: function _banner() {
        return Object(lit_element["d" /* html */])(_templateObject3(), Object(class_map["a" /* classMap */])({
          container: true,
          expandable: this.expandable,
          standalone: !this.expandable,
          lightcolor: this.lightColor && !this.expandable
        }), this.iconName, this.title ? Object(lit_element["d" /* html */])(_templateObject4(), this.title) : Object(lit_element["d" /* html */])(_templateObject5()));
      }
    }]
  };
