...
/******/ 	return __webpack_require__(__webpack_require__.s = "RKJ0");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VCalloutBanner", function() { return /* binding */ v_callout_banner_VCalloutBanner; });
...
// CONCATENATED MODULE: ./src/components/v-callout-banner/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    font-family: var(--v-fonts__primary);\n    max-width: 1280px;\n  }\n\n  .calloutContainer {\n    align-items: center;\n    display: flex;\n    padding: 30px;\n  }\n\n  .calloutContainer.expandable {\n    padding-right: 80px;\n  }\n\n  .calloutContainer.standalone {\n    border-radius: 10px;\n    border: 1px solid var(--v-colors__gray-medium-2);\n  }\n\n  .calloutContainer.standalone.lightcolor {\n    border: 1px solid var(--v-colors__gray-medium-2);\n  }\n\n  .hd-4,\n  h4 {\n    font-size: 25px;\n    font-weight: 600;\n    margin: 0 0 15px 0;\n    color: var(--v-colors__black);\n  }\n\n  .illustration {\n    background-repeat: no-repeat;\n    background-size: contain;\n    height: 40px;\n    margin-right: 30px;\n    min-width: 40px;\n    width: 40px;\n    position: relative;\n    margin-top: -90px;\n  }\n\n  @media screen and (max-width: 1024px) and (min-width: 769px) {\n    .calloutContainer,\n    .calloutContainer.expandable {\n      padding: 40px;\n    }\n  }\n\n  @media screen and (max-width: 768px) {\n    .illustration {\n      background-position: center;\n      background-repeat: no-repeat;\n      background-size: contain;\n      height: 150px;\n      margin: 40px 0px;\n      padding: 0px 72px;\n      width: 100%;\n    }\n    .calloutContainer,\n    .calloutContainer.expandable {\n      padding: 20px;\n      display: block;\n    }\n\n    .hd-4 {\n      font-size: 18px;\n    }\n\n    .hd-4.expandable {\n      margin-right: 30px;\n    }\n  }\n"]);
...
/* harmony default export */ var v_callout_banner_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/createSlottedStyles.js
var createSlottedStyles = __webpack_require__("ZEzQ");

// CONCATENATED MODULE: ./src/components/v-callout-banner/slottedStyles.js
/* harmony default export */ var slottedStyles = ("\n  v-callout-banner ul {\n    margin: 0;\n    padding-left: 30px;\n  }\n\n  v-callout-banner ul li {\n    font-family: var(--v-fonts__primary);\n    font-size: 18px;\n    line-height: 24px;\n    color: var(--v-colors__black);\n    list-style: none;\n    margin-bottom: 10px;\n    position: relative;\n  }\n\n  v-callout-banner ul li:before {\n    background-color: var(--v-colors__secondary);\n    border-radius: 5px;\n    content: '';\n    display: inline-block;\n    height: 10px;\n    left: -30px;\n    position: absolute;\n    top: 6px;\n    width: 10px;\n  }\n\n  v-callout-banner ul li:last-of-type {\n    margin: 0;\n  }\n\n  v-callout-banner a {\n    margin: 0;\n    color: var(--v-states__link-color);\n  }\n\n  v-callout-banner a:hover {\n    color: var(--v-states__link-hover-color);\n  }\n\n  v-callout-banner a:active {\n    color: var(--v-states__link-active-color)\n  }\n\n  v-callout-banner a:visited {\n    color: var(--v-states__link-visited-color);\n  }\n  \n  v-callout-banner a:focus {\n    box-shadow: var(--v-states__focus-box-shadow-with-inset);\n    outline: none;\n  }\n\n  v-callout-banner p {\n    color: var(--v-colors__black);\n    font-family: var(--v-fonts__primary);\n    font-size: 18px;\n    line-height: 24px;\n    padding-bottom:26px;\n  }\n\n  v-callout-banner p:last-of-type {\n    margin-bottom: 0px;\n  }\n\n  @media only screen and (max-width: 480px) {\n    v-callout-banner ul {\n      padding-left: 30px;\n    }\n\n    v-callout-banner ul li {\n      font-size: 18px;\n      line-height: 24px;\n    }\n\n    v-callout-banner ul li:before {\n      left: -31px;\n      top: 6px;\n    }\n  }\n");
// CONCATENATED MODULE: ./src/components/v-callout-banner/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject3() {
  var data = v_callout_banner_taggedTemplateLiteral(["\n      <div\n        slot=\"bannerContent\"\n        class=", "\n      >\n        <div class=\"illustration\"></div>\n        <div class=\"content-area\">\n          <h4 aria-level=\"2\" class=\"", "\">\n            ", "\n          </h4>\n          <slot slot=\"bannerContent\" name=\"bannerContent\"></slot>\n        </div>\n      </div>\n      <slot slot=\"expandableContent\" name=\"expandableContent\"></slot>\n    "]);
...
function v_callout_banner_templateObject() {
  var data = v_callout_banner_taggedTemplateLiteral(["\n          <v-expandable-area ?lightcolor=", " ?open=", ">\n            ", "\n          </v-expandable-area>\n        "]);

  v_callout_banner_templateObject = function _templateObject() {
    return data;
  };
...
function v_callout_banner_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_callout_banner_VCalloutBanner = _decorate([Object(lit_element["c" /* customElement */])('v-callout-banner')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_callout_banner_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        Object(createSlottedStyles["a" /* createSlottedStyles */])(this, slottedStyles);

        if (this.illustrationPath) {
          this.$illustration.setAttribute('style', "background-image: url(".concat(this.illustrationPath, ");"));
        }
      ...
      key: "render",
      value: function render() {
        return this.expandable ? Object(lit_element["d" /* html */])(v_callout_banner_templateObject(), this.lightcolor, this.open, this._banner()) : Object(lit_element["d" /* html */])(_templateObject2(), this._banner());
      }
    }, {
      kind: "method",
      key: "toggle",
