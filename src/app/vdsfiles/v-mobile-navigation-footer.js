...
/******/ 	return __webpack_require__(__webpack_require__.s = "a/4+");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VMobileNavigationFooter", function() { return /* binding */ v_mobile_navigation_footer_VMobileNavigationFooter; });

// EXTERNAL MODULE: ./node_modules/lit-element/lit-element.js + 5 modules
var lit_element = __webpack_require__("CQbg");

// CONCATENATED MODULE: ./src/components/v-mobile-navigation-footer/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    display: flex;\n    flex-direction: column;\n    padding: 30px 20px 30px 20px;\n    width: 100%;\n  }\n\n  @media screen and (min-width: 834px) {\n    :host {\n      padding: 30px 40px 30px 40px;\n    }\n  }\n\n  ::slotted(v-icon-button-with-text:not(:last-of-type)) {\n    margin-bottom: 30px;\n  }\n"]);
...
/* harmony default export */ var v_mobile_navigation_footer_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-mobile-navigation-footer/slottedStyles.js
/* harmony default export */ var slottedStyles = ("\n\t.mobile_footer_icon {\n\t\tmargin : 15px 0px;\n\t}\n\n");
// CONCATENATED MODULE: ./src/components/v-mobile-navigation-footer/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_mobile_navigation_footer_templateObject() {
  var data = v_mobile_navigation_footer_taggedTemplateLiteral([" <slot></slot> "]);

  v_mobile_navigation_footer_templateObject = function _templateObject() {
    return data;
  };
...
function v_mobile_navigation_footer_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_mobile_navigation_footer_VMobileNavigationFooter = _decorate([Object(lit_element["c" /* customElement */])('v-mobile-navigation-footer')], function (_initialize, _LitElement) {
  var VMobileNavigationFooter = /*#__PURE__*/function (_LitElement2) {
    _inherits(VMobileNavigationFooter, _LitElement2);

    var _super = _createSuper(VMobileNavigationFooter);

    function VMobileNavigationFooter() {
      var _this;

      _classCallCheck(this, VMobileNavigationFooter);
    ...
    return VMobileNavigationFooter;
  }(_LitElement);

  return {
    F: VMobileNavigationFooter,
    d: [{
      kind: "get",
      "static": true,
      key: "styles",
      value: function styles() {
        return [commonStyles["a" /* default */], v_mobile_navigation_footer_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        assignedElementsBySlot['default'].forEach(function (footerIcon) {
          footerIcon.classList.add('mobile_footer_icon');

          if (Object(utils["p" /* isIE */])() && footerIcon.classList.contains('anchorText')) {
            footerIcon.style.margin = '15px 0px';
          }
        });
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_mobile_navigation_footer_templateObject());
      }
    }]
  };
