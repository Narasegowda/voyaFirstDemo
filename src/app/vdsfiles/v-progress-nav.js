...
/******/ 	return __webpack_require__(__webpack_require__.s = "7jOx");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VProgressNav", function() { return /* binding */ v_progress_nav_VProgressNav; });
...
/* harmony default export */ var v_progress_nav_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-progress-nav/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_progress_nav_templateObject() {
  var data = v_progress_nav_taggedTemplateLiteral(["\n      <div class=\"navItemContainer\">\n        <slot></slot>\n      </div>\n      <ul class=\"listContainer\"></ul>\n      <div class=\"line\"></div>\n    "]);

  v_progress_nav_templateObject = function _templateObject() {
    return data;
  };
...
function v_progress_nav_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_progress_nav_VProgressNav = _decorate([Object(lit_element["c" /* customElement */])('v-progress-nav')], function (_initialize, _LitElement) {
  var VProgressNav = /*#__PURE__*/function (_LitElement2) {
    _inherits(VProgressNav, _LitElement2);

    var _super = _createSuper(VProgressNav);

    function VProgressNav() {
      var _this;

      _classCallCheck(this, VProgressNav);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_progress_nav_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        this.slider = this.shadowRoot.querySelector('.navItemContainer');
        this.renderDots();
        setTimeout(function () {
          _this2.activeNavItem && typeof _this2.activeNavItem.scrollIntoView === 'function' && _this2.activeNavItem.scrollIntoView({
            block: 'nearest',
            inline: 'center'
          });
        }, 0.1);
      ...
      value: function disconnectedCallback() {
        ...
        for (var i = 0; i < dots.length; i++) {
          dots[i].removeEventListener('click', this._handleDotClick);
        }

        this.slider.removeEventListener('mousedown', this._mouseDownListener);
        this.slider.removeEventListener('mouseleave', this._mouseLeaveListener);
        this.slider.removeEventListener('mouseup', this._mouseUpListener);
        this.slider.removeEventListener('mousemove', this._mouseMoveListener);

        _get(_getPrototypeOf(VProgressNav.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "renderDots",
      value: function renderDots() {
        // Count number of progress nav items and render
        // equal number of orange nav dots along with active dot
        var navItems = this.querySelectorAll('v-progress-nav-item');
        var listContainer = this.shadowRoot.querySelector('.listContainer');

        for (var i = 0; i < navItems.length; i++) {
          var newDot = document.createElement('div');

          if (navItems[i].hasAttribute('active')) {
            this.activeNavItem = navItems[i];
            newDot.className = 'dot active';
          } else {
            newDot.className = 'dot';
          } // Autofill urls from nav-items


          if (!this.isSPA) {
            if (navItems[i].hasAttribute('href')) {
              var dotUrl = navItems[i].getAttribute('href');
              newDot.setAttribute('href', dotUrl);
            }
          }

          newDot.addEventListener('click', this._handleDotClick);
          listContainer.appendChild(newDot);
        }
      }
    }, {
      kind: "method",
      ...
      value: function render() {
        return Object(lit_element["d" /* html */])(v_progress_nav_templateObject());
      }
    }, {
      kind: "method",
      key: "addScroll",
      value: function addScroll() {
        var slider = this.shadowRoot.querySelector('.navItemContainer');
        slider.addEventListener('mousedown', this._mouseDownListener);
        slider.addEventListener('mouseleave', this._mouseLeaveListener);
        slider.addEventListener('mouseup', this._mouseUpListener);
        slider.addEventListener('mousemove', this._mouseMoveListener);
      }
    }, {
      kind: "method",
      key: "_handleDotClick",
      value: function _handleDotClick(event) {
        this.dispatchEvent(new CustomEvent('vprogressnav-dotClick', {
      ...
      value: function value() {
        ...
        return function (e) {
          ...
          _this3.slider.classList.add('scrollActive');

          _this3.startX = e.pageX - _this3.slider.offsetLeft;
          _this3.scrollLeft = _this3.slider.scrollLeft;
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          ...
          _this4.slider.classList.remove('scrollActive');
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          ...
          _this5.slider.classList.remove('scrollActive');
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function (e) {
          if (!_this6.isDown) return;
          e.preventDefault();
          var x = e.pageX - _this6.slider.offsetLeft;
          var walk = x - _this6.startX;
          _this6.slider.scrollLeft = _this6.scrollLeft - walk;
        };
      }
    }]
  };
