...
/******/ 	return __webpack_require__(__webpack_require__.s = "mJ/h");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VStyledGridItem", function() { return /* binding */ v_styled_grid_item_VStyledGridItem; });
...
/* harmony default export */ var v_styled_grid_item_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-styled-grid-item/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_styled_grid_item_templateObject() {
  var data = v_styled_grid_item_taggedTemplateLiteral(["\n      <img class=\"grid-img\" src=", " alt=", " />\n      <div class=\"hd-3 col-heading\">", "</div>\n      <p class=\"col-subtext\">", "</p>\n    "]);

  v_styled_grid_item_templateObject = function _templateObject() {
    return data;
  };
...
function v_styled_grid_item_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_styled_grid_item_VStyledGridItem = _decorate([Object(lit_element["c" /* customElement */])('v-styled-grid-item')], function (_initialize, _LitElement) {
  var VStyledGridItem = /*#__PURE__*/function (_LitElement2) {
    _inherits(VStyledGridItem, _LitElement2);

    var _super = _createSuper(VStyledGridItem);

    function VStyledGridItem() {
      var _this;

      _classCallCheck(this, VStyledGridItem);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_styled_grid_item_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_styled_grid_item_templateObject(), this.image, this.alt, this.gridItemText, Object(unsafe_html["a" /* unsafeHTML */])(this.gridItemSubText));
      }
    }]
  };
