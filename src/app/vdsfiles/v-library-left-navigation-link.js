...
/******/ 	return __webpack_require__(__webpack_require__.s = "wzkJ");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ var v_library_left_navigation_link_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-library-left-navigation-link/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_library_left_navigation_link_templateObject() {
  var data = v_library_left_navigation_link_taggedTemplateLiteral(["\n      <a name=\"", "\" class=\"anch\" tabindex=\"0\">\n        <div class=\"mobileLinkDiv\">", "</div>\n        <div class=\"mobileViewIcon\">\n          <v-icon primary name=\"chevronright\"></v-icon>\n        </div>\n      </a>\n    "]);

  v_library_left_navigation_link_templateObject = function _templateObject() {
    return data;
  };
...
function v_library_left_navigation_link_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_library_left_navigation_link_VLibraryLeftNavigationLink = _decorate([Object(lit_element["c" /* customElement */])('v-library-left-navigation-link')], function (_initialize, _LitElement) {
  var VLibraryLeftNavigationLink = /*#__PURE__*/function (_LitElement2) {
    _inherits(VLibraryLeftNavigationLink, _LitElement2);

    var _super = _createSuper(VLibraryLeftNavigationLink);

    function VLibraryLeftNavigationLink() {
      var _this;

      _classCallCheck(this, VLibraryLeftNavigationLink);
    ...
    return VLibraryLeftNavigationLink;
  }(_LitElement);

  return {
    F: VLibraryLeftNavigationLink,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_library_left_navigation_link_styles];
      }
    }, {
      kind: "field",
      key: "firstUpdated",
      value: function value() {
        ...
        return function () {
          _this2.$tab = _this2.shadowRoot.querySelector('.anch');
      ...
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        _get(_getPrototypeOf(VLibraryLeftNavigationLink.prototype), "disconnectedCallback", this) && _get(_getPrototypeOf(VLibraryLeftNavigationLink.prototype), "disconnectedCallback", this).call(this);
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_library_left_navigation_link_templateObject(), this.linkRef, this.tabText);
      }
    }, {
      kind: "method",
      key: "updated",
      ...
      value: function value() {
        ...
        return function () {
          _this3.$tab.addEventListener('mousedown', _this3._setListener);

          _this3.$tab.addEventListener('keyup', _this3._setListener);
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function (event) {
          if (event.type === 'mousedown') {
            _this4.$tab.classList.add('outlineColorTransparent');

            _this4.$tab.classList.remove('outlineColorBlack');
          } else if (Object(keyboardAccessibility["e" /* tabKeyup */])(event)) {
            _this4.$tab.classList.remove('outlineColorTransparent');

            _this4.$tab.classList.add('outlineColorBlack');
          }

          if (event.type === 'mousedown' || Object(keyboardAccessibility["b" /* enterKeyup */])(event)) {
            if (_this4.linkRef && _this4.linkRef !== '') {
              _this4.$tab.classList.add('mobileLinkDiv_active');

              _this4._fire('activateRightPanel', _this4.$tab.name + '~' + _this4.tabText);
            }
          }
        };
      }
