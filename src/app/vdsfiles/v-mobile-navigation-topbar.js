...
/******/ 	return __webpack_require__(__webpack_require__.s = "jcRJ");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VMobileNavigationTopbar", function() { return /* binding */ v_mobile_navigation_topbar_VMobileNavigationTopbar; });

// EXTERNAL MODULE: ./node_modules/lit-element/lit-element.js + 5 modules
var lit_element = __webpack_require__("CQbg");

// CONCATENATED MODULE: ./src/components/v-mobile-navigation-topbar/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    background-color: var(--v-colors__white);\n    box-shadow: var(--v-mobile-navigation-container__box-shadow);\n    position: relative;\n    width: 100%;\n    z-index: 10;\n  }\n\n  .gradient-bar {\n    background-image: var(\n      --v-mobile-navigation-topbar__gradient-bar-background-image\n    );\n    height: 5px;\n    width: 100%;\n  }\n\n  .wrapper {\n    align-items: center;\n    display: flex;\n    height: 85px;\n    justify-content: space-between;\n    padding: 0 25px 0 20px;\n    width: 100%;\n  }\n\n  button {\n    background-color: var(--v-colors__white);\n    border: none;\n    height: 25px;\n    padding: 0;\n    width: 25px;\n  }\n\n  button:focus {\n    box-shadow: var(--v-states__focus-box-shadow);\n    outline: none;\n  }\n\n  button::-moz-focus-inner {\n    border: 0;\n  }\n\n  v-logo {\n    height: auto;\n    width: 110px;\n  }\n\n  @media screen and (min-width: 834px) {\n    .wrapper {\n      padding-right: 20px;\n    }\n  }\n"]);
...
/* harmony default export */ var v_mobile_navigation_topbar_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/styles/commonStyles.js
var commonStyles = __webpack_require__("ONJ/");

// CONCATENATED MODULE: ./src/components/v-mobile-navigation-topbar/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_mobile_navigation_topbar_templateObject() {
  var data = v_mobile_navigation_topbar_taggedTemplateLiteral(["\n      <div class=\"wrapper\">\n        <v-logo\n          alt=", "\n          src=", "\n          logohref=", "\n        ></v-logo>\n        <v-hamburger @click=", "></v-hamburger>\n      </div>\n    "]);

  v_mobile_navigation_topbar_templateObject = function _templateObject() {
    return data;
  };
...
function v_mobile_navigation_topbar_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_mobile_navigation_topbar_VMobileNavigationTopbar = _decorate([Object(lit_element["c" /* customElement */])('v-mobile-navigation-topbar')], function (_initialize, _LitElement) {
  var VMobileNavigationTopbar = /*#__PURE__*/function (_LitElement2) {
    _inherits(VMobileNavigationTopbar, _LitElement2);

    var _super = _createSuper(VMobileNavigationTopbar);

    function VMobileNavigationTopbar() {
      var _this;

      _classCallCheck(this, VMobileNavigationTopbar);
    ...
    return VMobileNavigationTopbar;
  }(_LitElement);

  return {
    F: VMobileNavigationTopbar,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_mobile_navigation_topbar_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_mobile_navigation_topbar_templateObject(), this.alt, this.logoSrc, this.logoHref, this._handleButtonClick);
      }
    }, {
      kind: "method",
      key: "_handleButtonClick",
      value: function _handleButtonClick() {
        this.dispatchEvent(new CustomEvent('vmobilenavigationtopbar-click', {
          bubbles: true,
          composed: true
        }));
      }
