...
/******/ 	return __webpack_require__(__webpack_require__.s = "S7gN");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VStyledGrid", function() { return /* binding */ v_styled_grid_VStyledGrid; });
...
/* harmony default export */ var v_styled_grid_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/index.js + 8 modules
var utils = __webpack_require__("7Qib");

// CONCATENATED MODULE: ./src/components/v-styled-grid/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_styled_grid_templateObject() {
  var data = v_styled_grid_taggedTemplateLiteral(["\n      <div class=\"style-grid-container\">\n        <div class=\"grid-container\"><slot name=\"gridItem\"></slot></div>\n        <div class=\"button-container\"><slot name=\"gridButton\"></slot></div>\n      </div>\n    "]);

  v_styled_grid_templateObject = function _templateObject() {
    return data;
  };
...
function v_styled_grid_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_styled_grid_VStyledGrid = _decorate([Object(lit_element["c" /* customElement */])('v-styled-grid')], function (_initialize, _LitElement) {
  var VStyledGrid = /*#__PURE__*/function (_LitElement2) {
    _inherits(VStyledGrid, _LitElement2);

    var _super = _createSuper(VStyledGrid);

    function VStyledGrid() {
      var _this;

      _classCallCheck(this, VStyledGrid);
  ...
  return {
    ...
    d: [{
      ...
      value: function firstUpdated() {
        ...
        if (this.noBorders) {
          assignedElements.forEach(function (item) {
            item.style.borderRight = 'none';
          });
        } else {
          var item = assignedElements[assignedElements.length - 1];
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_styled_grid_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_styled_grid_templateObject());
      }
    }]
  };
