...
/******/ 	return __webpack_require__(__webpack_require__.s = "0OQI");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ var v_speech_bubble_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-speech-bubble/slottedStyles.js
/* harmony default export */ var slottedStyles = ("\n  .v-speech-bubble.v-speech-bubble h3,\n  .v-speech-bubble.v-speech-bubble h4,\n  .v-speech-bubble.v-speech-bubble h5,\n  .v-speech-bubble.v-speech-bubble h6 {\n    font-size: 18px;\n    font-weight: 600;\n    margin: 0;\n  }\n\n  .v-speech-bubble.v-speech-bubble p {\n    margin: 0;\n  }\n\n.v-speech-bubble.v-speech-bubble a {\n  color: var(--v-states__link-color);\n  text-decoration: underline;\n}\n\n.v-speech-bubble.v-speech-bubble a:hover {\n  color: var(--v-states__link-hover-color);\n}\n\n.v-speech-bubble.v-speech-bubble a:active {\n  color: var(--v-states__link-active-color);\n}\n\n.v-speech-bubble.v-speech-bubble a:visited {\n  color: var(--v-states__link-visited-color);\n}\n\n.v-speech-bubble.v-speech-bubble a:focus {\n  box-shadow: var(--v-states__focus-box-shadow-with-inset);\n  outline: none;\n}\n");
// EXTERNAL MODULE: ./node_modules/lit-html/directives/class-map.js
var class_map = __webpack_require__("4qtV");

// CONCATENATED MODULE: ./src/components/v-speech-bubble/arrow.js
function arrow_templateObject() {
  var data = arrow_taggedTemplateLiteral(["\n  <svg\n    xmlns=\"http://www.w3.org/2000/svg\"\n    width=\"25\"\n    height=\"15\"\n    viewBox=\"0 0 25 15\"\n    aria-label=\"arrow icon\"\n  >\n    <filter id=\"dropshadow\" height=\"150%\">\n      <feGaussianBlur in=\"SourceAlpha\" stdDeviation=\"3\" />\n      <feOffset dx=\"1\" dy=\"1\" result=\"offsetblur\" />\n      <feComponentTransfer>\n        <feFuncA type=\"linear\" slope=\"0.3\" />\n      </feComponentTransfer>\n      <feMerge>\n        <feMergeNode />\n        <feMergeNode in=\"SourceGraphic\" />\n      </feMerge>\n    </filter>\n    <path\n      class=\"fillable\"\n      fill=\"#FFF\"\n      d=\"M23 0L11.5 9 0 0z\"\n      style=\"filter:url(#dropshadow)\"\n    />\n  </svg>\n"]);

  arrow_templateObject = function _templateObject() {
    return data;
  };
...
function arrow_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }


/* harmony default export */ var arrow = (Object(lit_element["d" /* html */])(arrow_templateObject()));
// EXTERNAL MODULE: ./src/utils/index.js + 8 modules
var utils = __webpack_require__("7Qib");

// CONCATENATED MODULE: ./src/components/v-speech-bubble/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_speech_bubble_templateObject() {
  var data = v_speech_bubble_taggedTemplateLiteral(["\n      <div id=\"wrapper\" class=", ">\n        <slot></slot>\n        ", "\n      </div>\n    "]);

  v_speech_bubble_templateObject = function _templateObject() {
    return data;
  };
...
function v_speech_bubble_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_speech_bubble_vSpeechBubble = _decorate([Object(lit_element["c" /* customElement */])('v-speech-bubble')], function (_initialize, _LitElement) {
  var vSpeechBubble = /*#__PURE__*/function (_LitElement2) {
    _inherits(vSpeechBubble, _LitElement2);

    var _super = _createSuper(vSpeechBubble);

    function vSpeechBubble() {
      var _this;

      _classCallCheck(this, vSpeechBubble);
  ...
  return {
    ...
    d: [{
      ...
      value: function firstUpdated() {
        ...
        this.classList.add('v-speech-bubble');
        this.$assignedElements = Object(utils["j" /* getSlottedElements */])(this);
        this.$wrapper = this.shadowRoot.querySelector('#wrapper');

        if (!Object(utils["c" /* browserSupportsWidthMaxContent */])()) {
          if (this.onlyIcon) {
            this._deriveCorrectWidthForIcons();

            this.shadowRoot.querySelector('slot').style.display = 'flex';
          } else {
            this._deriveCorrectWidth();
          }
        }
      }
    }, {
      ...
      value: function disconnectedCallback() {
        if (this.parentNode && this.parentNode.removeChild === 'function') {
          this.parentNode.removeChild(this.$slotStyles);
        }

        _get(_getPrototypeOf(vSpeechBubble.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "get",
      "static": true,
      ...
      value: function styles() {
        return [v_speech_bubble_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_speech_bubble_templateObject(), this._divClasses(), arrow);
      }
    }, {
      kind: "field",
      key: "_divClasses",
      ...
      kind: "method",
      key: "_deriveCorrectWidth",
      value: function _deriveCorrectWidth() {
        // Because IE11 & Edge do not support instrinsic width values like
        // max-content, the width must be assigned programmatically if the
        // speech bubble is to expand with its content.
        var div = document.createElement('div');
        div.style.display = 'inline-block';
        div.style.whiteSpace = 'nowrap';
        this.$wrapper.appendChild(div);
        this.$assignedElements.forEach(function (el) {
          div.appendChild(el.cloneNode(true));
        });
        var width = Math.min(div.offsetWidth, 400) + 40;
        this.$wrapper.style.width = "".concat(width, "px");
        div.parentNode.removeChild(div);
      }
    }, {
      kind: "method",
      key: "_deriveCorrectWidthForIcons",
      value: function _deriveCorrectWidthForIcons() {
        // Because IE11 & Edge do not support instrinsic width values like
        // max-content, the width must be assigned programmatically if the
        // speech bubble is to expand with its content for Only Icons case.
        var wid = 52;
        wid = wid + this.widthTobeAddedForIcon * this.$assignedElements.length;
        var width = Math.min(wid, 400);
        this.$wrapper.style.width = "".concat(width, "px");
      }
    }]
  };
