...
/******/ 	return __webpack_require__(__webpack_require__.s = "vaZf");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VMobileNavigationContainer", function() { return /* binding */ v_mobile_navigation_container_VMobileNavigationContainer; });
...
// CONCATENATED MODULE: ./src/components/v-mobile-navigation-container/keyFrameStyles.js
function _templateObject() {
...
/* harmony default export */ var keyFrameStyles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-mobile-navigation-container/styles.js
...
/* harmony default export */ var v_mobile_navigation_container_styles = (Object(lit_element["b" /* css */])(styles_templateObject()));
// EXTERNAL MODULE: ./src/utils/index.js + 8 modules
var utils = __webpack_require__("7Qib");

// CONCATENATED MODULE: ./src/components/v-mobile-navigation-container/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_mobile_navigation_container_taggedTemplateLiteral(["<v-brand-stripe class=\"inActive brandStripe\"></v-brand-stripe>"]);
...
function v_mobile_navigation_container_templateObject() {
  var data = v_mobile_navigation_container_taggedTemplateLiteral(["\n      <div class=\"container\">\n        ", "\n        <v-mobile-navigation-topbar\n          logoHref=", "\n          logoSrc=", "\n        ></v-mobile-navigation-topbar>\n      </div>\n      <div><slot></slot></div>\n    "]);

  v_mobile_navigation_container_templateObject = function _templateObject() {
    return data;
  };
...
function v_mobile_navigation_container_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_mobile_navigation_container_VMobileNavigationContainer = _decorate([Object(lit_element["c" /* customElement */])('v-mobile-navigation-container')], function (_initialize, _LitElement) {
  var VMobileNavigationContainer = /*#__PURE__*/function (_LitElement2) {
    _inherits(VMobileNavigationContainer, _LitElement2);

    var _super = _createSuper(VMobileNavigationContainer);

    function VMobileNavigationContainer() {
      var _this;

      _classCallCheck(this, VMobileNavigationContainer);

      _this = _super.call(this);

      _initialize(_assertThisInitialized(_this));

      _this.getCollapseView = _this.getCollapseView.bind(_assertThisInitialized(_this));
      return _this;
    }

    return VMobileNavigationContainer;
  }(_LitElement);

  return {
    F: VMobileNavigationContainer,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_mobile_navigation_container_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        var vDDM = this.querySelector('v-drilldown-menu');
        var vMNF = this.querySelector('v-mobile-navigation-footer');
        this.$slottedItems = Object(utils["j" /* getSlottedElements */])(this);
        vDDM.classList.remove('show');
        vDDM.classList.add('hide');

        if (vMNF) {
          vMNF.classList.remove('show');
          vMNF.classList.add('hide');
        }

        this.addKeyFramesForAnimation();

        this._updateSlotForSearch();
      }
    }, {
      kind: "method",
      key: "_updateSlotForSearch",
      value: function _updateSlotForSearch() {
        var pageSlot = this.querySelector('v-drilldown-menu').querySelectorAll('v-drilldown-menu-page');

        if (pageSlot && pageSlot.length > 0 && this.disableSearch) {
          pageSlot.forEach(function (slottedItem) {
            slottedItem.setAttribute('disableSearch', true);
          });
        }
      }
    }, {
      ...
      value: function updated(changedProperties) {
        if (changedProperties.has('disableSearch')) {
          this._updateSlotForSearch();
        }
      }
    }, {
      kind: "method",
      key: "addKeyFramesForAnimation",
      value: function addKeyFramesForAnimation() {
        var style = document.createElement('style');
      ...
      kind: "method",
      key: "_addPositionToDrillDownMenu",
      value: function _addPositionToDrillDownMenu() {
        this.$slottedItems.forEach(function (slottedItem) {
          if (slottedItem && slottedItem.classList.contains('mainMenuMobile')) {
            slottedItem.style.marginTop = '95px';
          }
        });
      }
    }, {
      kind: "method",
      key: "getCollapseView",
      value: function getCollapseView() {
        var vDDM = this.querySelector('v-drilldown-menu');
        var vMNF = this.querySelector('v-mobile-navigation-footer');

        if (vDDM.classList.contains('hide')) {
          vDDM.classList.remove('hide');
          vDDM.classList.add('show');

          if (vMNF && vMNF.classList.contains('hide')) {
            vMNF.classList.remove('hide');
            vMNF.classList.add('show');
          }

          if (this.shadowRoot.querySelector('.brandStripe') && this.shadowRoot.querySelector('.brandStripe').classList) {
            this.shadowRoot.querySelector('.brandStripe').classList.remove('inActive');
          }

          if (this.issimplenav) {
            this.shadowRoot.querySelector('.container').classList.add('topbar');

            this._addPositionToDrillDownMenu();
          }
          ...
          if (this.shadowRoot.querySelector('.brandStripe') && this.shadowRoot.querySelector('.brandStripe').classList) {
            this.shadowRoot.querySelector('.brandStripe').classList.add('inActive');
          }

          if (this.issimplenav) {
            this.shadowRoot.querySelector('.container').classList.remove('topbar');
          }
      ...
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(VMobileNavigationContainer.prototype), "connectedCallback", this).call(this);

        this.addEventListener('vmobilenavigationtopbar-click', this.getCollapseView);
      }
    }, {
      kind: "method",
      key: "disconnectedCallback",
      value: function disconnectedCallback() {
        this.removeEventListener('vmobilenavigationtopbar-click', this.getCollapseView);

        _get(_getPrototypeOf(VMobileNavigationContainer.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_mobile_navigation_container_templateObject(), this.issimplenav ? Object(lit_element["d" /* html */])(_templateObject2()) : "", this.logoHref, this.logoSrc);
      }
    }]
  };
