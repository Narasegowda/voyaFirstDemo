...
/******/ 	return __webpack_require__(__webpack_require__.s = "bEuA");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vDrilldownMenu", function() { return /* binding */ v_drilldown_menu_vDrilldownMenu; });
...
// CONCATENATED MODULE: ./src/components/v-drilldown-menu/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    height: 100%;\n    width: 100%;\n    overflow: hidden;\n    position: relative;\n  }\n"]);
...
/* harmony default export */ var v_drilldown_menu_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// EXTERNAL MODULE: ./src/utils/index.js + 8 modules
var utils = __webpack_require__("7Qib");

// CONCATENATED MODULE: ./src/components/v-drilldown-menu/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function v_drilldown_menu_templateObject() {
  var data = v_drilldown_menu_taggedTemplateLiteral([" <slot></slot> "]);

  v_drilldown_menu_templateObject = function _templateObject() {
    return data;
  };
...
function v_drilldown_menu_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_drilldown_menu_vDrilldownMenu = _decorate([Object(lit_element["c" /* customElement */])('v-drilldown-menu')], function (_initialize, _LitElement) {
  var vDrilldownMenu = /*#__PURE__*/function (_LitElement2) {
    _inherits(vDrilldownMenu, _LitElement2);

    var _super = _createSuper(vDrilldownMenu);

    function vDrilldownMenu() {
      var _this;

      _classCallCheck(this, vDrilldownMenu);
  ...
  return {
    ...
    d: [{
      ...
      function styles() {
        return [commonStyles["a" /* default */], v_drilldown_menu_styles];
      }
    }, {
      kind: "method",
      key: "updated",
      value: function updated(changedProperties) {
        if (changedProperties.has('activatedPageIds')) {
          this._activatePages();

          this._dispatchNavigateEvent();
        }
      }
    }, {
      kind: "method",
      ...
      value: function firstUpdated() {
        ...
        this.$pages = Object(utils["j" /* getSlottedElements */])(this);
        setTimeout(function () {
          _this2.addEventListener('vdrilldownmenu-activatepage', _this2._handleVDrilldownMenuActivatePage);

          _this2.addEventListener('vdrilldownmenu-deactivatepage', _this2._handleVDrilldownMenuDeactivatePage);
        }, 0);
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_drilldown_menu_templateObject());
      }
    }, {
      kind: "method",
      key: "_activatePages",
      value: function _activatePages() {
        var _this3 = this;

        this.$pages.forEach(function (page) {
          var isActivated = _this3.activatedPageIds.includes(page.getAttribute('id'));

          var isShown = _this3._isLastActivatedPage(page);

          page.activated = isActivated;
          page.shown = isShown;

          if (isActivated) {
            if (_this3.activatedPageIds.length >= 1) {
              var calcheight = 163 + 63 * page.getAttribute('noofitems'); // 163 height of menu-page without any links  63 height of one menu link

              if (Object(utils["r" /* isIosMobile */])()) {
                calcheight = calcheight + 6; // 6 is extra height required for IOS
              }

              if (_this3.activatedPageIds.length === 1) calcheight = calcheight - 50; // 112 is height of main menu upper part ( search) hence deducting 50 here

              calcheight = Math.max(calcheight, 285);
              _this3.height = calcheight + 'px';
              _this3.style.height = _this3.height;
            }
          }
        });
      }
      ...
      kind: "method",
      key: "_dispatchNavigateEvent",
      value: function _dispatchNavigateEvent() {
        this.dispatchEvent(new CustomEvent('vdrilldownmenu-navigate', {
          bubbles: true,
          composed: true,
          detail: {
            activatedPageIds: this.activatedPageIds
          }
        }));
      }
    }, {
      kind: "method",
      key: "_getAncestorPageIds",
      value: function _getAncestorPageIds(page, acc) {
        if (page.level === 0) {
          return acc;
        } else {
          var parent = this._getPage(page.getAttribute('from'));

          return this._getAncestorPageIds(parent, [].concat(_toConsumableArray(acc), [parent.getAttribute('id')]));
        }
      }
    }, {
      kind: "method",
      key: "_getPage",
      value: function _getPage(id) {
        return this.$pages.filter(function (page) {
          return page.getAttribute('id') === id;
        })[0];
      }
    }, {
      kind: "method",
      key: "_handleVDrilldownMenuActivatePage",
      value: function _handleVDrilldownMenuActivatePage(e) {
        var pageId = e.detail.pageId;

        var page = this._getPage(pageId);

        var ancestorPageIds = this._getAncestorPageIds(page, []);

        var nextActivatedPageIds = [].concat(_toConsumableArray(ancestorPageIds), [pageId]);
        this.activatedPageIds = this._orderPageIdsByPageLevel(nextActivatedPageIds);
      }
    }, {
      kind: "method",
      key: "_handleVDrilldownMenuDeactivatePage",
      value: function _handleVDrilldownMenuDeactivatePage(e) {
        var pageId = e.detail.pageId;
        var nextActivatedPageIds = this.activatedPageIds.filter(function (activatedPageId) {
          return activatedPageId !== pageId;
        });
        this.activatedPageIds = this._orderPageIdsByPageLevel(nextActivatedPageIds);
      }
    }, {
      kind: "method",
      key: "_isLastActivatedPage",
      value: function _isLastActivatedPage(page) {
        page.id = this.activatedPageIds.slice(-1)[0];
      }
    }, {
      kind: "method",
      key: "_orderPageIdsByPageLevel",
      value: function _orderPageIdsByPageLevel(pageIds) {
        var _this4 = this;

        return pageIds.slice().sort(function (pageId1, pageId2) {
          var page1 = _this4.$pages.find(function (page) {
            return page.getAttribute('id') === pageId1;
          });

          var page2 = _this4.$pages.find(function (page) {
            return page.getAttribute('id') === pageId2;
          });

          return page1.level - page2.level;
        });
      }
    }]
  };
