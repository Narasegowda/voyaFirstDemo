...
/******/ 	return __webpack_require__(__webpack_require__.s = "jZak");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VNavigationIcon", function() { return /* binding */ v_navigation_icon_VNavigationIcon; });
...
// CONCATENATED MODULE: ./src/components/v-navigation-icon/styles.js
function _templateObject() {
...
/* harmony default export */ var v_navigation_icon_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-navigation-icon/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_navigation_icon_taggedTemplateLiteral(["<slot></slot>\n            <div class=\"badge\"></div> "]);
...
function v_navigation_icon_templateObject() {
  var data = v_navigation_icon_taggedTemplateLiteral(["\n      <v-icon\n        ?active=", "\n        ?hover=", "\n        ?selected=", "\n        name=", "\n        ?primary=", "\n        size=", "\n        ?applyhoverstyles=", "\n        hovercolor=", "\n        aria-hidden=\"true\"\n      ></v-icon>\n      ", "\n    "]);

  v_navigation_icon_templateObject = function _templateObject() {
    return data;
  };
...
function v_navigation_icon_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_navigation_icon_VNavigationIcon = _decorate([Object(lit_element["c" /* customElement */])('v-navigation-icon')], function (_initialize, _LitElement) {
  var VNavigationIcon = /*#__PURE__*/function (_LitElement2) {
    _inherits(VNavigationIcon, _LitElement2);

    var _super = _createSuper(VNavigationIcon);

    function VNavigationIcon() {
      var _this;

      _classCallCheck(this, VNavigationIcon);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_navigation_icon_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        if (this.withBadge && this.slt.length === 0) {
          this.shadowRoot.querySelector('.badge').style.display = 'block';
        } else if (this.withBadge) {
          this.shadowRoot.querySelector('.badge').style.display = 'none';
          var icon = this.slt.find(function (el) {
            return el.tagName === 'V-ICON';
          });

          if (this.slt && icon) {
            icon.setAttribute('size', '18px');
            icon.classList.add('badgeIcon');
          }
        }
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_navigation_icon_templateObject(), this.active, this.hover, this.selected, this.iconName, this.primary, this.size, this.applyHoverStyles, this.hoverColor, this.withBadge ? Object(lit_element["d" /* html */])(_templateObject2()) : undefined);
      }
    }]
  };
