...
/******/ 	return __webpack_require__(__webpack_require__.s = "KkKu");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VFooter", function() { return /* binding */ v_footer_VFooter; });
...
// CONCATENATED MODULE: ./src/components/v-footer/slottedStyles.js
...
// CONCATENATED MODULE: ./src/components/v-footer/styles.js
...
/* harmony default export */ var v_footer_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-footer/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject34() {
  var data = v_footer_taggedTemplateLiteral([" <v-dropdown-item\n                text=\"", "\"\n                value=\"", "\"\n              ></v-dropdown-item>"]);
...
function _templateObject32() {
  var data = v_footer_taggedTemplateLiteral(["<v-footer-nav-item class=\"languageSelectorPosition OneLinkNoTx\">\n      <v-desktop-navbar-item\n        id=\"selector\"\n        text=\"", "\"\n        class=\"v-desktop-navbar-item\"\n        fontSize=\"16px\"\n        openUp\n      >\n        <v-navigation-icon\n          iconname=\"globeamericas\"\n          slot=\"icon\"\n          size=\"17px\"\n        ></v-navigation-icon>\n        ", "\n      </v-desktop-navbar-item>\n    </v-footer-nav-item>"]);
...
function _templateObject31() {
  var data = v_footer_taggedTemplateLiteral(["<v-icon\n              class=\"external\"\n              name=\"externalLink\"\n              color=\"", "\"\n              size=\"15px\"\n            ></v-icon> "]);
...
function _templateObject30() {
  var data = v_footer_taggedTemplateLiteral(["<li class=\"v-menu-link-mobile\">\n      <a\n        aria-label=\"", "\"\n        href=\"", "\"\n        target=", "\n        >", "", "</a\n      >\n    </li>"]);
...
function _templateObject28() {
  var data = v_footer_taggedTemplateLiteral(["<ul class=\"v-menu-links-list-mobile\" slot=\"nav-items-", "\">\n      <li class=\"v-menu-link-mobile\">\n        <a\n          aria-label=\"", "\"\n          href=\"", "\"\n          target=", "\n          >", "", "</a\n        >\n      </li>\n    </ul>"]);
...
function _templateObject27() {
  var data = v_footer_taggedTemplateLiteral(["", ""]);
...
function _templateObject26() {
  var data = v_footer_taggedTemplateLiteral(["<ul\n        class=\"v-menu-links-list-mobile\"\n        slot=\"nav-items-", "\"\n      >\n        ", "\n      </ul>"]);
...
function _templateObject23() {
  var data = v_footer_taggedTemplateLiteral(["<li class=\"v-menu-link\">\n      <a\n        aria-label=\"", "\"\n        href=\"", "\"\n        target=", "\n        >", "", "\n    </li>"]);
...
function _templateObject21() {
  var data = v_footer_taggedTemplateLiteral(["<ul class=\"v-menu-links-list\" slot=\"nav-items-", "\">\n      <li class=\"v-menu-link\"><a>", "</a></li>\n      ", "\n    </ul>"]);
...
function _templateObject20() {
  var data = v_footer_taggedTemplateLiteral(["<v-footer-nav-item\n      linkname=", "\n      aria-label=\"", "\"\n      linkref=", "\n      target=", "\n      >", "</v-footer-nav-item\n    >"]);
...
function _templateObject16() {
  var data = v_footer_taggedTemplateLiteral(["<div class=\"single-column\">\n                ", "\n                <v-footer-nav-item>\n                  ", "\n                </v-footer-nav-item>\n              </div>"]);
...
function _templateObject5() {
  var data = v_footer_taggedTemplateLiteral(["<v-logo\n        class=\"logo\"\n        alt=", "\n        src=", "\n        logohref=", "\n        aria-label=", "\n      ></v-logo>"]);
...
function _templateObject2() {
  var data = v_footer_taggedTemplateLiteral(["\n          <v-icon linkButton primary name=\"expand\" size=\"25px\" color=\"white\"\n            >View Disclaimer</v-icon\n          >\n        "]);
...
function v_footer_templateObject() {
  var data = v_footer_taggedTemplateLiteral(["\n          <v-icon\n            color=\"--v-colors__secondary\"\n            linkButton\n            primary\n            name=\"collapse\"\n            size=\"25px\"\n            color=\"white\"\n            >Hide Disclaimer</v-icon\n          >\n        "]);

  v_footer_templateObject = function _templateObject() {
    return data;
  };
...
function v_footer_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_footer_VFooter = _decorate([Object(lit_element["c" /* customElement */])('v-footer')], function (_initialize, _LitElement) {
  var VFooter = /*#__PURE__*/function (_LitElement2) {
    _inherits(VFooter, _LitElement2);

    var _super = _createSuper(VFooter);

    function VFooter() {
      var _this;

      _classCallCheck(this, VFooter);
  ...
  return {
    ...
    d: [{
      ...
      key: "externalIconColor",
      value: function value() {
        return '--v-colors__primary';
      }
    }, {
      kind: "get",
      "static": true,
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_footer_styles];
      }
    }, {
      kind: "method",
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(VFooter.prototype), "connectedCallback", this).call(this);
      ...
      value: function disconnectedCallback() {
        ...
        _get(_getPrototypeOf(VFooter.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "get",
      "static": true,
      ...
      key: "render",
      value: function render() {
        //Update the copyRightYear.
        this.copyRightText = this.copyRightText && this.setCopyRightYear(this.copyRightText);
      ...
      value: function firstUpdated() {
        var _this$config, _this$config$mobileNa, _this$config2, _this$config3, _this$config3$navItem, _this$config4;

        var slot = this.shadowRoot.querySelector('slot[name="v-disc-text"]');

        if (this.config && !this.config.disclaimerText || !this.config && slot.assignedNodes().length === 0) {
          this.shadowRoot.querySelector('.v-toggle-button').style.display = 'none';
        }
        ...
        if (!this.open) {
          var content = this.shadowRoot.querySelector('.expandable-content');
          content.style.height = '0px';
        }

        var assignedElementsBySlot = Object(utils["k" /* getSlottedElementsBySlotName */])(this);
        var disclaimerText = this.config && (this.config.disclaimerText && this.config.disclaimerText === '' || !this.config.disclaimerText);

        if (disclaimerText || !this.config && assignedElementsBySlot['v-disc-text'].length === 0) {
          this.shadowRoot.querySelector('.expandable-content').style.display = 'none';
        }

        var nav_items = false;

        for (var index = 1; index <= 6; index++) {
          var slotName = 'nav-items-' + index;

          if (!this.config && assignedElementsBySlot[slotName].length > 0) {
            nav_items = true;
          }
        }

        var navItems = this.config && (this.config.navItems && this.config.navItems.length <= 0 || !this.config.navItems);

        if (navItems || !this.config && !nav_items) {
          this.shadowRoot.querySelector('#menu_list').style.display = 'none';
        }

        var mobileNavItems = ((_this$config = this.config) === null || _this$config === void 0 ? void 0 : (_this$config$mobileNa = _this$config.mobileNavItems) === null || _this$config$mobileNa === void 0 ? void 0 : _this$config$mobileNa.length) <= 0 || !((_this$config2 = this.config) === null || _this$config2 === void 0 ? void 0 : _this$config2.mobileNavItems);
        var navItemsLength = ((_this$config3 = this.config) === null || _this$config3 === void 0 ? void 0 : (_this$config3$navItem = _this$config3.navItems) === null || _this$config3$navItem === void 0 ? void 0 : _this$config3$navItem.length) <= 0 || !((_this$config4 = this.config) === null || _this$config4 === void 0 ? void 0 : _this$config4.navItems);

        if (this.config && mobileNavItems && navItemsLength) {
          this.shadowRoot.querySelector('#menu_list_mobile').style.display = 'none';
        }

        var iconLinks = this.config && (this.config.iconLinks && this.config.iconLinks.length <= 0 || !this.config.iconLinks);

        if (iconLinks || !this.config && assignedElementsBySlot['nav-items'].length === 0) {
          this.shadowRoot.querySelector('.navList').style.display = 'none';
        }
      ...
      kind: "method",
      key: "_applyResponsiveness",
      value: function _applyResponsiveness() {
        var slotNavItems = this.shadowRoot.querySelector('slot[name="nav-items"]');

        if (Object(utils["p" /* isIE */])()) {
          this.shadowRoot.querySelector('#menu_list').classList.add('menu-list-IE');
          this.shadowRoot.querySelector('#menu_list').classList.remove('menu-list');
        }

        if (!this.config && slotNavItems.assignedNodes().length > 9 || this.config && this.config.iconLinks.length >= 9) {
          if (!this.config && slotNavItems.assignedNodes().length > 9) {
            for (var index = slotNavItems.assignedNodes().length - 1; index > slotNavItems.assignedNodes().length - 4; index--) {
              slotNavItems.assignedNodes()[index].style.marginRight = '0px';
            }
          }

          this.shadowRoot.querySelector('.logo-info').classList.add('logoInfo-flex-column');
          this.shadowRoot.querySelector('.copy-right-text').classList.add('copy-right-text-res');
          this.shadowRoot.querySelector('.logo-info').classList.add('logo-info-res');
          this.shadowRoot.querySelector('.copy-right-text').classList.add('copy-right-text-res');

          if (Object(utils["p" /* isIE */])()) {
            this.shadowRoot.querySelector('.logo-info').classList.add('logo-info-IE');
            this.shadowRoot.querySelector('.logo').classList.add('logo-IE');
            this.shadowRoot.querySelector('.copy-right-text').classList.add('copy-right-text-IE');
          }
        }
      }
    }, {
      ...
      kind: "method",
      key: "setCopyRightYear",
      value: function setCopyRightYear(text) {
        var _text$replace;

        var date = new Date();
        var currentYear = date === null || date === void 0 ? void 0 : date.getFullYear();
        var getYear = Number(text === null || text === void 0 ? void 0 : (_text$replace = text.replace(/<[^>]*>?/gm, '')) === null || _text$replace === void 0 ? void 0 : _text$replace.slice(1, 5)); //Slicing the year after the copy right symbol.

        if (text === null || text === void 0 ? void 0 : text.match('{currentYear}')) {
          //If consuming apps pass {currentYear} placeholder in the copyRightText string then
          //it will be replaced with current year.
          return text === null || text === void 0 ? void 0 : text.replace('{currentYear}', currentYear);
        } else if (!Number.isNaN(getYear)) {
          return text.replace(getYear, currentYear);
        } else {
          return text;
        }
      }
      ...
      value: function value() {
        ...
        return function () {
          var element = _this2.shadowRoot.querySelector('.expandable-content');
      ...
      value: function value() {
        ...
        return function () {
          var element = _this3.shadowRoot.querySelector('.expandable-content');

          var sectionHeight = element.scrollHeight;
          element.style.height = sectionHeight + 'px';

          var removeHeight = function removeHeight() {
            element.removeEventListener('transitionend', removeHeight);
      ...
      value: function value() {
        ...
        return function () {
          return _this4.open ? Object(lit_element["d" /* html */])(v_footer_templateObject()) : Object(lit_element["d" /* html */])(_templateObject2());
        };
      }
    }, {
      kind: "method",
      ...
      value: function _standardTemplate() {
        return Object(lit_element["d" /* html */])(_templateObject3(), this.toggle, this.compactSize ? 'compact' : '', this.tabIndex, this._toggleIcon(), this.open ? 'open' : '', this._getLogo(), Object(unsafe_html["a" /* unsafeHTML */])(this.copyRightText));
      }
    }, {
      kind: "method",
      key: "_getLogo",
      value: function _getLogo() {
        if (this.nologo) {
          return Object(lit_element["d" /* html */])(_templateObject4());
        } else {
          return Object(lit_element["d" /* html */])(_templateObject5(), this.alt, this.logoSrc, this.logohref, this.target === '_blank' ? 'opens ' + this.alt + ' new window' : 'redirects to ' + this.alt);
        }
      }
    }, {
      kind: "method",
      ...
      value: function _configTemplate() {
        var _this5 = this,
            _this$config5,
            _this$config5$mobileN;

        return Object(lit_element["d" /* html */])(_templateObject6(), this.toggle, this.compactSize ? 'compact' : '', this.tabIndex, this._toggleIcon(), this.open ? 'open' : '', Object(unsafe_html["a" /* unsafeHTML */])(this.config.disclaimerText || ''), this.config.navItems.map(function (item, index) {
          return Object(lit_element["d" /* html */])(_templateObject7(), _this5.getNavItem(item, index + 1));
        }), ((_this$config5 = this.config) === null || _this$config5 === void 0 ? void 0 : (_this$config5$mobileN = _this$config5.mobileNavItems) === null || _this$config5$mobileN === void 0 ? void 0 : _this$config5$mobileN.length) > 0 ? Object(lit_element["d" /* html */])(_templateObject8(), this.config.mobileNavItems.map(function (item, index) {
          return Object(lit_element["d" /* html */])(_templateObject9(), _this5.getMobileNavItem(item, index + 1));
        })) : this.config.navItems && this.config.navItems.length > 0 ? Object(lit_element["d" /* html */])(_templateObject10(), this.config.navItems.map(function (item, index) {
          return Object(lit_element["d" /* html */])(_templateObject11(), _this5.getMobileNavItemFromNav(item, index + 1));
        })) : Object(lit_element["d" /* html */])(_templateObject12()), this._getLogo(), Object(unsafe_html["a" /* unsafeHTML */])(this.copyRightText), this.config.iconLinks.length > 3 ? Object(lit_element["d" /* html */])(_templateObject13(), this.config.iconLinks.map(function (iconLink) {
          return Object(lit_element["d" /* html */])(_templateObject14(), iconLink.languages ? _this5.getMultilingualSelector(iconLink) : _this5.getIconLink(iconLink));
        }), this.config.icons.map(function (icon) {
          return Object(lit_element["d" /* html */])(_templateObject15(), _this5.getIcon(icon));
        })) : Object(lit_element["d" /* html */])(_templateObject16(), this.config.iconLinks.map(function (iconLink) {
          return Object(lit_element["d" /* html */])(_templateObject17(), iconLink.languages ? _this5.getMultilingualSelector(iconLink) : _this5.getIconLink(iconLink));
        }), this.config.icons.map(function (icon) {
          return Object(lit_element["d" /* html */])(_templateObject18(), _this5.getIcon(icon));
        })));
      }
    }, {
      kind: "method",
      ...
      value: function getIcon(icon) {
        return Object(lit_element["d" /* html */])(_templateObject19(), 'opens ' + icon.iconname + ' in new tab', icon.iconname, icon.href, icon.iconsize ? icon.iconsize : this.iconSize);
      }
    }, {
      kind: "method",
      key: "getIconLink",
      value: function getIconLink(iconLink) {
        return Object(lit_element["d" /* html */])(_templateObject20(), iconLink.iconName, iconLink.target ? 'opens ' + iconLink.linkLabel + ' in new tab' : iconLink.linkLabel ? iconLink.linkLabel : '', iconLink.linkURL, iconLink.target ? iconLink.target : '_self', iconLink.linkLabel);
      }
    }, {
      kind: "method",
      key: "getNavItem",
      value: function getNavItem(item, index) {
        var _this6 = this;

        return Object(lit_element["d" /* html */])(_templateObject21(), index, item.title, item.links.map(function (link) {
          return Object(lit_element["d" /* html */])(_templateObject22(), _this6.getMenuLink(link, item));
        }));
      }
    }, {
      kind: "method",
      key: "getMenuLink",
      value: function getMenuLink(link, item) {
        return Object(lit_element["d" /* html */])(_templateObject23(), link.target ? 'opens ' + item.title + ' ' + link.name + ' in new tab' : item.title + ' ' + link.name, link.href, link.target ? link.target : '_self', link.name, link.target === '_blank' ? Object(lit_element["d" /* html */])(_templateObject24(), this.externalIconColor) : '');
      }
    }, {
      kind: "method",
      key: "getAriaLabel",
      value: function getAriaLabel(linkName) {
        return linkName ? 'footer-' + linkName.replace(/\s+/g, '-') : linkName;
      }
    }, {
      kind: "method",
      key: "getMobileNavItemFromNav",
      value: function getMobileNavItemFromNav(item, index) {
        var _this7 = this;

        if (item.href && item.href !== '') {
          return Object(lit_element["d" /* html */])(_templateObject25(), index, 'redirects to ' + item.title, item.href, item.target ? item.target : '_self', item.title);
        } else {
          return Object(lit_element["d" /* html */])(_templateObject26(), index, item.links.map(function (link) {
            return Object(lit_element["d" /* html */])(_templateObject27(), _this7.getMobileMenuLink(link));
          }));
        }
      }
    }, {
      kind: "method",
      key: "getMobileNavItem",
      value: function getMobileNavItem(item, index) {
        return Object(lit_element["d" /* html */])(_templateObject28(), index, 'redirects to ' + item.title, item.href, item.target ? item.target : '_self', item.title, item.target === '_blank' ? Object(lit_element["d" /* html */])(_templateObject29(), this.externalIconColor) : '');
      }
    }, {
      kind: "method",
      key: "getMobileMenuLink",
      value: function getMobileMenuLink(link) {
        return Object(lit_element["d" /* html */])(_templateObject30(), 'redirects to ' + link.name, link.href, link.target ? link.target : '_self', link.name, link.target === '_blank' ? Object(lit_element["d" /* html */])(_templateObject31(), this.externalIconColor) : '');
      }
    }, {
      kind: "method",
      key: "getMultilingualSelector",
      value: function getMultilingualSelector(iconLink) {
        return Object(lit_element["d" /* html */])(_templateObject32(), iconLink.linkLabel, iconLink.languages.map(function (language) {
          return iconLink.linkLabel === language ? Object(lit_element["d" /* html */])(_templateObject33(), language, language) : Object(lit_element["d" /* html */])(_templateObject34(), language, language);
        }));
      }
    }]
  };
