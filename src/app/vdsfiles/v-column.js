...
/******/ 	return __webpack_require__(__webpack_require__.s = "be2x");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VColumn", function() { return /* binding */ v_column_VColumn; });
...
// CONCATENATED MODULE: ./src/components/v-column/slottedStyles.js
/* harmony default export */ var slottedStyles = ("\n  .v-column-item {\n    flex-grow: 1;    \n    word-break: break-word;\n  }\n  .separator {\n    border-right: 1px solid  #d9d9d9;\n    border-right: 1px solid var(--v-colors__gray-medium-2);\n    padding-top:16px;\n    padding-bottom:16px;    \n  }\n .columnHeaders {\n    font-weight: 600;\n    padding-bottom: 30px;\n    font-size: 20px;\n  }\n  .columnHeadersNoBorder{   \n    padding-top:16px;\n    padding-bottom:16px;\n  }\n  .v-middle-column{\n    padding-right: 40px;\n    padding-left: 50px;    \n    width:452px;    \n  }\n\n  .columnSubHeaders {\n    padding-bottom: 30px;\n    font-size: 18px;\n  }\n\n  .v-last-column {    \n    border-right: none;    \n    padding-left: 40px; \n    padding-top:16px;\n    padding-bottom:16px;     \n    width:453px;\n  }\n\n  .v-first-column {\n    padding-left: 0;\n    padding-right: 50px;    \n    width:452px;\n  }\n\n  .v-icons-flex {\n    display: flex;\n    flex:1;\n    justify-content: flex-start;\n  } \n  .v-icon-flex {\n    margin-right: 5px;\n  }\n\n  .noBorder {\n    border-right: none;\n  }\n\n  @media screen and (max-width: 767px) {\n    .v-column-item {\n      flex-grow: 1;\n      border-right: 0;\n      padding: 40px 20px 40px 20px;\n      width: auto;\n    }\n    .v-icons-flex {\n      justify-content: center;\n    } \n\t.separator{\n    border-bottom: 1px solid  #d9d9d9;\n    border-bottom: 1px solid var(--v-colors__gray-medium-2);\n\t}\n    .columnHeaders {\n      font-weight: 600;\n      padding-bottom: 30px;\n    }\n  \n    .columnSubHeaders {\n      padding-bottom: 30px;\n    }\n  \n    .v-last-column {    \n      border-right: none;\n      border-bottom: none;\n    }\n  \n    .v-first-column {\n      padding-top: 40px;      \n    }\n\n    v-button {      \n      display: flex;\n      justify-content: center;\n      align-items: center;\n    } \n  }\n");
// CONCATENATED MODULE: ./src/components/v-column/slottedStylesIE.js
/* harmony default export */ var slottedStylesIE = ("\n  .v-column-item {\n    flex-grow: 1;    \n    word-break: break-word;\n  }\n  .separator {\n    border-right: 1px solid  #d9d9d9;\n    border-right: 1px solid var(--v-colors__gray-medium-2);\n\t border-bottom:0;\n    padding-top:16px;\n    padding-bottom:16px;    \n  }\n .columnHeaders {\n    font-weight: 600;\n    padding-bottom: 30px;\n    font-size: 20px;\n  }\n  .columnHeadersNoBorder{   \n    padding-top:16px;\n    padding-bottom:16px;\n  }\n  .v-middle-column{\n    padding-right: 40px;\n    padding-left: 50px;    \n    width:452px;    \n  }\n\n  .columnSubHeaders {\n    padding-bottom: 30px;\n    font-size: 18px;\n  }\n\n  .v-last-column {    \n    border-right: none;    \n    padding-left: 40px; \n    padding-top:16px;\n    padding-bottom:16px;     \n    width:453px;\n  }\n\n  .v-first-column {\n    padding-left: 0;\n    padding-right: 50px;    \n    width:452px;\n  }\n\n  .v-icons-flex {\n    display: flex;\n    flex-flow: row wrap;\n    justify-content: flex-start;\n    flex: 0 1 100%;\n  }\n  \n  .noBorder {\n    border-right: none;\n  }\n  v-button {      \n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n");
// CONCATENATED MODULE: ./src/components/v-column/styles.js
function _templateObject() {
...
/* harmony default export */ var v_column_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-column/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_column_templateObject() {
  var data = v_column_taggedTemplateLiteral(["\n      <div class=\"flex\">\n        <slot name=\"columns\"></slot>\n      </div>\n    "]);

  v_column_templateObject = function _templateObject() {
    return data;
  };
...
function v_column_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_column_VColumn = _decorate([Object(lit_element["c" /* customElement */])('v-column')], function (_initialize, _LitElement) {
  var VColumn = /*#__PURE__*/function (_LitElement2) {
    _inherits(VColumn, _LitElement2);

    var _super = _createSuper(VColumn);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_column_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_column_templateObject());
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        this._createSlottedStyles();

        this.$slottedItems = Object(utils["j" /* getSlottedElements */])(this);

        if (!Object(utils["s" /* isMobile */])()) {
          this._addWidthtoItems();
        }

        if (!this.noColumnSeparator) {
          this._addBordersToItems();
        }

        if (this.noColumnSeparator) {
          this._noBordersToItems();
        }

        if (Object(utils["p" /* isIE */])()) {
          this.$slottedItems.forEach(function (slottedItem) {
            var icons = slottedItem.getElementsByTagName('v-icon');

            for (var index = 0; index < icons.length; index++) {
              icons[index].style.width = '40px';
            }
          });
        }
      }
      ...
      kind: "method",
      key: "_addBordersToItems",
      value: function _addBordersToItems() {
        this.$slottedItems.forEach(function (slottedItem) {
          if (!slottedItem.classList.contains('v-last-column')) {
            slottedItem.classList.add('separator');
          }

          if (!slottedItem.classList.contains('v-last-column') && !slottedItem.classList.contains('v-first-column')) {
            slottedItem.classList.add('v-middle-column');
          }
        });
      }
    }, {
      kind: "method",
      key: "_noBordersToItems",
      value: function _noBordersToItems() {
        this.$slottedItems.forEach(function (slottedItem) {
          slottedItem.classList.add('columnHeadersNoBorder');
      ...
      kind: "method",
      key: "_addWidthtoItems",
      value: function _addWidthtoItems() {
        var numberOfItems = this.$slottedItems.length;

        if (numberOfItems === 2) {
          this.$slottedItems.forEach(function (slottedItem) {
            if (slottedItem.classList.contains('v-middle-column')) {
              slottedItem.style.width = 450 + 'px';
            } else {
              slottedItem.style.width = 449 + 'px';
            }
          });
        }
      }
      ...
      kind: "method",
      key: "_createSlottedStyles",
      value: function _createSlottedStyles() {
        this.$slotStyles = document.createElement('style');
        var browserStyles = Object(utils["b" /* browserSupportsCssVariables */])() ? slottedStyles : Object(utils["w" /* replaceCssVars */])({
          context: this,
          styles: slottedStylesIE
        });
        this.$slotStyles.innerHTML = browserStyles;
        this.parentNode.appendChild(this.$slotStyles);
      }
    }]
  };
