...
/******/ 	return __webpack_require__(__webpack_require__.s = "zBY2");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VBreadcrumb", function() { return /* binding */ v_breadcrumb_VBreadcrumb; });
...
// CONCATENATED MODULE: ./src/components/v-breadcrumb/styles.js
function _templateObject() {
...
/* harmony default export */ var v_breadcrumb_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-breadcrumb/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject2() {
  var data = v_breadcrumb_taggedTemplateLiteral([" <span> ", " </span> "]);
...
function v_breadcrumb_templateObject() {
  var data = v_breadcrumb_taggedTemplateLiteral(["\n      <a href=", "> ", " </a>\n      <v-icon\n        color=\"--v-colors__secondary\"\n        height=\"12px\"\n        name=\"chevronright\"\n        width=\"7px\"\n      ></v-icon>\n    "]);

  v_breadcrumb_templateObject = function _templateObject() {
    return data;
  };
...
function v_breadcrumb_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_breadcrumb_VBreadcrumb = _decorate([Object(lit_element["c" /* customElement */])('v-breadcrumb')], function (_initialize, _LitElement) {
  var VBreadcrumb = /*#__PURE__*/function (_LitElement2) {
    _inherits(VBreadcrumb, _LitElement2);

    var _super = _createSuper(VBreadcrumb);

    function VBreadcrumb() {
      var _this;

      _classCallCheck(this, VBreadcrumb);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_breadcrumb_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return this.last ? this._spanTemplate() : this._anchorTemplate();
      }
    }, {
      kind: "method",
      key: "_anchorTemplate",
      value: function _anchorTemplate() {
        return Object(lit_element["d" /* html */])(v_breadcrumb_templateObject(), this.href, this._displayText());
      }
    }, {
      kind: "method",
      key: "_displayText",
      value: function _displayText() {
        return this.text.length > this.charLimit ? this.text.slice(0, this.charLimit).trim() + '...' : this.text;
      }
    }, {
      kind: "method",
      key: "_spanTemplate",
      value: function _spanTemplate() {
        return Object(lit_element["d" /* html */])(_templateObject2(), this._displayText());
      }
    }]
  };
