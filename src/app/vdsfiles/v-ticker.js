...
/******/ 	return __webpack_require__(__webpack_require__.s = "s6ol");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "vTicker", function() { return /* binding */ v_ticker_vTicker; });
...
// CONCATENATED MODULE: ./src/components/v-ticker/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    display: inline-block;\n  }\n\n  span {\n    font-family: var(--v-fonts__primary);\n  }\n\n  #price {\n    font-size: 48px;\n    padding-right: 30px;\n    color: var(--v-colors__black);\n  }\n\n  .down::before {\n    content: '\\2193';\n    margin-right: 10px;\n    position: relative;\n    bottom: 6px;\n  }\n\n  .down {\n    color: var(--v-ticker__negative-color);\n  }\n\n  .up::before {\n    content: '\\2191';\n    margin-right: 10px;\n    position: relative;\n    bottom: 6px;\n  }\n\n  .up {\n    color: var(--v-ticker__positive-color);\n  }\n\n  #change::after {\n    content: '%';\n  }\n\n  #change {\n    font-size: var(--v-fonts__l);\n  }\n"], ["\n  :host {\n    display: inline-block;\n  }\n\n  span {\n    font-family: var(--v-fonts__primary);\n  }\n\n  #price {\n    font-size: 48px;\n    padding-right: 30px;\n    color: var(--v-colors__black);\n  }\n\n  .down::before {\n    content: '\\\\2193';\n    margin-right: 10px;\n    position: relative;\n    bottom: 6px;\n  }\n\n  .down {\n    color: var(--v-ticker__negative-color);\n  }\n\n  .up::before {\n    content: '\\\\2191';\n    margin-right: 10px;\n    position: relative;\n    bottom: 6px;\n  }\n\n  .up {\n    color: var(--v-ticker__positive-color);\n  }\n\n  #change::after {\n    content: '%';\n  }\n\n  #change {\n    font-size: var(--v-fonts__l);\n  }\n"]);
...
/* harmony default export */ var v_ticker_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-ticker/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_ticker_templateObject() {
  var data = v_ticker_taggedTemplateLiteral(["\n      <span id=\"price\"></span>\n      <span id=\"change\"></span>\n    "]);

  v_ticker_templateObject = function _templateObject() {
    return data;
  };
...
function v_ticker_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_ticker_vTicker = _decorate([Object(lit_element["c" /* customElement */])('v-ticker')], function (_initialize, _LitElement) {
  var vTicker = /*#__PURE__*/function (_LitElement2) {
    _inherits(vTicker, _LitElement2);

    var _super = _createSuper(vTicker);

    function vTicker() {
      var _this;

      _classCallCheck(this, vTicker);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_ticker_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_ticker_templateObject());
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        var price = this.shadowRoot.getElementById('price');
        var change = this.shadowRoot.getElementById('change');
        request.price = price;
        request.change = change;
        request.open('GET', 'https://voya.q4web.com/feed/StockQuote.svc/GetStockQuoteList?apiKey=464A9133499340FFBB763C88E22E157F&symbol=VOYA&exchange=NYSE&_=1561994091866');
        request.addEventListener('load', function () {
          var data = JSON.parse(this.responseText);
          var currPrice = data['GetStockQuoteListResult'][0].TradePrice;
          var currChange = data['GetStockQuoteListResult'][0].PercChange;
          this.price.innerHTML = new Intl.NumberFormat('en-US', {
            style: 'currency',
            currency: 'USD'
          }).format(currPrice);
          this.change.innerHTML = new Intl.NumberFormat('en-US', {
            style: 'decimal',
