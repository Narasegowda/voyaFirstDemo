...
/******/ 	return __webpack_require__(__webpack_require__.s = "nS1c");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VDropdownItem", function() { return /* binding */ v_dropdown_item_VDropdownItem; });
...
/* harmony default export */ var v_dropdown_item_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-dropdown-item/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject3() {
  var data = v_dropdown_item_taggedTemplateLiteral(["<div\n          class=", "\n          value=", "\n          @click=", "\n          @keyup=", "\n          aria-hidden=\"false\"\n          aria-label=", "\n          role=\"menuitem\"\n          @focus=", "\n          @focusout=", "\n          tabindex=\"0\"\n        >\n          ", "\n        </div>"]);
...
function _templateObject2() {
  var data = v_dropdown_item_taggedTemplateLiteral(["\n          <a\n            @mouseover=", "\n            @mouseout=", "\n            @focus=", "\n            @focusout=", "\n            class=", "\n            href=", "\n            aria-label=\"", "\"\n          >\n            ", "\n            <slot></slot>\n          </a>\n        "]);
...
function v_dropdown_item_templateObject() {
  var data = v_dropdown_item_taggedTemplateLiteral(["", ""]);

  v_dropdown_item_templateObject = function _templateObject() {
    return data;
  };
...
function v_dropdown_item_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_dropdown_item_VDropdownItem = _decorate([Object(lit_element["c" /* customElement */])('v-dropdown-item')], function (_initialize, _LitElement) {
  var VDropdownItem = /*#__PURE__*/function (_LitElement2) {
    _inherits(VDropdownItem, _LitElement2);

    var _super = _createSuper(VDropdownItem);

    function VDropdownItem() {
      var _this;

      _classCallCheck(this, VDropdownItem);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_dropdown_item_styles];
      }
    }, {
      kind: "method",
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(VDropdownItem.prototype), "connectedCallback", this).call(this);
      ...
      value: function applyHover() {
        if (this.icon) {
          this.icon.setAttribute('hover', true);
        }
      }
    }, {
      kind: "method",
      ...
      value: function removeHover() {
        if (this.icon) {
          this.icon.removeAttribute('hover');
        }
      }
    }, {
      kind: "method",
      ...
      value: function _applyFocus() {
        ...
        if (this.desktop) {
          ...
          if (!this.link) {
            anchor = this.shadowRoot.querySelector('option');
          }

          if (anchor) {
            anchor.classList.add('focusedDiv');
          }
        } else {
          var _anchor = this.shadowRoot.querySelector('.divOption');

          _anchor.classList.add('focusedDiv');
        }
      }
    }, {
      kind: "method",
      ...
      value: function _removeFocus() {
        ...
        if (this.desktop) {
          ...
          if (anchor) {
            anchor.classList.remove('focusedDiv');
          }
        } else {
          var _anchor2 = this.shadowRoot.querySelector('.divOption');

          _anchor2.classList.remove('focusedDiv');
        }
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_dropdown_item_templateObject(), this.link ? Object(lit_element["d" /* html */])(_templateObject2(), this.applyHover, this.removeHover, this._applyFocus, this._removeFocus, Object(class_map["a" /* classMap */])({
          selected: this.selected,
          noTextTransform: this.noTextTransform
        }), this.link, this.ariaLabel ? 'redirects to ' + this.ariaLabel : 'redirects to ' + this.link, Object(unsafe_html["a" /* unsafeHTML */])(this.text)) : Object(lit_element["d" /* html */])(_templateObject3(), Object(class_map["a" /* classMap */])({
          selected: this.selected,
          noTextTransform: this.noTextTransform,
          divOption: true
        }), this.value, this._handleClick, this._handleKeyup, this.ariaLabel, this._applyFocus, this._removeFocus, Object(unsafe_html["a" /* unsafeHTML */])(this.text)));
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        if (this.desktop) {
          ...
          if (anchor) {
            anchor.classList.add('aDesktop');
          }
        }

        var slot = this.shadowRoot.querySelector('slot');
        var icon = slot ? slot.assignedNodes().find(function (el) {
          return el.tagName === 'V-ICON';
        }) : undefined;
      ...
      value: function _handleClick() {
        this.dispatchEvent(new CustomEvent('vdropdownitem-select', {
          bubbles: true,
          composed: true,
          detail: {
            value: this.value,
