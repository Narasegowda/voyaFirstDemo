...
/******/ 	return __webpack_require__(__webpack_require__.s = "H5aT");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VDollarPercentInput", function() { return /* binding */ v_dollar_percent_input_VDollarPercentInput; });

// EXTERNAL MODULE: ./node_modules/lit-element/lit-element.js + 5 modules
var lit_element = __webpack_require__("CQbg");

// CONCATENATED MODULE: ./src/components/v-dollar-percent-input/styles.js
function _templateObject() {
  var data = _taggedTemplateLiteral(["\n  :host {\n    display: inline-block;\n  }\n\n  .wrapper {\n    align-items: center;\n    display: inline-flex;\n    height: 100%;\n    justify-content: flex-start;\n  }\n\n  input[type='text'],\n  .dollar,\n  .percent,\n  #width-measure {\n    background-color: transparent;\n    font-family: var(--v-fonts__primary);\n    font-size: 40px;\n    font-weight: 600;\n  }\n\n  input[type='text'],\n  .dollar,\n  .percent {\n    border-bottom: solid 3px var(--v-colors__black);\n    color: var(--v-colors__black);\n  }\n\n  input[type='text'] {\n    border-left: none;\n    border-right: none;\n    border-top: none;\n    margin: 0;\n    min-width: 1ch;\n    padding: 0;\n  }\n\n  input[type='text']::-ms-clear {\n    display: none;\n  }\n\n  input[type='text']:focus {\n    border-color: var(--v-states__form-field_active-border-color);\n    outline: none;\n  }\n\n  .percent.focus,\n  .dollar.focus {\n    border-color: var(--v-states__form-field_active-border-color);\n  }\n\n  input[type='text'][error],\n  .percent.error,\n  .dollar.error {\n    border-color: var(--v-states__error-color);\n    color: var(--v-states__error-color);\n  }\n\n  input[type='text'][disabled],\n  .percent.disabled,\n  .dollar.disabled {\n    background-color: transparent;\n    border-color: var(--v-states__disabled-color);\n    color: var(--v-states__disabled-color);\n    -webkit-text-fill-color: var(--v-states__disabled-color);\n    cursor: not-allowed;\n    user-select: none;\n  }\n\n  #width-measure {\n    color: transparent;\n    position: absolute;\n    user-select: none;\n    z-index: -1;\n  }\n"]);
...
/* harmony default export */ var v_dollar_percent_input_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-dollar-percent-input/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject3() {
  var data = v_dollar_percent_input_taggedTemplateLiteral(["\n          <span\n            class=", "\n            >%</span\n          >\n        "]);
...
function v_dollar_percent_input_templateObject() {
  var data = v_dollar_percent_input_taggedTemplateLiteral(["\n      <div class=\"wrapper\">\n        ", "\n        <input\n          ?disabled=", "\n          ?error=", "\n          @focusin=", "\n          @focusout=", "\n          @keydown=", "\n          id=", "\n          type=\"text\"\n          value=", "\n          aria-label=", "\n        />", "\n        <span id=\"width-measure\">", "</span>\n      </div>\n    "]);

  v_dollar_percent_input_templateObject = function _templateObject() {
    return data;
  };
...
function v_dollar_percent_input_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_dollar_percent_input_VDollarPercentInput = _decorate([Object(lit_element["c" /* customElement */])('v-dollar-percent-input')], function (_initialize, _LitElement) {
  var VDollarPercentInput = /*#__PURE__*/function (_LitElement2) {
    _inherits(VDollarPercentInput, _LitElement2);

    var _super = _createSuper(VDollarPercentInput);

    function VDollarPercentInput() {
      var _this;

      _classCallCheck(this, VDollarPercentInput);
    ...
    return VDollarPercentInput;
  }(_LitElement);

  return {
    F: VDollarPercentInput,
    d: [{
      kind: "field",
      ...
      key: "numberOfExcessDecimalsRemoved",
      value: function value() {
        return 0;
      }
    }, {
      ...
      value: function firstUpdated() {
        this.wholeCharLimit = this.dollar ? 5 : 3;
        this.permitsDecimals = Boolean(this.decimalPlaces);
        this.$input = this.shadowRoot.querySelector('input');
        this.$widthMeasure = this.shadowRoot.querySelector('#width-measure');

        this._transposeAttributes();
      }
    }, {
      kind: "method",
      key: "updated",
      value: function updated(changedProperties) {
        ...
        if (changedProperties.has('inputText')) {
          this._updateSelection(changedProperties.get('inputText'));
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_dollar_percent_input_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_dollar_percent_input_templateObject(), this._dollarTemplate(), this.disabled, this.error, this._handleFocusin, this._handleFocusout, this._handleKeydown, this.inputId, this.inputText, this.altLabel, this._percentTemplate(), this.inputText);
      }
    }, {
      kind: "method",
      key: "_addCommas",
      value: function _addCommas(string) {
        var _string$split = string.split('.'),
            _string$split2 = _slicedToArray(_string$split, 2),
            whole = _string$split2[0],
            decimal = _string$split2[1]; // eslint-disable-next-line


        var withoutCommas = whole.replace(/\,/g, '');
        var withCommasReadded = withoutCommas ? parseInt(withoutCommas).toLocaleString() : '';
        return decimal === undefined ? withCommasReadded : withCommasReadded + '.' + decimal;
      }
    }, {
      kind: "method",
      key: "_alreadyHasDecimal",
      value: function _alreadyHasDecimal() {
        return this.value.includes('.');
      }
    }, {
      kind: "field",
      key: "_cursorIsBeforeDecimal",
      value: function value() {
        var _this2 = this;
        ...
        return function (_ref) {
          ...
          return selectionStart <= _this2.inputText.indexOf('.');
        };
      }
    }, {
      kind: "method",
      key: "_decimalIsNotSelected",
      value: function _decimalIsNotSelected() {
        var _this$$input = this.$input,
            selectionStart = _this$$input.selectionStart,
            selectionEnd = _this$$input.selectionEnd;
        return !this.inputText.slice(selectionStart, selectionEnd).includes('.');
      }
    }, {
      kind: "method",
      key: "_decimalIsProhibited",
      value: function _decimalIsProhibited() {
        return this._alreadyHasDecimal() && this._decimalIsNotSelected();
      }
    }, {
      kind: "method",
      key: "_deriveNextValue",
      value: function _deriveNextValue(e) {
        var _this$$input2 = this.$input,
            value = _this$$input2.value,
            selectionStart = _this$$input2.selectionStart,
            selectionEnd = _this$$input2.selectionEnd;
        var nextValue = value.slice(0, selectionStart) + e.key + value.slice(selectionEnd);
        if (this._hasInvalidWholeNumber(nextValue)) return this.value;
        nextValue = this._removeCommas(nextValue);
        nextValue = this._removeExcessDecimalPlaces(nextValue);
        return nextValue;
      }
    }, {
      kind: "method",
      key: "_deriveNextValueOnDelete",
      value: function _deriveNextValueOnDelete(e) {
        var _this$$input3 = this.$input,
            selectionEnd = _this$$input3.selectionEnd,
            value = _this$$input3.value;
        if (e.metaKey) return value.slice(selectionEnd);
        var nextValue = value.slice(0, this._nextSelectionStart()) + value.slice(selectionEnd);
        if (this._hasInvalidWholeNumber(nextValue)) return this.value; // eslint-disable-next-line
      ...
      value: function _dispatchChangeEvent() {
        this.dispatchEvent(new CustomEvent('vdollarpercentinput-change', {
          bubbles: true,
          composed: true,
          detail: {
            value: this.value
      ...
      kind: "method",
      key: "_dispatchInputEvent",
      value: function _dispatchInputEvent() {
        Object(utils["e" /* emitStandardEvent */])(this, 'input');
      }
    }, {
      kind: "method",
      key: "_dollarTemplate",
      value: function _dollarTemplate() {
        return this.dollar ? Object(lit_element["d" /* html */])(_templateObject2(), Object(class_map["a" /* classMap */])({
      ...
      kind: "method",
      key: "_entryIsLeadingZero",
      value: function _entryIsLeadingZero(e) {
        var _this$$input4 = this.$input,
            selectionStart = _this$$input4.selectionStart,
            selectionEnd = _this$$input4.selectionEnd;
        return selectionStart === 0 && selectionEnd === 0 && e.key === '0';
      }
    }, {
      kind: "method",
      key: "_formatValue",
      value: function _formatValue() {
        this.value = this._nextWholeValue() + this._nextDecimalValue();
      }
    }, {
      kind: "method",
      key: "_handleFocusin",
      ...
      value: function _handleKeydown(e) {
        if (this._isFunctionalInput(e)) return;
        e.preventDefault();
        if (this._isDelete(e)) this._registerDelete(e);
        if (this._isDecimal(e) && this.permitsDecimals) this._registerDecimal(e);
        if (this._isNumeral(e)) this._registerNumeral(e);
        e.target.click();
      }
    }, {
      kind: "method",
      key: "_hasInvalidWholeNumber",
      value: function _hasInvalidWholeNumber(nextValue) {
        // eslint-disable-next-line
        var whole = nextValue.replace(/\,/, '').split('.');
        return whole.length > this.wholeCharLimit;
      }
    }, {
      kind: "method",
      key: "_inputTextLengthDifference",
      value: function _inputTextLengthDifference(prevInputText) {
        if (!prevInputText) return this.inputText.length;
        var diff = this.inputText.length - prevInputText.length + this.numberOfExcessDecimalsRemoved;
        this.numberOfExcessDecimalsRemoved = 0;
        return diff;
      }
    }, {
      kind: "method",
      key: "_isAtMaxiumCharCount",
      value: function _isAtMaxiumCharCount() {
        var selectionStart = this.$input.selectionStart;

        var _this$value$split = this.value.split('.'),
            _this$value$split2 = _slicedToArray(_this$value$split, 2),
            whole = _this$value$split2[0],
            decimal = _this$value$split2[1];

        return this._cursorIsBeforeDecimal({
          decimal: decimal,
          selectionStart: selectionStart
        }) && whole.length >= this.wholeCharLimit;
      }
    }, {
      kind: "method",
      key: "_isDecimal",
      value: function _isDecimal(e) {
        // eslint-disable-next-line
        return /[\.]/g.test(e.key);
      }
    }, {
      kind: "method",
      key: "_isDelete",
      value: function _isDelete(e) {
        // 8, 46 = backspace, delete
        return [8, 46].includes(e.keyCode);
      }
    }, {
      kind: "method",
      key: "_isFunctionalInput",
      value: function _isFunctionalInput(e) {
        var isFunctionalKey = [9, 16, 17, 18, 37, 38, 39, 40].includes(e.keyCode);
        var isChord = e.ctrlKey || e.altKey || e.metaKey;
        return isFunctionalKey || isChord && !this._isDelete(e);
      }
    }, {
      kind: "method",
      key: "_isNumeral",
      value: function _isNumeral(e) {
        return /[0-9]/g.test(e.key);
      }
    }, {
      kind: "method",
      key: "_numeralIsProhibited",
      value: function _numeralIsProhibited(e) {
        if (this._somethingIsSelected()) return false;
        if (this._entryIsLeadingZero(e)) return true;
        return this._isAtMaxiumCharCount();
      }
    }, {
      kind: "method",
      key: "_nextDecimalValue",
      value: function _nextDecimalValue() {
        if (!this.permitsDecimals) return '';
        var decimal = this.value.split('.');
        var currentDecimalValue = decimal ? decimal : '';
        var currentDecimalPlaces = decimal ? decimal.length : 0;
        return '.' + currentDecimalValue + '0'.repeat(this.decimalPlaces - currentDecimalPlaces);
      }
    }, {
      kind: "method",
      key: "_nextWholeValue",
      value: function _nextWholeValue() {
        var whole = this.value.split('.');
        if (/^0+$/g.test(whole) || whole === '') return '0';
        return whole.replace(/^0+/, '');
      }
    }, {
      kind: "method",
      key: "_percentTemplate",
      value: function _percentTemplate() {
        return this.percent ? Object(lit_element["d" /* html */])(_templateObject3(), Object(class_map["a" /* classMap */])({
          disabled: this.disabled,
          error: this.error,
          focus: this.focus,
          percent: true
      ...
      kind: "method",
      key: "_nextSelectionStart",
      value: function _nextSelectionStart() {
        var selectionStart = this.$input.selectionStart;
        if (this._somethingIsSelected()) return selectionStart;
        var subtrahend = this._prevCharIsComma() ? 2 : 1;
        return Math.max(selectionStart - subtrahend, 0);
      }
    }, {
      kind: "method",
      key: "_nothingIsSelected",
      value: function _nothingIsSelected() {
        var _this$$input5 = this.$input,
      ...
      kind: "method",
      key: "_prevChar",
      value: function _prevChar() {
        var selectionStart = this.$input.selectionStart;
        return this.inputText.slice(selectionStart - 1, selectionStart);
      }
    }, {
      kind: "method",
      key: "_prevCharIsComma",
      value: function _prevCharIsComma() {
        return this._prevChar() === ',';
      }
    }, {
      kind: "method",
      key: "_prevCharIsPeriod",
      value: function _prevCharIsPeriod() {
        return this._prevChar() === '.';
      }
    }, {
      kind: "method",
      key: "_registerDecimal",
      value: function _registerDecimal(e) {
        if (this._decimalIsProhibited()) return;

        this._registerKeystroke(e);
      }
    }, {
      kind: "method",
      key: "_registerDelete",
      value: function _registerDelete(e) {
        var nextValue = this._deriveNextValueOnDelete(e);

        this.numberOfExcessDecimalsRemoved = 0;
        this.lastSelectionEnd = this.$input.selectionEnd;
        this.lastSelectionStart = this.$input.selectionStart;
        this.value = nextValue;
      }
    }, {
      kind: "method",
      key: "_registerNumeral",
      value: function _registerNumeral(e) {
        if (this._numeralIsProhibited(e)) return;

        this._registerKeystroke(e);
      }
    }, {
      kind: "method",
      key: "_registerKeystroke",
      value: function _registerKeystroke(e) {
        var nextValue = this._deriveNextValue(e);
      ...
      kind: "method",
      key: "_removeCommas",
      value: function _removeCommas(value) {
        // eslint-disable-next-line
        return value.includes(',') ? value.replace(/\,/g, '') : value;
      }
    }, {
      kind: "method",
      key: "_removeExcessDecimalPlaces",
      value: function _removeExcessDecimalPlaces(stringValue) {
        if (!stringValue.includes('.')) return stringValue;

        var _stringValue$split = stringValue.split('.'),
            _stringValue$split2 = _slicedToArray(_stringValue$split, 2),
            whole = _stringValue$split2[0],
            decimal = _stringValue$split2[1];

        var nextDecimal = decimal.slice(0, this.decimalPlaces);
        this.numberOfExcessDecimalsRemoved = decimal.length - nextDecimal.length;
        return whole + '.' + nextDecimal;
      }
    }, {
      kind: "method",
      key: "_somethingIsSelected",
      value: function _somethingIsSelected() {
        var _this$$input6 = this.$input,
      ...
      kind: "method",
      key: "_transposeAttributes",
      value: function _transposeAttributes() {
        var _this3 = this;

        var validAttributes = Object.values(this.attributes).filter(function (_ref2) {
          var name = _ref2.name;
          return ['autofocus', 'form', 'name', 'required'].includes(name);
        });
        validAttributes.forEach(function (_ref3) {
          var name = _ref3.name,
              value = _ref3.value;

          _this3.$input.setAttribute(name, value);
        });
      }
    }, {
      kind: "method",
      ...
      value: function _updateInputText() {
        var nextInputText = this.dollar ? this._addCommas(this.value) : this.value;
      ...
      value: function _updateInputWidth() {
        var _this$$widthMeasure$g = this.$widthMeasure.getBoundingClientRect(),
            width = _this$$widthMeasure$g.width;

        var displayWidth = Math.ceil(width);
        this.$input.style.width = "".concat(displayWidth + 3, "px");
      }
    }, {
      kind: "method",
      key: "_updateSelection",
      value: function _updateSelection(prevInputText) {
        var diff = this._inputTextLengthDifference(prevInputText);

        var nextCursorPosition = Math.max(this.lastSelectionEnd + diff, 0);
