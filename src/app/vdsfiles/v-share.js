...
/******/ 	return __webpack_require__(__webpack_require__.s = "YENU");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VShare", function() { return /* binding */ v_share_VShare; });
...
// CONCATENATED MODULE: ./src/components/v-share/styles.js
function _templateObject() {
...
/* harmony default export */ var v_share_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-share/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject5() {
  var data = v_share_taggedTemplateLiteral(["<v-icon\n                  name=", "\n                  @click=", "\n                  class=", "\n                ></v-icon>"]);
...
function _templateObject4() {
  var data = v_share_taggedTemplateLiteral(["\n          <div @click=", ">\n            <v-speech-bubble\n              ?left=", "\n              ?right=", "\n              ?top=", "\n              ?bottom=", "\n              onlyIcon\n            >\n              ", "\n            </v-speech-bubble>\n          </div>\n        "]);
...
function _templateObject3() {
  var data = v_share_taggedTemplateLiteral(["<button\n          class=", "\n          @click=", "\n          @mouseenter=", "\n          @mouseleave=", "\n          type=\"button\"\n        >\n          <v-icon\n            color=", "\n            name=", "\n            size=\"20px\"\n          ></v-icon>\n        </button>"]);
...
function v_share_templateObject() {
  var data = v_share_taggedTemplateLiteral(["", "\n    ", " "]);

  v_share_templateObject = function _templateObject() {
    return data;
  };
...
function v_share_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_share_VShare = _decorate([Object(lit_element["c" /* customElement */])('v-share')], function (_initialize, _LitElement) {
  var VShare = /*#__PURE__*/function (_LitElement2) {
    _inherits(VShare, _LitElement2);

    var _super = _createSuper(VShare);
    ...
    function VShare() {
      ...
      window.addEventListener('outside-tooltip:click', function (event) {
        return _this._handleClickOutside(event);
      });
      window.addEventListener('click', function (event) {
        return _this._handleClickOutside(event);
      });
      window.addEventListener('keyup', function (event) {
        return _this._handleEscapeKey(event);
      });
      return _this;
    }
    ...
    d: [{
      ...
      value: function updated(changedProperties) {
        if (changedProperties.has('active')) {
          this.showSpeechBubble = this.active;
        }

        if (changedProperties.has('showSpeechBubble') && changedProperties.get('showSpeechBubble') !== this.showSpeechBubble) {
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_share_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        ...
        return Object(lit_element["d" /* html */])(v_share_templateObject(), this.linkText ? Object(lit_element["d" /* html */])(_templateObject2(), this.icon, this.iconcolor, this._toggleActive, this.linkText) : Object(lit_element["d" /* html */])(_templateObject3(), Object(class_map["a" /* classMap */])({
          active: this.active,
          hover: this.hover,
          'icon-only': true
        }), this._toggleActive, this._handleMouseEnter, this._handleMouseLeave, this._iconColor(), this.icon), this.showSpeechBubble ? Object(lit_element["d" /* html */])(_templateObject4(), this._handleClickSlot, this.left, this.right, this.top, this.bottom, this.config.icons.map(function (item) {
          return Object(lit_element["d" /* html */])(_templateObject5(), item.icon, item.icon === 'facebook' ? _this2._facebookShare : item.icon === 'linkedin' ? _this2._linkedinShare : item.icon === 'twitter' ? _this2._twitterShare : _this2._mailShare, item.icon === 'envelope' ? '' : 'vIconMargin');
        })) : undefined);
      }
    }, {
      kind: "method",
      key: "callbackOnDisconnect",
      value: function callbackOnDisconnect() {
      ...
      value: function _dispatchChangeEvent() {
        this.dispatchEvent(new CustomEvent('vshare-change', {
          detail: {
            open: this.showSpeechBubble
          },
          bubbles: true,
          composed: true
        }));
      ...
      value: function _iconColor() {
        return this.active || this.hover ? this.iconHoverColor : this.iconcolor;
      }
    }, {
      kind: "method",
      key: "_toggleActive",
      value: function _toggleActive(e) {
        e.stopPropagation();
        window.dispatchEvent(new CustomEvent('outside-tooltip:click'));
      ...
      value: function _handleClickOutside(e) {
        if (e.target !== this) this.active = false;
      }
    }, {
      kind: "method",
      key: "_handleEscapeKey",
      value: function _handleEscapeKey(e) {
        if (e.keyCode === 27) {
          this.active = false;
        }
      }
      ...
      value: function _removeClickListener() {
        ...
        window.removeEventListener('click', function (event) {
          return _this3._handleClickOutside(event);
        });
        window.removeEventListener('outside-tooltip:click', function (event) {
          return _this3._handleClickOutside(event);
        });
      }
    }, {
      kind: "method",
      key: "_removeEscapeListener",
      value: function _removeEscapeListener() {
        var _this4 = this;

        window.removeEventListener('keyup', function (event) {
          return _this4._handleEscapeKey(event);
        });
      }
    }, {
      kind: "method",
      key: "_facebookShare",
      value: function _facebookShare() {
        this._popitup('https://www.facebook.com/share.php?u=' + this.urlToShare, '_blank');
      }
    }, {
      kind: "method",
      key: "_linkedinShare",
      value: function _linkedinShare() {
        this._popitup('https://www.linkedin.com/sharing/share-offsite/?url=' + this.urlToShare, '_blank');
      }
    }, {
      kind: "method",
      key: "_twitterShare",
      value: function _twitterShare() {
        this._popitup('http://twitter.com/share?url=' + this.urlToShare, '_blank');
      }
    }, {
      kind: "method",
      key: "_mailShare",
      value: function _mailShare() {
        this._popitup('mailto:?subject=Sharing ' + this.urlToShare);
      }
    }, {
      kind: "method",
      key: "_popitup",
      value: function _popitup(url, windowName) {
        var newwindow = window.open(url, windowName, 'height=500,width=400');
