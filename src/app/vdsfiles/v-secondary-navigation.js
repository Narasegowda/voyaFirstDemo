...
/******/ 	return __webpack_require__(__webpack_require__.s = "EUBW");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ var v_secondary_navigation_styles = (Object(lit_element["b" /* css */])(_templateObject()));
...
// CONCATENATED MODULE: ./src/components/v-secondary-navigation/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_secondary_navigation_templateObject() {
  var data = v_secondary_navigation_taggedTemplateLiteral(["\n      <div class=\"illustration-spacer\"></div>\n      <div class=\"nav-container\">\n        <div class=\"tab-row\">\n          <div class=\"indicator\"><div class=\"indicator-tab\"></div></div>\n          <slot name=\"tabs\"></slot>\n        </div>\n        <div class=\"link-row-spacer\"></div>\n      </div>\n    "]);

  v_secondary_navigation_templateObject = function _templateObject() {
    return data;
  };
...
function v_secondary_navigation_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_secondary_navigation_VSecondaryNavigation = _decorate([Object(lit_element["c" /* customElement */])('v-secondary-navigation')], function (_initialize, _LitElement) {
  var VSecondaryNavigation = /*#__PURE__*/function (_LitElement2) {
    _inherits(VSecondaryNavigation, _LitElement2);

    var _super = _createSuper(VSecondaryNavigation);

    function VSecondaryNavigation() {
      var _this;

      _classCallCheck(this, VSecondaryNavigation);

      _this = _super.call(this);

      _initialize(_assertThisInitialized(_this));

      _this.shadowRoot.addEventListener('focustab', function (e) {
        _this._focusTab(e.detail);
      });

      _this.shadowRoot.addEventListener('activatetab', function (e) {
        _this._activateTab(e.detail);
      });

      _this.shadowRoot.addEventListener('resetfocustab', function () {
        _this.$tabs.forEach(function (tab) {
          if (tab.active) {
            tab.setAttribute('focused', '');
          } else {
    ...
    return VSecondaryNavigation;
  }(_LitElement);

  return {
    F: VSecondaryNavigation,
    d: [{
      kind: "field",
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_secondary_navigation_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        ...
        this.$tabs = Object(utils["j" /* getSlottedElements */])(this);
        this.tabCount = this.$tabs.length;
        this.tabWidth = 100 / this.tabCount;
      ...
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_secondary_navigation_templateObject());
      }
    }, {
      kind: "field",
      key: "_setTabIndexes",
      value: function value() {
        ...
        return function () {
          _this2.$tabs.forEach(function (tab, i) {
      ...
      value: function value() {
        ...
        return function () {
          ...
          _this3.$tabs.forEach(function (tab, i) {
            if (tab.active) {
              activateFirst = false;

              _this3._activateTab(i);
      ...
      value: function value() {
        ...
        return function (tabIndex) {
          _this4.$tabs.forEach(function (tab, i) {
            if (tabIndex === i) {
              tab.setAttribute('focused', '');
            } else {
              tab.removeAttribute('focused');
      ...
      value: function value() {
        ...
        return function (tabIndex) {
          _this5.$tabs.forEach(function (tab, i) {
            if (tabIndex === i) {
              tab.setAttribute('active', '');
              _this5.activeTabIndex = i;

              _this5._positionIndicator();
            } else {
      ...
      kind: "field",
      key: "_positionIndicator",
      value: function value() {
        var _this6 = this;

        return function () {
          _this6.$indicator.setAttribute('style', "display:block; width: ".concat(_this6.tabWidth, "%; left: ").concat(_this6.activeTabIndex * _this6.tabWidth, "%;"));
        };
      }
    }]
  };
