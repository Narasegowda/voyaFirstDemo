...
/******/ 	return __webpack_require__(__webpack_require__.s = "XaEn");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VBreadcrumbs", function() { return /* binding */ v_breadcrumbs_VBreadcrumbs; });
...
// CONCATENATED MODULE: ./src/components/v-breadcrumbs/styles.js
function _templateObject() {
...
/* harmony default export */ var v_breadcrumbs_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-breadcrumbs/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_breadcrumbs_templateObject() {
  var data = v_breadcrumbs_taggedTemplateLiteral([" <slot></slot> "]);

  v_breadcrumbs_templateObject = function _templateObject() {
    return data;
  };
...
function v_breadcrumbs_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_breadcrumbs_VBreadcrumbs = _decorate([Object(lit_element["c" /* customElement */])('v-breadcrumbs')], function (_initialize, _LitElement) {
  var VBreadcrumbs = /*#__PURE__*/function (_LitElement2) {
    _inherits(VBreadcrumbs, _LitElement2);

    var _super = _createSuper(VBreadcrumbs);

    function VBreadcrumbs() {
      var _this;

      _classCallCheck(this, VBreadcrumbs);
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_breadcrumbs_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_breadcrumbs_templateObject());
      }
    }]
  };
