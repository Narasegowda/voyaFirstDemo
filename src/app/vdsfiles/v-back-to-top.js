...
/******/ 	return __webpack_require__(__webpack_require__.s = "rcA+");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VBackToTop", function() { return /* binding */ v_back_to_top_VBackToTop; });
...
// CONCATENATED MODULE: ./src/components/v-back-to-top/styles.js
function _templateObject() {
...
/* harmony default export */ var v_back_to_top_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/components/v-back-to-top/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function v_back_to_top_templateObject() {
  var data = v_back_to_top_taggedTemplateLiteral(["\n      <button @click=", ">\n        <v-icon color=\"--v-colors__white\" name=\"chevronUp\" size=\"18px\"></v-icon\n        ><span>Back to Top</span>\n      </button>\n    "]);

  v_back_to_top_templateObject = function _templateObject() {
    return data;
  };
...
function v_back_to_top_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var v_back_to_top_VBackToTop = _decorate([Object(lit_element["c" /* customElement */])('v-back-to-top')], function (_initialize, _LitElement) {
  var VBackToTop = /*#__PURE__*/function (_LitElement2) {
    _inherits(VBackToTop, _LitElement2);

    var _super = _createSuper(VBackToTop);

    function VBackToTop() {
      var _this;

      _classCallCheck(this, VBackToTop);
  ...
  return {
    ...
    d: [{
      ...
      key: "connectedCallback",
      value: function connectedCallback() {
        _get(_getPrototypeOf(VBackToTop.prototype), "connectedCallback", this).call(this);
      ...
      value: function disconnectedCallback() {
        ...
        _get(_getPrototypeOf(VBackToTop.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "get",
      "static": true,
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_back_to_top_styles];
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_back_to_top_templateObject(), this._handleClick);
      }
    }, {
      kind: "method",
      key: "_handleClick",
      value: function _handleClick() {
        ...
        var _int = setInterval(function () {
          window.scrollBy(0, -Math.abs(i));
          i += 10;
          if (window.scrollY === 0) clearInterval(_int);
        }, 20);
      ...
      value: function value() {
        ...
        return function () {
          if (window.scrollY > 300 && !_this2.shadowRoot.querySelector('button').classList.contains('enter')) {
            if (_this2.shadowRoot.querySelector('button').classList.contains('exit')) {
              _this2.shadowRoot.querySelector('button').classList.remove('exit');
            }

            _this2.shadowRoot.querySelector('button').classList.add('enter');
          }

          if (window.scrollY < 300 && _this2.shadowRoot.querySelector('button').classList.contains('enter')) {
            _this2.shadowRoot.querySelector('button').classList.remove('enter');

            _this2.shadowRoot.querySelector('button').classList.add('exit');
          }
        };
      }
    }]
