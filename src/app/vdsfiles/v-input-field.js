...
/******/ 	return __webpack_require__(__webpack_require__.s = "0gko");
/******/ })
/************************************************************************/
/******/ ({
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "VTextInput", function() { return /* binding */ v_input_field_VTextInput; });
...
/* harmony default export */ var v_input_field_styles = (Object(lit_element["b" /* css */])(_templateObject()));
// CONCATENATED MODULE: ./src/utils/createPasswordValidation.js
var checkUpperCase = function checkUpperCase(value) {
  var re = new RegExp('^(?=.*[A-Z]).+$');
  return re.test(value);
};
var checkLowerCase = function checkLowerCase(value) {
  var re = new RegExp('^(?=.*[a-z]).+$');
  return re.test(value);
};
...
var checkSpecialCharacter = function checkSpecialCharacter(value) {
  var re = new RegExp('^(?=.*[!@#$%^&*-]).+$');
  return re.test(value);
};
var checkNumericValue = function checkNumericValue(value) {
  var re = new RegExp('^(?=.*[0-9]).+$');
  return re.test(value);
};
var checkCases = function checkCases(value, type) {
  switch (type) {
    case 'UPPER_CASE':
    ...
    case 'SPECIAL_CASE':
      return checkSpecialCharacter(value);

    case 'NUMERIC_CASE':
      return checkNumericValue(value);

    case 'LENGTH_CASE':
      return checkLength(value);
  }
};
// CONCATENATED MODULE: ./src/components/v-input-field/index.js
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _templateObject15() {
  var data = v_input_field_taggedTemplateLiteral([" <span class=\"disc\"> </span> "]);
...
function _templateObject14() {
  var data = v_input_field_taggedTemplateLiteral([" <v-icon size=", " color=", " name=", "> </v-icon>"]);
...
function _templateObject13() {
  var data = v_input_field_taggedTemplateLiteral(["<div class=\"confirm_password\">\n          ", "\n        </div>"]);
...
function _templateObject12() {
  var data = v_input_field_taggedTemplateLiteral(["<div class=\"checkList\">\n                        ", "\n                        <span>", " </span>\n                      </div> "]);
...
function _templateObject11() {
  var data = v_input_field_taggedTemplateLiteral(["\n                    ", "\n                  "]);
...
function _templateObject9() {
  var data = v_input_field_taggedTemplateLiteral(["<div class=\"header\">Let's create a secure password</div>"]);
...
function _templateObject5() {
  var data = v_input_field_taggedTemplateLiteral(["\n              Show Password\n              <v-icon name=\"eye\" secondary size=\"22px\" />\n            "]);
...
function _templateObject4() {
  var data = v_input_field_taggedTemplateLiteral(["\n              Hide Password\n              <v-icon name=\"eyeslash\" secondary size=\"22px\" />\n            "]);
...
function _templateObject2() {
  var data = v_input_field_taggedTemplateLiteral([" <span>*</span> "]);
...
function v_input_field_templateObject() {
  var data = v_input_field_taggedTemplateLiteral(["\n      ", " ", "\n      <input\n        ?autofocus=", "\n        ?disabled=", "\n        ?error=", "\n        ?readonly=", "\n        ?required=", "\n        @input=", "\n        @focus=", "\n        @blur=", "\n        autocomplete=", "\n        class=", "\n        id=", "\n        maxlength=", "\n        minlength=", "\n        ?createPassword=", "\n        ?confirm=", "\n        name=", "\n        placeholder=", "\n        size=", "\n        tabindex=", "\n        type=", "\n        value=", "\n        pattern=", "\n        aria-label=\"", "\"\n      />\n      ", " ", "\n      ", "\n    "]);

  v_input_field_templateObject = function _templateObject() {
    return data;
  };
...
function v_input_field_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
var CREATE_PASSWORD_CRITERIA = [{
  ...
  type: 'LENGTH_CASE',
  text: 'Minimum of 8 caracters.'
}];
var v_input_field_VTextInput = _decorate([Object(lit_element["c" /* customElement */])('v-input-field')], function (_initialize, _LitElement) {
  var VTextInput = /*#__PURE__*/function (_LitElement2) {
    _inherits(VTextInput, _LitElement2);

    var _super = _createSuper(VTextInput);

    // Properties with novel behavior.
    // Properties that correspond to native `<input type="text" />` attributes
    // but have some introduced behavior.
    // Properties that correspond to native `<input type="text" />` attributes
    // and map one-to-one to the input element attributes.
    function VTextInput() {
      var _this;

      _classCallCheck(this, VTextInput);

      _this = _super.call(this);

      _initialize(_assertThisInitialized(_this));

      _this.formDataAppend = _this.formDataAppend.bind(_assertThisInitialized(_this));
      _this.impliciteSubmit = _this.impliciteSubmit.bind(_assertThisInitialized(_this));
      return _this;
    }
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return [commonStyles["a" /* default */], v_input_field_styles];
      }
    }, {
      kind: "method",
      key: "firstUpdated",
      value: function firstUpdated() {
        if (this.password || this.hasAttribute('confirm')) {
          this.type = 'password';
        }

        this.masked = this.ssn ? true : false;
        this.$input = this.hasAttribute('disable-shadow') ? this.querySelector('input') : this.shadowRoot.querySelector('input');
      }
    }, {
      kind: "field",
      key: "closest",
      ...
      value: function connectedCallback() {
        _get(_getPrototypeOf(VTextInput.prototype), "connectedCallback", this).call(this);

        var formName = '';
        formName = this.closest(this, function (el) {
          return el.localName === 'form';
        });

        if (formName !== null) {
          formName.addEventListener('formdata', this.formDataAppend);
          this.addEventListener('keypress', this.impliciteSubmit);
        }

        if (this.password || this.hasAttribute('confirm')) {
          this.addEventListener('keypress', this.removeSpace);
        }

        if (this.hasAttribute('SSN')) {
          this.addEventListener('keypress', this.checkSSNvalid);
        }
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          _this2.hideText = true;
          _this2.hasAttribute('createPassword') ? _this2.hideText = false : '';
          _this2.hasAttribute('SSN') ? _this2.$input.value = _this2.maskedValue : '';
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          _this3.hasAttribute('createPassword') ? _this3.hideText = true : ''; // this.hasAttribute('SSN') ? (this.$input.value = '***_**_****') : '';
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function (event) {
          if (event.keyCode === 32 && (_this4.password || _this4.hasAttribute('confirm'))) {
      ...
      value: function value() {
        ...
        return function (event) {
          if (event.keyCode === 13) {
            if (_this5.disableSubmit === false) {
              var form = _this5.closest(_this5, function (el) {
                return el.localName === 'form';
              });
      ...
      kind: "method",
      key: "formDataAppend",
      value: function formDataAppend(event) {
      ...
      value: function disconnectedCallback() {
        ...
        if (formName !== null) {
          formName.removeEventListener('formdata', this.formDataAppend);
          this.removeEventListener('keypress', this.impliciteSubmit);
        }

        if (this.password || this.hasAttribute('confirm')) {
          this.removeEventListener('keypress', this.removeSpace);
        }

        if (this.hasAttribute('SSN')) {
          this.removeEventListener('keypress', this.checkSSNvalid);
        }

        _get(_getPrototypeOf(VTextInput.prototype), "disconnectedCallback", this).call(this);
      }
    }, {
      kind: "method",
      key: "createRenderRoot",
      value: function createRenderRoot() {
        // Render template without shadow DOM. Note that shadow DOM features like encapsulated CSS
        // and slots are unavailable.
        return this.hasAttribute('disable-shadow') ? this : _get(_getPrototypeOf(VTextInput.prototype), "createRenderRoot", this).call(this);
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        return Object(lit_element["d" /* html */])(v_input_field_templateObject(), this._label(), this._confirmPassword(), this.autoFocus, this.disabled, this.error, this.readOnly, this.required, this._handleInput, this._onFocusEvent, this._onBlurEvent, this.autoComplete, Object(class_map["a" /* classMap */])({
          password: this.password,
          vinput: 'vinput',
          createpassword: this.createPassword && !this.passwordValid,
          validpassword: this.passwordValid
        }), this.id, this.maxLength, this.minLength, this.createPassword, this.confirm, this.name, this.placeholder, this.size, this.inputTabIndex, this.type, this.value, this.pattern, this.altLabel, this._displayPasswordButton(), this._errorText(), this._createPassword());
      }
    }, {
      kind: "field",
      key: "checkValidity",
      ...
      value: function value() {
        ...
        return function () {
          return _this7.required ? Object(lit_element["d" /* html */])(_templateObject2()) : undefined;
        };
      }
    }, {
      kind: "field",
      key: "_displayPasswordButton",
      value: function value() {
        var _this8 = this;

        return function () {
          if (!_this8.password) return undefined;
          return Object(lit_element["d" /* html */])(_templateObject3(), _this8.disabled, Object(class_map["a" /* classMap */])({
            vInputButton: 'vInputButton'
          }), _this8._toggleShowPassword, _this8.showPassword ? Object(lit_element["d" /* html */])(_templateObject4()) : Object(lit_element["d" /* html */])(_templateObject5()));
        };
      }
    }, {
      kind: "field",
      ...
      value: function value() {
        ...
        return function () {
          return _this9.errorText ? Object(lit_element["d" /* html */])(_templateObject6(), _this9.errorText, Object(class_map["a" /* classMap */])({
            vInputError: 'vInputError'
          })) : undefined;
        };
      }
    }, {
      ...
      value: function _handleInput(e) {
        if (this.masked) {
          this.value = this._getUnmaskedValue(e.target.value, this.value, 'SSN');
          this.maskedValue = this._getMaskedValue(this.maskedValue, this.value, 'SSN');
          this.$input.value = this.maskedValue;
        } else {
          this.value = e.target.value;
        }

        this.$input.hasAttribute('createpassword') ? this.passwordValid = this._checkAllConstarians(e.target.value) : '';
      ...
      value: function value() {
        ...
        return function () {
          return _this10.labelText ? Object(lit_element["d" /* html */])(_templateObject7(), Object(class_map["a" /* classMap */])({
            disabled: _this10.disabled,
            error: _this10.error,
            vlabel: 'vlabel'
          }), _this10.id, _this10._asterisk(), _this10.labelText) : undefined;
        };
      }
    }, {
      kind: "method",
      key: "_toggleShowPassword",
      value: function _toggleShowPassword(e) {
        e.preventDefault();
        if (!this.password) return;
        this.type = this.type === 'password' ? 'text' : 'password';
        this.showPassword = !this.showPassword;
        this.dispatchEvent(new CustomEvent('vtextinput-toggleshowpassword', {
          detail: {
      ...
      kind: "method",
      key: "dispatchValidity",
      value: function dispatchValidity() {
        this.dispatchEvent(new CustomEvent('vtextinput-checkvalidity', {
      ...
      value: function value() {
        ...
        return function () {
          return _this11.createPassword ? Object(lit_element["d" /* html */])(_templateObject8(), Object(class_map["a" /* classMap */])({
            helpText: true,
            hide: _this11.hideText
          }), _this11.passwordValid ? '' : Object(lit_element["d" /* html */])(_templateObject9()), _this11.passwordValid ? Object(lit_element["d" /* html */])(_templateObject10(), _this11._getIcon('check', '--v-ticker__positive-color', '18px')) : Object(lit_element["d" /* html */])(_templateObject11(), CREATE_PASSWORD_CRITERIA.map(function (item) {
            return Object(lit_element["d" /* html */])(_templateObject12(), checkCases(_this11.value, item.type) ? _this11._getIcon('check', '--v-ticker__positive-color', '18px') : _this11._getDiscIcon(), item.text);
          }))) : undefined;
        };
      }
    }, {
      ...
      value: function value() {
        ...
        return function () {
          return _this12.hasAttribute('confirm') ? Object(lit_element["d" /* html */])(_templateObject13(), _this12.getAttribute('confirm') === 'false' ? _this12._getIcon('x', '--v-states__error-color', '24px') : _this12.getAttribute('confirm') === 'true' ? _this12._getIcon('check', '--v-ticker__positive-color', '24px') : undefined) : undefined;
        };
      }
    }, {
      kind: "method",
      key: "_checkAllConstarians",
      value: function _checkAllConstarians(value) {
        return checkCases(value, CREATE_PASSWORD_CRITERIA[0].type) && checkCases(value, CREATE_PASSWORD_CRITERIA[1].type) && checkCases(value, CREATE_PASSWORD_CRITERIA[2].type) && checkCases(value, CREATE_PASSWORD_CRITERIA[3].type) && checkCases(value, CREATE_PASSWORD_CRITERIA[4].type);
      }
    }, {
      kind: "method",
      key: "_getIcon",
      value: function _getIcon(name, color, size) {
        return Object(lit_element["d" /* html */])(_templateObject14(), size, color, name);
      }
    }, {
      kind: "method",
      key: "_getDiscIcon",
      value: function _getDiscIcon() {
        return Object(lit_element["d" /* html */])(_templateObject15());
      }
    }, {
      kind: "method",
      key: "_getMaskedValue",
      value: function _getMaskedValue(masked, unMaskedValue, type) {
        masked = masked.trim();
        unMaskedValue = unMaskedValue.trim();

        if (masked.length > unMaskedValue.length) {
          var unMask = masked.slice(masked.length - 1, masked.length) === '_' ? unMaskedValue.slice(0, unMaskedValue.length - 1) : unMaskedValue;
          var mask = masked.slice(0, unMask.length - 1);
          return this._getMaskedValue(mask, unMask, type);
        }

        switch (type) {
          case 'SSN':
            return unMaskedValue.length === 3 ? '***_' : unMaskedValue.length === 6 ? '***_**_' : masked + unMaskedValue.slice(unMaskedValue.length - 1, unMaskedValue.length);
        }
      }
    }, {
      kind: "method",
      key: "_getUnmaskedValue",
      value: function _getUnmaskedValue(masked, value, type) {
        masked = masked.trim();
        value = value.trim();

        if (value.length >= masked.length) {
          return value.slice(0, masked.length);
        }

        switch (type) {
          case 'SSN':
            return masked.length >= 5 && masked.length <= 6 ? value.split('_')[0] + '_' + masked.split('_')[1] : masked.length >= 7 && masked.length <= 11 ? value.split('_')[0] + '_' + value.split('_')[1] + '_' + masked.split('_')[2] : masked.match(/\d+/g)[0];
        }
      }
    }]
  };
